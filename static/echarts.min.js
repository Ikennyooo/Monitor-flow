!function (t, e) {
    ...
    function l(t, e, n) {
        ...
        for (var i in e) if (e.hasOwnProperty(i)) {
            var r = t[i], o = e[i];
            !A(o) || !A(r) || M(o) || M(r) || P(o) || P(r) || k(o) || k(r) || Y(o) || Y(r) ? !n && i in t || (t[i] = s(e[i])) : l(r, o, n)
        }
        return t
    }
    ...
    function y(t, e, n) {
        if (t && e) if (t.forEach && t.forEach === iv) t.forEach(e, n); else if (t.length === +t.length) for (var i = 0, r = t.length; r > i; i++) e.call(n, t[i], i, t); else for (var o in t) t.hasOwnProperty(o) && e.call(n, t[o], o, t)
    }

    function v(t, e, n) {
        if (!t) return [];
        if (!e) return V(t);
        if (t.map && t.map === av) return t.map(e, n);
    ...
    function _(t, e, n) {
        if (!t) return [];
        if (!e) return V(t);
        if (t.filter && t.filter === rv) return t.filter(e, n);
    ...
    function w(t, e) {
        ...
        return function () {
            return t.apply(e, n.concat(ov.call(arguments)))
        }
    }
    ...
    function S(t) {
        ...
        return function () {
            return t.apply(this, e.concat(ov.call(arguments)))
        }
    }

    function M(t) {
        return Array.isArray ? Array.isArray(t) : "[object Array]" === ev.call(t)
    }
    ...
    function I(t) {
        return "[object String]" === ev.call(t)
    }
    ...
    function E(t) {
        return "[object RegExp]" === ev.call(t)
    }
    ...
    function me(t, e, n, i, r, o) {
        ...
        if (1 === e) {
            var l = Math.round(Math.log((1 << s) - 1 & ~r) / Mv);
            return t[n][l]
        }
    ...
    function xe(t, e, n, i, r) {
        return be(Cv, e, i, r, !0) && be(t, n, Cv[0], Cv[1])
    }

    function be(t, e, n, i, r) {
        if (e.getBoundingClientRect && Qy.domSupported && !Me(e)) {
    ...
    function Te(t, e, n, i) {
        return n = n || {}, i || !Qy.canvasSupported ? Ce(t, e, n) : Qy.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : Ce(t, e, n), n
    }

    function Ce(t, e, n) {
        if (Qy.domSupported && t.getBoundingClientRect) {
    ...
    function De(t, e, n) {
        ...
        var s = e.button;
        return null == e.which && void 0 !== s && Dv.test(e.type) && (e.which = 1 & s ? 1 : 2 & s ? 3 : 4 & s ? 2 : 0), e
    }
    ...
    function ke(t, e, n, i) {
        Iv ? t.addEventListener(e, n, i) : t.attachEvent("on" + e, n)
    }

    function Le(t, e, n, i) {
        Iv ? t.removeEventListener(e, n, i) : t.detachEvent("on" + e, n)
    }
    ...
    function rn(t, e) {
        em && nn(em, e), em = tm.put(t, em || e.slice())
    }
    ...
    function on(t, e) {
        if (t) {
            ...
            if (i in Jv) return nn(e, Jv[i]), rn(t, e), e;
            var r = i.length;
            if ("#" !== i.charAt(0)) {
    ...
    function Sn(t, e, n) {
        ...
        if (i.push && r.push) {
            ...
            if (o !== a) {
                var s = o > a;
                if (s) i.length = a; else for (var l = o; a > l; l++) i.push(1 === n ? r[l] : om.call(r[l]))
            }
    ...
    function Dn(t) {
        if (g(t)) {
            var e = t.length;
            if (g(t[0])) {
                for (var n = [], i = 0; e > i; i++) n.push(om.call(t[i]));
                return n
            }
            return om.call(t)
        }
    ...
    function Ln(t, e) {
        return Nv || (Nv = cv().getContext("2d")), Fv !== e && (Fv = Nv.font = e || xm), Nv.measureText(t)
    }
    ...
    function Pn(t, e) {
        ...
        n || (n = _m[e] = new Qv(500));
        var i = n.get(t);
        return null == i && (i = bm.measureText(t, e).width, n.put(t, i)), i
    }

    function On(t, e, n, i) {
        var r = Pn(t, e), o = zn(e), a = En(0, r, n), s = Bn(0, o, i), l = new mm(a, s, r, o);
        return l
    }
    ...
    function Rn(t, e, n, i) {
        ...
        for (var a = new mm(0, 0, 0, 0), s = 0; s < r.length; s++) {
            var l = On(r[s], e, n, i);
    ...
    function Wn(t, e, n) {
        if (g(e[n])) if (g(t[n]) || (t[n] = []), L(e[n])) {
            ...
            if (Gn(r)) for (var s = r[0].length, l = 0; a > l; l++) o[l] ? Hn(o[l], r[l], s) : o[l] = Array.prototype.slice.call(r[l]); else Hn(o, r, a);
            o.length = r.length
        } else t[n] = e[n]
    }

    function Un(t, e, n, i, r, o, a, s) {
        for (var l = [], u = [], h = b(i), c = r.duration, f = r.delay, d = r.additive, y = r.setToFinal, v = !A(o), m = 0; m < h.length; m++) {
            var _ = h[m];
    ...
    function Qn(t, e, n, i) {
        ...
        if (!(2 > r)) {
            var o = 0;
            if (Em > r) return o = Xn(t, n, i, e), void qn(t, n, i, n + o, e);
            var a = $n(t, e), s = Yn(r);
            do {
                if (o = Xn(t, n, i, e), s > o) {
                    var l = r;
    ...
    function ai(t, e) {
        var n = e.domHandlers;
        Qy.pointerEventsSupported ? y(Wm.pointer, function (i) {
            li(e, i, function (e) {
                n[i].call(t, e)
            })
        }) : (Qy.touchEventsSupported && y(Wm.touch, function (i) {
            li(e, i, function (r) {
                n[i].call(t, r), ni(e)
            })
        }), y(Wm.mouse, function (i) {
            li(e, i, function (r) {
    ...
    function si(t, e) {
        ...
        Qy.pointerEventsSupported ? y(Um.pointer, n) : Qy.touchEventsSupported || y(Um.mouse, n)
    }
    ...
    function ci(t) {
        if (!t) return !1;
        if ("string" == typeof t) return gn(t, 1) < Mm;
        if (t.colorStops) {
    ...
    function di() {
        for (var t in t_) t_.hasOwnProperty(t) && t_[t].dispose();
        t_ = {}
    }
    ...
    function Gi(t) {
        return !A(t) || M(t) || t instanceof Date ? t : t.value
    }
    ...
    function Ki(t) {
        ...
        y(t, function (t) {
            ...
            if (A(r)) {
                if (o.name = null != r.name ? Qi(r.name) : i ? i.name : s_ + n, i) o.id = Qi(i.id); else if (null != r.id) o.id = Qi(r.id); else {
                    var a = 0;
    ...
    function tr(t) {
        var e = t.name;
        return !(!e || !e.indexOf(s_))
    }

    function er(t) {
        return t && null != t.id && 0 === Qi(t.id).indexOf(l_)
    }
    ...
    function hr(t) {
        return "auto" === t ? Qy.domSupported ? "html" : "richText" : t || "html"
    }
    ...
    function gr(t) {
        t.$constructor = t, t.extend = function (t) {
            ...
            var i = this;
            return e[d_] = !0, h(e.prototype, t), e.extend = this.extend, e.superCall = _r, e.superApply = xr, f(e, this), e.superClass = i, e
        }
    }
    ...
    function br(t) {
        function e(t) {
            var e = n[t.main];
            return e && e[f_] || (e = n[t.main] = {}, e[f_] = !0), e
        }
        ...
        t.registerClass = function (t) {
            ...
            var r = n[t];
            if (r && r[f_] && (r = e ? r[e] : null), i && !r) throw new Error(e ? "Component " + t + "." + (e || "") + " not exists. Load it first." : t + ".type should be specified.");
            return r
        }, t.getClassesByMainType = function (t) {
            var e = pr(t), i = [], r = n[e.main];
            return r && r[f_] ? y(r, function (t, e) {
                e !== f_ && i.push(t)
            }) : i.push(r), i
    ...
    function Mr(t, e, n, i, r) {
        if (t) {
            if ("string" == typeof t) {
                ...
                var o = __.get(t), a = {hostEl: n, cb: i, cbPayload: r};
                return o ? (e = o.image, !Cr(e) && o.pending.push(a)) : (e = new Image, e.onload = e.onerror = Tr, __.put(t, e.__cachedImgObj = {
                    image: e,
                    pending: [a]
    ...
    function Lr(t, e) {
        ...
        n = null != h && "break" === i || "breakAll" === i ? t ? Br(t, e.font, h, "breakAll" === i, 0).lines : [] : t ? t.split("\n") : [];
    ...
    function Pr(t, e) {
        ...
        for (var r, o = e.width, a = e.height, s = e.overflow, l = "break" !== s && "breakAll" !== s || null == o ? null : {
            ...
            accumWidth: 0,
            breakAll: "breakAll" === s
        }, u = x_.lastIndex = 0; null != (r = x_.exec(t));) {
            var h = r.index;
            h > u && Or(i, t.substring(u, h), e, l), Or(i, r[2], e, l, r[1]), u = x_.lastIndex
        }
        ...
        t:for (var v = 0; v < i.lines.length; v++) {
            for (var m = i.lines[v], _ = 0, x = 0, b = 0; b < m.tokens.length; b++) {
                ...
                if ("string" == typeof D && "%" === D.charAt(D.length - 1)) w.percentWidth = D, c.push(w), w.contentWidth = Pn(w.text, C); else {
                    if (A) {
                        var k = S.backgroundColor, L = k && k.image;
                        L && (L = Sr(L), Cr(L) && (w.width = Math.max(w.width, L.width * I / L.height)))
                    }
                    var P = g && null != o ? o - x : null;
                    null != P && P < w.width ? !A || T > P ? (w.text = "", w.width = w.contentWidth = 0) : (w.text = Ir(w.text, P - T, C, e.ellipsis, {minChar: e.truncateMinChar}), w.width = w.contentWidth = Pn(w.text, C)) : w.contentWidth = Pn(w.text, C)
                }
    ...
    function Or(t, e, n, i, r) {
        ...
        if (i) {
            ...
            if (null != l.width && "auto" !== l.width) {
                ...
                var g = Br(e, h, i.width, i.breakAll, i.accumWidth);
                i.accumWidth = g.accumWidth + f, a = g.linesWidths, o = g.lines
            }
        } else o = e.split("\n");
        for (var y = 0; y < o.length; y++) {
            var v = o[y], m = new b_;
            if (m.styleName = r, m.text = v, m.isLineHolder = !v && !s, m.width = "number" == typeof l.width ? l.width : a ? a[y] : Pn(v, h), y || c) u.push(new w_([m])); else {
                var _ = (u[u.length - 1] || (u[0] = new w_)).tokens, x = _.length;
    ...
    function Nr(t, e, n) {
        return k_.copy(t.getBoundingRect()), t.transform && k_.applyTransform(t.transform), L_.width = e, L_.height = n, !k_.intersect(L_)
    }
    ...
    function Wr(t, e, n, i, r, o) {
        ...
        if (Fr(h) && Fr(c)) if (Fr(s)) o[0] = 0; else {
            ...
            if (Fr(g)) {
                ...
                var m = O_(g), _ = h * s + 1.5 * a * (-c + m), x = h * s + 1.5 * a * (-c - m);
                _ = 0 > _ ? -P_(-_, z_) : P_(_, z_), x = 0 > x ? -P_(-x, z_) : P_(x, z_);
                var d = (-s - (_ + x)) / (3 * a);
                d >= 0 && 1 >= d && (o[f++] = d)
            } else {
                var b = (2 * h * s - 3 * a * c) / (2 * O_(h * h * h)), w = Math.acos(b) / 3, S = O_(h), M = Math.cos(w),
                    d = (-s - 2 * S * M) / (3 * a), v = (-s + S * (M + B_ * Math.sin(w))) / (3 * a),
    ...
    function Ur(t, e, n, i, r) {
        ...
        if (Fr(a)) {
            ...
            if (Fr(h)) r[0] = -o / (2 * a); else if (h > 0) {
                var c = O_(h), u = (-o + c) / (2 * a), p = (-o - c) / (2 * a);
    ...
    function Xr(t, e, n, i, r, o, a, s, l, u, h) {
        ...
        N_[0] = l, N_[1] = u;
        for (var m = 0; 1 > m; m += .05) F_[0] = Hr(t, n, r, a, m), F_[1] = Hr(e, i, o, s, m), d = _v(N_, F_), v > d && (c = m, v = d);
        v = 1 / 0;
        for (var _ = 0; 32 > _ && !(E_ > y); _++) p = c - y, f = c + y, F_[0] = Hr(t, n, r, a, p), F_[1] = Hr(e, i, o, s, p), d = _v(F_, N_), p >= 0 && v > d ? (c = p, v = d) : (V_[0] = Hr(t, n, r, a, f), V_[1] = Hr(e, i, o, s, f), g = _v(V_, N_), 1 >= f && v > g ? (c = f, v = g) : y *= .5);
        return h && (h[0] = Hr(t, n, r, a, c), h[1] = Hr(e, i, o, s, c)), O_(v)
    }
    ...
    function Kr(t, e, n, i, r) {
        ...
        if (Fr(o)) {
            ...
            if (Fr(h)) {
                ...
                var c = O_(h), u = (-a + c) / (2 * o), p = (-a - c) / (2 * o);
                u >= 0 && 1 >= u && (r[l++] = u), p >= 0 && 1 >= p && (r[l++] = p)
            }
        }
        return l
    ...
    function Jr(t, e, n, i, r, o, a, s, l) {
        ...
        for (var p = 0; 1 > p; p += .05) {
            F_[0] = qr(t, n, r, p), F_[1] = qr(e, i, o, p);
            var f = _v(N_, F_);
            c > f && (u = p, c = f)
        }
        c = 1 / 0;
        for (var d = 0; 32 > d && !(E_ > h); d++) {
            var g = u - h, y = u + h;
            F_[0] = qr(t, n, r, g), F_[1] = qr(e, i, o, g);
            var f = _v(F_, N_);
            if (g >= 0 && c > f) u = g, c = f; else {
                V_[0] = qr(t, n, r, y), V_[1] = qr(e, i, o, y);
                var v = _v(V_, N_);
                1 >= y && c > v ? (u = y, c = v) : h *= .5
            }
        }
        return l && (l[0] = qr(t, n, r, u), l[1] = qr(e, i, o, u)), O_(c)
    }
    ...
    function eo(t, e, n) {
        if (0 !== t.length) {
            for (var i = t[0], r = i[0], o = i[0], a = i[1], s = i[1], l = 1; l < t.length; l++) i = t[l], r = H_(r, i[0]), o = G_(o, i[0]), a = H_(a, i[1]), s = G_(s, i[1]);
            e[0] = r, e[1] = a, n[0] = o, n[1] = s
        }
    }

    function no(t, e, n, i, r, o) {
        r[0] = H_(t, n), r[1] = H_(e, i), o[0] = G_(t, n), o[1] = G_(e, i)
    }

    function io(t, e, n, i, r, o, a, s, l, u) {
        var h = Ur, c = Hr, p = h(t, n, r, a, Z_);
        l[0] = 1 / 0, l[1] = 1 / 0, u[0] = -1 / 0, u[1] = -1 / 0;
        for (var f = 0; p > f; f++) {
            var d = c(t, n, r, a, Z_[f]);
            l[0] = H_(d, l[0]), u[0] = G_(d, u[0])
        }
        p = h(e, i, o, s, K_);
        for (var f = 0; p > f; f++) {
            var g = c(e, i, o, s, K_[f]);
            l[1] = H_(g, l[1]), u[1] = G_(g, u[1])
        }
        l[0] = H_(t, l[0]), u[0] = G_(t, u[0]), l[0] = H_(a, l[0]), u[0] = G_(a, u[0]), l[1] = H_(e, l[1]), u[1] = G_(e, u[1]), l[1] = H_(s, l[1]), u[1] = G_(s, u[1])
    }

    function ro(t, e, n, i, r, o, a, s) {
        var l = $r, u = qr, h = G_(H_(l(t, n, r), 1), 0), c = G_(H_(l(e, i, o), 1), 0), p = u(t, n, r, h),
            f = u(e, i, o, c);
        a[0] = H_(t, r, p), a[1] = H_(e, o, f), s[0] = G_(t, r, p), s[1] = G_(e, o, f)
    }

    function oo(t, e, n, i, r, o, a, s, l) {
        var u = ye, h = ve, c = Math.abs(r - o);
        if (1e-4 > c % Y_ && c > 1e-4) return s[0] = t - n, s[1] = e - i, l[0] = t + n, void (l[1] = e + i);
        if (X_[0] = U_(r) * n + t, X_[1] = W_(r) * i + e, j_[0] = U_(o) * n + t, j_[1] = W_(o) * i + e, u(s, X_, j_), h(l, X_, j_), r %= Y_, 0 > r && (r += Y_), o %= Y_, 0 > o && (o += Y_), r > o && !a ? o += Y_ : o > r && a && (r += Y_), a) {
            var p = o;
            o = r, r = p
        }
        for (var f = 0; o > f; f += Math.PI / 2) f > r && (q_[0] = U_(f) * n + t, q_[1] = W_(f) * i + e, u(s, q_, s), h(l, q_, l))
    }

    function ao(t) {
        var e = Math.round(t / hx * 1e8) / 1e8;
        return e % 2 * hx
    }
    ...
    function so(t, e) {
        ...
        0 > n && (n += cx);
        var i = n - t[0], r = t[1];
        r += i, !e && r - n >= cx ? r = n + cx : e && n - r >= cx ? r = n - cx : !e && n > r ? r = n + (cx - ao(n - r)) : e && r > n && (r = n - (cx - ao(r - n))), t[0] = n, t[1] = r
    }
    ...
    function po(t, e, n, i, r, o, a, s, l) {
        ...
        if (Math.abs(i - r) % yx < 1e-4) return !0;
        if (o) {
            var c = i;
            i = co(r), r = co(c)
        } else i = co(i), r = co(r);
        ...
        return 0 > p && (p += yx), p >= i && r >= p || p + yx >= i && r >= p + yx
    }
    ...
    function vo(t, e, n, i, r, o, a, s, l, u) {
        ...
        var h = Wr(e, i, o, s, u, xx);
        if (0 === h) return 0;
        for (var c = 0, p = -1, f = void 0, d = void 0, g = 0; h > g; g++) {
            var y = xx[g], v = 0 === y || 1 === y ? .5 : 1, m = Hr(t, n, r, a, y);
            l > m || (0 > p && (p = Ur(e, i, o, s, bx), bx[1] < bx[0] && p > 1 && yo(), f = Hr(e, i, o, s, bx[0]), p > 1 && (d = Hr(e, i, o, s, bx[1]))), c += 2 === p ? y < bx[0] ? e > f ? v : -v : y < bx[1] ? f > d ? v : -v : d > s ? v : -v : y < bx[0] ? e > f ? v : -v : f > s ? v : -v)
        }
        return c
    }
    ...
    function mo(t, e, n, i, r, o, a, s) {
        ...
        if (u >= 0 && 1 >= u) {
            for (var h = 0, c = qr(e, i, o, u), p = 0; l > p; p++) {
                var f = 0 === xx[p] || 1 === xx[p] ? .5 : 1, d = qr(t, n, r, xx[p]);
                a > d || (h += xx[p] < u ? e > c ? f : -f : c > o ? f : -f)
            }
            return h
        }
        var f = 0 === xx[0] || 1 === xx[0] ? .5 : 1, d = qr(t, n, r, xx[0]);
    ...
    function _o(t, e, n, i, r, o, a, s) {
        ...
        for (var p = 0, f = 0; 2 > f; f++) {
            ...
            if (d + t > a) {
                ...
                0 > g && (g = mx + g), (g >= i && r >= g || g + mx >= i && r >= g + mx) && (g > Math.PI / 2 && g < 1.5 * Math.PI && (h = -h), p += h)
            }
        }
        return p
    }
    ...
    function xo(t, e, n, i, r) {
        for (var o, a, s = t.data, l = t.len(), u = 0, h = 0, c = 0, p = 0, f = 0, d = 0; l > d;) {
            var g = s[d++], y = 1 === d;
            switch (g === vx.M && d > 1 && (n || (u += fo(h, c, p, f, i, r))), y && (h = s[d], c = s[d + 1], p = h, f = c), g) {
                case vx.M:
                    p = s[d++], f = s[d++], h = p, c = f;
                    break;
                case vx.L:
                ...
                case vx.A:
                    ...
                    d += 1;
                    var S = !!(1 - s[d++]);
                    o = Math.cos(b) * _ + v, a = Math.sin(b) * x + m, y ? (p = o, f = a) : u += fo(h, c, o, a, i, r);
                    var M = (i - v) * x / _ + v;
                    if (n) {
    ...
    function To(t, e, n) {
        if (e) {
            ...
            var s = n && n.lineWidth;
            return s ? (Px(2 * i) === Px(2 * r) && (t.x1 = t.x2 = Io(i, s, !0)), Px(2 * o) === Px(2 * a) && (t.y1 = t.y2 = Io(o, s, !0)), t) : t
        }
    }
    ...
    function Io(t, e, n) {
        if (!e) return t;
        var i = Px(2 * t);
        return (i + Px(e)) % 2 === 0 ? i / 2 : (i + (n ? 1 : -1)) / 2
    }
    ...
    function Ao(t) {
        if (t) {
            t.font = Fx.makeFont(t);
            var e = t.align;
            "middle" === e && (e = "center"), t.align = null == e || Vx[e] ? e : "left";
    ...
    function Fo(t) {
        t.hoverState === qx && zo(t, "normal", Xx)
    }
    ...
    function Ho(t) {
        t.hoverState === jx && zo(t, "normal", Xx)
    }
    ...
    function qo(t, e, n, i) {
        ...
        if (t instanceof Cx) {
            var a = Yx(t), s = r ? a.selectFill || a.normalFill : a.normalFill,
            ...
            a.eachSeries(function (t) {
                ...
                if (!("series" === n && !r || "coordinateSystem" === n && !h || "series" === e && r)) {
                    ...
                    if (c.group.traverse(function (t) {
                        Vo(t)
                    }), g(e)) o(t.getData(), e); else if (A(e)) for (var p = b(e), f = 0; f < p.length; f++) o(t.getData(p[f]), e[p[f]]);
                    u.push(t)
                }
    ...
    function ha(t, e, n) {
        if (ba(e)) {
            var i = e.type === Jx, r = t.seriesIndex, o = t.getData(e.dataType), a = rr(o, e);
            a = (M(a) ? a[0] : a) || 0;
    ...
    function ca(t, e) {
        if (xa(e)) {
            ...
            M(r) || (r = [r]), t[e.type === ib ? "toggleSelect" : e.type === eb ? "select" : "unselect"](r, n)
        }
    }
    ...
    function _a(t) {
        var e = Ux[t];
        return null == e && 32 >= Wx && (e = Ux[t] = Wx++), e
    }
    ...
    function Sa(t, e) {
        var n, i, r, o, a, s, l = t.data, u = t.len(), h = sb.M, c = sb.C, p = sb.L, f = sb.R, d = sb.A, g = sb.Q;
        for (r = 0, o = 0; u > r;) {
            switch (n = l[r++], o = r, i = 0, n) {
                ...
                case g:
                    ...
                    break;
                case d:
                    var y = e[4], v = e[5], m = ub(e[0] * e[0] + e[1] * e[1]), _ = ub(e[2] * e[2] + e[3] * e[3]),
                        x = hb(-e[1] / _, e[0] / m);
    ...
    function Ia(t, e, n, i, r, o, a, s, l, u, h) {
        var c = l * (db / 180), p = fb(c) * (t - n) / 2 + pb(c) * (e - i) / 2,
            f = -1 * pb(c) * (t - n) / 2 + fb(c) * (e - i) / 2, d = p * p / (a * a) + f * f / (s * s);
        d > 1 && (a *= cb(d), s *= cb(d));
        var g = (r === o ? -1 : 1) * cb((a * a * s * s - a * a * f * f - s * s * p * p) / (a * a * f * f + s * s * p * p)) || 0,
            y = g * a * f / s, v = g * -s * p / a, m = (t + n) / 2 + fb(c) * y - pb(c) * v,
            _ = (e + i) / 2 + pb(c) * y + fb(c) * v, x = Ca([1, 0], [(p - y) / a, (f - v) / s]),
            b = [(p - y) / a, (f - v) / s], w = [(-1 * p - y) / a, (-1 * f - v) / s], S = Ca(b, w);
        if (Ta(b, w) <= -1 && (S = db), Ta(b, w) >= 1 && (S = 0), 0 > S) {
            var M = Math.round(S / db * 1e6) / 1e6;
            S = 2 * db + M % 2 * db
        }
    ...
    function Da(t) {
        var e = new dx;
        if (!t) return e;
        var n, i = 0, r = 0, o = i, a = r, s = dx.CMD, l = t.match(gb);
        if (!l) return e;
        for (var u = 0; u < l.length; u++) {
            for (var h = l[u], c = h.charAt(0), p = void 0, f = h.match(yb) || [], d = f.length, g = 0; d > g; g++) f[g] = parseFloat(f[g]);
            for (var y = 0; d > y;) {
                ...
                switch (c) {
                    ...
                    case"t":
                        ...
                        break;
                    case"A":
                        _ = f[y++], x = f[y++], b = f[y++], w = f[y++], S = f[y++], M = i, T = r, i = f[y++], r = f[y++], p = s.A, Ia(M, T, i, r, w, S, _, x, b, p, e);
                        break;
                    case"a":
                        _ = f[y++], x = f[y++], b = f[y++], w = f[y++], S = f[y++], M = i, T = r, i += f[y++], r += f[y++], p = s.A, Ia(M, T, i, r, w, S, _, x, b, p, e)
                }
    ...
    function La(t, e) {
        return new vb(ka(t, e))
    }

    function Pa(t, n) {
        var i = ka(t, n), r = function (t) {
            function n(e) {
    ...
    function Ra(t, e, n, i, r, o, a, s) {
        ...
        return Pb > p * p ? void 0 : (p = (h * (e - o) - c * (t - r)) / p, [t + p * l, e + p * u])
    }

    function Ea(t, e, n, i, r, o, a) {
        var s = t - n, l = e - i, u = (a ? o : -o) / Ab(s * s + l * l), h = u * l, c = -u * s, p = t + h, f = e + c,
            d = n + h, g = i + c, y = (p + d) / 2, v = (f + g) / 2, m = d - p, _ = g - f, x = m * m + _ * _, b = r - o,
            w = p * g - d * f, S = (0 > _ ? -1 : 1) * Ab(kb(0, b * b * x - w * w)), M = (w * _ - m * S) / x,
            T = (-w * m - _ * S) / x, C = (w * _ + m * S) / x, I = (-w * m + _ * S) / x, D = M - y, A = T - v,
            k = C - y, L = I - v;
        return D * D + A * A > k * k + L * L && (M = C, T = I), {
            cx: M,
            cy: T,
            x01: -h,
            y01: -c,
    ...
    function Ba(t, e) {
        var n = kb(e.r, 0), i = kb(e.r0 || 0, 0), r = n > 0, o = i > 0;
        if (r || o) {
            if (r || (n = i, i = 0), i > n) {
                var a = n;
                n = i, i = a
            ...
            if (n > Pb) if (s > Sb - Pb) t.moveTo(p + n * Tb(u), f + n * Mb(u)), t.arc(p, f, n, u, h, !l), i > Pb && (t.moveTo(p + i * Tb(h), f + i * Mb(h)), t.arc(p, f, i, h, u, l)); else {
                var y = Db(n - i) / 2, v = Lb(y, d), m = Lb(y, g), _ = m, x = v, b = n * Tb(u), w = n * Mb(u),
                    S = i * Tb(h), M = i * Mb(h), T = void 0, C = void 0, I = void 0, D = void 0;
                if ((v > Pb || m > Pb) && (T = n * Tb(h), C = n * Mb(h), I = i * Tb(u), D = i * Mb(u), wb > s)) {
                    var A = Ra(b, w, I, D, T, C, S, M);
                    if (A) {
                        var k = b - A[0], L = w - A[1], P = T - A[0], O = C - A[1],
                            R = 1 / Mb(Cb((k * P + L * O) / (Ab(k * k + L * L) * Ab(P * P + O * O))) / 2),
                            E = Ab(A[0] * A[0] + A[1] * A[1]);
                        _ = Lb(m, (i - E) / (R - 1)), x = Lb(v, (n - E) / (R + 1))
                    }
                }
                if (s > Pb) if (x > Pb) {
                    var B = Ea(I, D, b, w, n, x, l), z = Ea(T, C, S, M, n, x, l);
                    t.moveTo(p + B.cx + B.x01, f + B.cy + B.y01), v > x ? t.arc(p + B.cx, f + B.cy, x, Ib(B.y01, B.x01), Ib(z.y01, z.x01), !l) : (t.arc(p + B.cx, f + B.cy, x, Ib(B.y01, B.x01), Ib(B.y11, B.x11), !l), t.arc(p, f, n, Ib(B.cy + B.y11, B.cx + B.x11), Ib(z.cy + z.y11, z.cx + z.x11), !l), t.arc(p + z.cx, f + z.cy, x, Ib(z.y11, z.x11), Ib(z.y01, z.x01), !l))
                } else t.moveTo(p + b, f + w), t.arc(p, f, n, u, h, !l); else t.moveTo(p + b, f + w);
                if (i > Pb && s > Pb) if (_ > Pb) {
                    var B = Ea(S, M, T, C, i, -_, l), z = Ea(b, w, I, D, i, -_, l);
                    t.lineTo(p + B.cx + B.x01, f + B.cy + B.y01), m > _ ? t.arc(p + B.cx, f + B.cy, _, Ib(B.y01, B.x01), Ib(z.y01, z.x01), !l) : (t.arc(p + B.cx, f + B.cy, _, Ib(B.y01, B.x01), Ib(B.y11, B.x11), !l), t.arc(p, f, i, Ib(B.cy + B.y11, B.cx + B.x11), Ib(z.cy + z.y11, z.cx + z.x11), l), t.arc(p + z.cx, f + z.cy, _, Ib(z.y11, z.x11), Ib(z.y01, z.x01), !l))
    ...
    function Na(t, e) {
        ...
        for (var o = 0; a > o; o++) {
            ...
            var d = u * u, g = u * d;
            i.push([za(h[0], c[0], p[0], f[0], u, d, g), za(h[1], c[1], p[1], f[1], u, d, g)])
        }
        return i
    }
    ...
    function Ha(t, e, n) {
        ...
        return null === i || null === r ? [(n ? Gr : Hr)(t.x1, t.cpx1, t.cpx2, t.x2, e), (n ? Gr : Hr)(t.y1, t.cpy1, t.cpy2, t.y2, e)] : [(n ? Zr : qr)(t.x1, t.cpx1, t.x2, e), (n ? Zr : qr)(t.y1, t.cpy1, t.y2, e)]
    }
    ...
    function Ya(t) {
        return lw.hasOwnProperty(t) ? lw[t] : void 0
    }
    ...
    function ns(t, e, n, i) {
        t.removeTextContent(), t.removeTextGuideLine(), es(t, {style: {opacity: 0}}, e, n, i)
    }
    ...
    function as(t, e, n) {
        return e && !g(e) && (e = jv.getLocalTransform(e)), n && (e = Ye([], e)), ge([], t, e)
    }
    ...
    function ss(t, e, n) {
        ...
        return o = as(o, e, n), Math.abs(o[0]) > Math.abs(o[1]) ? o[0] > 0 ? "right" : "left" : o[1] > 0 ? "bottom" : "top"
    }
        ...
        if (t && e) {
            ...
            e.traverse(function (t) {
                if (ls(t) && t.anid) {
                    ...
                    if (e) {
                        var i = r(t);
                        t.attr(r(e)), Ja(t, i, n, Gx(t).dataIndex)
                    }
                }
            })
        }
    ...
    function cs(t, e) {
        return v(t, function (t) {
            var n = t[0];
            n = aw(n, e.x), n = sw(n, e.x + e.width);
            var i = t[1];
            return i = aw(i, e.y), i = sw(i, e.y + e.height), [n, i]
        })
    }

    function ps(t, e) {
        var n = aw(t.x, e.x), i = sw(t.x + t.width, e.x + e.width), r = aw(t.y, e.y),
            o = sw(t.y + t.height, e.y + e.height);
    ...
    function fs(t, e, n) {
        ...
        return n = n || {
            ...
            width: 2,
            height: 2
        }, t ? 0 === t.indexOf("image://") ? (r.image = t.slice(8), c(r, n), new Lx(i)) : Xa(t.replace("path://", ""), i, n, "center") : void 0
    }
    ...
    function gs(t, e, n, i, r, o, a, s) {
        var l = n - t, u = i - e, h = a - r, c = s - o, p = ys(h, c, l, u);
        if (vs(p)) return !1;
        var f = t - r, d = e - o, g = ys(f, d, l, u) / p;
        if (0 > g || g > 1) return !1;
        var y = ys(f, d, h, c) / p;
        return 0 > y || y > 1 ? !1 : !0
    }
    ...
    function ms(t, e) {
        for (var n = 0; n < Zx.length; n++) {
            var i = Zx[n], r = e[i], o = t.ensureState(i);
    ...
    function _s(t, e, n) {
        ...
        for (var l = {normal: i}, u = 0; u < Zx.length; u++) {
            var h = Zx[u], c = e[h];
    ...
    function xs(t, e, n, i) {
        n = n || fw;
        for (var r = t instanceof Fx, o = !1, a = 0; a < Kx.length; a++) {
            var s = e[Kx[a]];
        ...
        if (o) {
            r || (l || (l = new Fx, t.setTextContent(l)), t.stateProxy && (l.stateProxy = t.stateProxy));
            var u = _s(n, e), h = e.normal, c = !!h.getShallow("show"), p = ws(h, i && i.normal, n, !1, !r);
            ...
            l.silent = !!h.getShallow("silent"), null != l.style.x && (p.x = l.style.x), null != l.style.y && (p.y = l.style.y), l.ignore = !c, l.useStyle(p), l.dirty(), n.enableTextSetter && (vw(l).setLabelText = function (t) {
                var i = _s(n, e, t);
                ms(l, i)
            })
        } else l && (l.ignore = !0);
    ...
    function bs(t, e) {
        e = e || "label";
        for (var n = {normal: t.getModel(e)}, i = 0; i < Zx.length; i++) {
            var r = Zx[i];
            n[r] = t.getModel([r, e])
        }
        return n
    ...
    function Ms(t, e, n, i, r) {
        ...
        null != p && (t.margin = p), Cs(t, e, s, n, i, r, !0, !1)
    }

    function Ts(t) {
        for (var e; t && t !== t.ecModel;) {
            var n = (t.option || fw).rich;
            if (n) {
                e = e || {};
    ...
    function Cs(t, e, n, i, r, o, a, s) {
        ...
        for (var g = 0; g < dw.length; g++) {
            var y = dw[g], v = N(e.getShallow(y), n[y]);
            null != v && (t[y] = v)
        }
        for (var g = 0; g < gw.length; g++) {
            var y = gw[g], v = e.getShallow(y);
            null != v && (t[y] = v)
        }
    ...
    function As(t, e, n, i, r) {
        function o(i) {
            ...
            var h = _s({labelDataIndex: e, labelFetcher: r, defaultText: s ? s(o) : o + ""}, a.statesModels, o);
            ms(t, h)
        }
    ...
    function Rs(t, e) {
        t = t.toUpperCase(), Ew[t] = new Iw(e), Rw[t] = e
    }

    function Es(t) {
        if (C(t)) {
            var e = Rw[t.toUpperCase()] || {};
            return t === Lw || t === Pw ? s(e) : l(s(e), s(Rw[Ow]), !1)
        }
        return l(s(t), s(Rw[Ow]), !1)
    }
    ...
    function Gs(t, e, n, i) {
        var r = Di(t), o = r[Xs(n)](), a = r[js(n)]() + 1, s = Math.floor((a - 1) / 4) + 1, l = r[qs(n)](),
            u = r["get" + (n ? "UTC" : "") + "Day"](), h = r[Zs(n)](), c = (h - 1) % 12 + 1, p = r[Ks(n)](),
            f = r[$s(n)](), d = r[Qs(n)](), g = i instanceof Iw ? i : Bs(i || Bw) || zs(), y = g.getModel("time"),
            v = y.get("month"), m = y.get("monthAbbr"), _ = y.get("dayOfWeek"), x = y.get("dayOfWeekAbbr");
        return (e || "").replace(/{yyyy}/g, o + "").replace(/{yy}/g, o % 100 + "").replace(/{Q}/g, s + "").replace(/{MMMM}/g, v[a - 1]).replace(/{MMM}/g, m[a - 1]).replace(/{MM}/g, Ns(a, 2)).replace(/{M}/g, a + "").replace(/{dd}/g, Ns(l, 2)).replace(/{d}/g, l + "").replace(/{eeee}/g, _[u]).replace(/{ee}/g, x[u]).replace(/{e}/g, u + "").replace(/{HH}/g, Ns(h, 2)).replace(/{H}/g, h + "").replace(/{hh}/g, Ns(c + "", 2)).replace(/{h}/g, c + "").replace(/{mm}/g, Ns(p, 2)).replace(/{m}/g, p + "").replace(/{ss}/g, Ns(f, 2)).replace(/{s}/g, f + "").replace(/{SSS}/g, Ns(d, 3)).replace(/{S}/g, d + "")
    }
    ...
    function Ws(t, e, n, i, r) {
        ...
        if ("string" == typeof n) o = n; else if ("function" == typeof n) o = n(t.value, e, {level: t.level}); else {
            var a = h({}, Gw);
            if (t.level > 0) for (var s = 0; s < Yw.length; ++s) a[Yw[s]] = "{primary|" + a[Yw[s]] + "}";
            var l = n ? n.inherit === !1 ? n : c(n, a) : a, u = Us(t.value, r);
            if (l[u]) o = l[u]; else if (l.inherit) {
                for (var p = Xw.indexOf(u), s = p - 1; s >= 0; --s) if (l[u]) {
                    o = l[u];
                    break
                }
                o = o || a.none
    ...
    function Us(t, e) {
        var n = Di(t), i = n[js(e)]() + 1, r = n[qs(e)](), o = n[Zs(e)](), a = n[Ks(e)](), s = n[$s(e)](),
            l = n[Qs(e)](), u = 0 === l, h = u && 0 === s, c = h && 0 === a, p = c && 0 === o, f = p && 1 === r,
            d = f && 1 === i;
    ...
    function ul(t) {
        return null == t ? "" : (t + "").replace(qw, function (t, e) {
            return Zw[e]
        })
    }
    ...
    function cl(t, e, n) {
        ...
        for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
            var a = Kw[o];
            t = t.replace($w(a), $w(a, 0))
        }
        for (var s = 0; i > s; s++) for (var l = 0; l < r.length; l++) {
            var u = e[s][r[l]];
            t = t.replace($w(Kw[l], s), n ? ul(u) : u)
        }
        return t
    }
    ...
    function pl(t, e) {
        ...
        if (!i) return "";
        if ("html" === o) return "subItem" === r ? '<span style="display:inline-block;vertical-align:middle;margin-right:8px;margin-left:3px;border-radius:4px;width:4px;height:4px;background-color:' + ul(i) + ";" + (e || "") + '"></span>' : '<span style="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;background-color:' + ul(i) + ";" + (e || "") + '"></span>';
    ...
    function fl(t, e, n) {
        ...
        return t = t.replace("MM", Ns(a, 2)).replace("M", a).replace("yyyy", o).replace("yy", o % 100 + "").replace("dd", Ns(s, 2)).replace("d", s).replace("hh", Ns(l, 2)).replace("h", l).replace("mm", Ns(u, 2)).replace("m", u).replace("ss", Ns(h, 2)).replace("s", h).replace("SSS", Ns(c, 3))
    }
    ...
    function xl(t, e, n) {
        ...
        !M(s) && (s = [s, s]);
        var l = i(tS[0], 0), u = i(tS[1], 1);
        a(tS[0], t, l), a(tS[1], t, u)
    }
    ...
    function Sl(t) {
        var e = [];
        return y(iS.getClassesByMainType(t), function (t) {
    ...
    function Tl(t, e, n) {
        ...
        var o = {}, a = Il(e);
        if (!a || !t) return o;
        var s, l, u = [], h = [], c = e.ecModel, p = _S(c).datasetMap, f = a.uid + "_" + n.seriesLayoutBy;
    ...
    function Cl(t, e, n) {
        ...
        var l = function () {
            ...
            for (var i = {}, r = {}, l = [], u = 0, h = Math.min(5, n); h > u; u++) {
                var c = kl(e.data, a, e.seriesLayoutBy, s, e.startIndex, u);
                l.push(c);
                var p = c === mS.Not;
                if (p && null == i.v && u !== o && (i.v = u), (null == i.n || i.n === i.v || !p && l[i.n] === mS.Not) && (i.n = u), t(i) && l[i.n] !== mS.Not) return i;
                p || (c === mS.Might && null == r.v && u !== o && (r.v = u), (null == r.n || r.n === r.v) && (r.n = u))
            }
    ...
    function Al(t, e) {
        return kl(t.data, t.sourceFormat, t.seriesLayoutBy, t.dimensionsDefine, t.startIndex, e)
    }

    function kl(t, e, n, i, r, o) {
        function a(t) {
            var e = C(t);
            return null != t && isFinite(t) && "" !== t ? e ? mS.Might : mS.Not : e && "-" !== t ? mS.Must : void 0
        }

        var s, l = 5;
        if (L(t)) return mS.Not;
        var u, h;
        if (i) {
            var c = i[o];
            A(c) ? (u = c.name, h = c.type) : C(c) && (u = c)
        }
        if (null != h) return "ordinal" === h ? mS.Must : mS.Not;
        if (e === cS) {
            var p = t;
            if (n === vS) {
            ...
            if (!u) return mS.Not;
            var f = m[u];
            if (!f || L(f)) return mS.Not;
            for (var d = 0; d < f.length && l > d; d++) if (null != (s = a(f[d]))) return s
        } else if (e === hS) for (var _ = t, d = 0; d < _.length && l > d; d++) {
            var v = _[d], x = Gi(v);
            if (!M(x)) return mS.Not;
    ...
    function Bl(t, e) {
        ...
        y(e, function (e, i) {
            "colorLayer" === i && n || iS.hasClass(i) || ("object" == typeof e ? t[i] = t[i] ? l(t[i], e, !1) : s(e) : null == t[i] && (t[i] = e))
        })
    }
    ...
    function Ul(t) {
        var e = t && t.itemStyle;
        if (e) for (var n = 0, i = FS.length; i > n; n++) {
            var r = FS[n], o = e.normal, a = e.emphasis;
    ...
    function Xl(t) {
        Yl(t, "itemStyle"), Yl(t, "lineStyle"), Yl(t, "areaStyle"), Yl(t, "label"), Yl(t, "labelLine"), Yl(t, "upperLabel"), Yl(t, "edgeLabel")
    }

    function jl(t, e) {
        var n = NS(t) && t[e], i = NS(n) && n.textStyle;
        if (i) for (var r = 0, o = u_.length; o > r; r++) {
            var a = u_[r];
    ...
    function Zl(t) {
        if (NS(t)) {
            Ul(t), Xl(t), jl(t, "label"), jl(t, "upperLabel"), jl(t, "edgeLabel"), t.emphasis && (jl(t.emphasis, "label"), jl(t.emphasis, "upperLabel"), jl(t.emphasis, "edgeLabel"));
            var e = t.markPoint;
            e && (Ul(e), ql(e));
            var n = t.markLine;
            n && (Ul(n), ql(n));
            ...
            if ("graph" === t.type) {
                ...
                if (o && !L(o)) for (var a = 0; a < o.length; a++) ql(o[a]);
                y(t.categories, function (t) {
                    Xl(t)
                })
            }
            if (r && !L(r)) for (var a = 0; a < r.length; a++) ql(r[a]);
            if (e = t.markPoint, e && e.data) for (var s = e.data, a = 0; a < s.length; a++) ql(s[a]);
            if (n = t.markLine, n && n.data) for (var l = n.data, a = 0; a < l.length; a++) M(l[a]) ? (ql(l[a][0]), ql(l[a][1])) : ql(l[a]);
            "gauge" === t.type ? (jl(t, "axisLabel"), jl(t, "title"), jl(t, "detail")) : "treemap" === t.type ? (Yl(t.breadcrumb, "itemStyle"), y(t.levels, function (t) {
                Xl(t)
    ...
    function Ql(t, e) {
        zS(Kl(t.series), function (t) {
            NS(t) && Zl(t)
        });
        var n = ["xAxis", "yAxis", "radiusAxis", "angleAxis", "singleAxis", "parallelAxis", "radar"];
        e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"), zS(n, function (e) {
            zS(Kl(t[e]), function (t) {
                t && (jl(t, "axisLabel"), jl(t.axisPointer, "label"))
            })
        }), zS(Kl(t.parallel), function (t) {
            var e = t && t.parallelAxisDefault;
            jl(e, "axisLabel"), jl(e && e.axisPointer, "label")
        }), zS(Kl(t.calendar), function (t) {
            Yl(t, "itemStyle"), jl(t, "dayLabel"), jl(t, "monthLabel"), jl(t, "yearLabel")
        }), zS(Kl(t.radar), function (t) {
            jl(t, "name"), t.name && null == t.axisName && (t.axisName = t.name, delete t.name), null != t.nameGap && null == t.axisNameGap && (t.axisNameGap = t.nameGap, delete t.nameGap)
        }), zS(Kl(t.geo), function (t) {
            NS(t) && (ql(t), zS(Kl(t.regions), function (t) {
                ql(t)
            }))
        }), zS(Kl(t.timeline), function (t) {
            ql(t), Yl(t, "label"), Yl(t, "itemStyle"), Yl(t, "controlStyle", !0);
            var e = t.data;
            M(e) && y(e, function (t) {
                A(t) && (Yl(t, "label"), Yl(t, "itemStyle"))
            })
        }), zS(Kl(t.toolbox), function (t) {
            Yl(t, "iconStyle"), zS(t.feature, function (t) {
                Yl(t, "iconStyle")
            })
    ...
    function au(t, e) {
        if (t) for (var n = 0; n < t.length; n++) e(t[n]), t[n] && au(t[n].children, e)
    }
        ...
        Ql(t, e), t.series = Vi(t.series), y(t.series, function (t) {
            if (A(t)) {
                ...
                if ("line" === e) null != t.clipOverflow && (t.clip = t.clipOverflow); else if ("pie" === e || "gauge" === e) {
                    ...
                    var n = t.data;
                    if (n && !L(n)) for (var i = 0; i < n.length; i++) iu(n[i]);
                    ...
                    var n = t.data;
                    if (n && !L(n)) for (var i = 0; i < n.length; i++) "object" == typeof n[i] && (nu(n[i]), nu(n[i] && n[i].emphasis))
                } else if ("sunburst" === e) {
                    var o = t.highlightPolicy;
                    o && (t.emphasis = t.emphasis || {}, t.emphasis.focus || (t.emphasis.focus = o)), ru(t), au(t.data, ru)
                } else "graph" === e || "sankey" === e ? ou(t) : "map" === e && (t.mapType && !t.map && (t.map = t.mapType), t.mapLocation && c(t, t.mapLocation));
                null != t.hoverAnimation && (t.emphasis = t.emphasis || {}, t.emphasis && null == t.emphasis.scale && (t.emphasis.scale = t.hoverAnimation)), eu(t)
            }
        }), t.dataRange && (t.visualMap = t.dataRange), y(HS, function (e) {
            var n = t[e];
    ...
    function cu(t, e, n, i) {
        n = n || gu(t);
        var r = e.seriesLayoutBy, o = yu(t, n, r, e.sourceHeader, e.dimensions), a = new WS({
            data: t,
            sourceFormat: n,
            seriesLayoutBy: r,
    ...
    function pu(t) {
        return new WS({data: t, sourceFormat: L(t) ? dS : hS})
    }
    ...
    function yu(t, e, n, i, r) {
        var o, a;
        if (!t) return {dimensionsDefine: mu(r), startIndex: a, dimensionsDetectedCount: o};
        if (e === cS) {
            var s = t;
            "auto" === i || null == i ? _u(function (t) {
                ...
                r[e] = null != t ? t + "" : ""
            }, n, s, 1 / 0)), o = r ? r.length : n === vS ? s.length : s[0] ? s[0].length : null
        } else if (e === pS) r || (r = vu(t)); else if (e === fS) r || (r = [], y(t, function (t, e) {
            r.push(e)
        })); else if (e === hS) {
            var l = Gi(t[0]);
            o = M(l) && l.length || 1
        }
        return {startIndex: a, dimensionsDefine: mu(r), dimensionsDetectedCount: o}
    }
    ...
    function _u(t, e, n, i) {
        if (e === vS) for (var r = 0; r < n.length && i > r; r++) t(n[r] ? n[r][0] : null, r);
    ...
    function Du(t, e) {
        var n = new iM, i = t.data, r = n.sourceFormat = t.sourceFormat, o = t.startIndex, a = "";
        t.seriesLayoutBy !== yS && Fi(a);
        ...
        e.__isBuiltIn && (n.getRawDataItem = function (t) {
            return c(i, o, s, t)
        }, n.getRawData = pv(Au, null, t)), n.cloneRawData = pv(ku, null, t);
        var p = bu(r, yS);
        n.count = pv(p, null, i, o, s);
        var f = wu(r);
        ...
        return n.getDimensionInfo = pv(Lu, null, s, l), n.cloneAllDimensionInfo = pv(Pu, null, s), n
    }
    ...
    function Ou(t) {
        ...
        2 !== i.length && Fi(n);
        var r = !1;
        "echarts" === i[0] && (e = i[1], r = !0), t.__isBuiltIn = r, rM.set(e, t)
    }
    ...
    function Eu(t, e) {
        ...
        return v(a, function (t, n) {
            ...
            } else o = {seriesLayoutBy: yS, sourceHeader: 0, dimensions: t.dimensions};
    ...
    function Yu(t) {
        ...
        return {html: sM[e], richText: lM[e]}
    }

    function Xu(t, e) {
        var n = '<div style="clear:both"></div>', i = "margin: " + e + "px 0 0";
        return '<div style="' + i + ";" + aM + ';">' + t + n + "</div>"
    }
    ...
    function Ju(t) {
        var e, n, i, r, o = t.series, a = t.dataIndex, s = t.multipleSeries, l = o.getData(),
            u = l.mapDimensionsAll("defaultedTooltip"), h = u.length, c = o.getRawValue(a), p = M(c), f = $u(o, a);
        if (h > 1 || p && !h) {
            var d = th(c, o, a, u, f);
    ...
    function ph(t, e, n) {
        var i = rr(t, e), r = e && null != e.highlightKey ? _a(e.highlightKey) : null;
    ...
    function dh(t) {
        var e = t.model, n = t.ecModel, i = t.api, r = t.payload, o = e.pipelineContext.progressiveRender, a = t.view,
            s = r && dM(r).updateMethod, l = o ? "incrementalPrepareRender" : s && a[s] ? s : "render";
        return "render" !== l && a[l](e, n, i, r), mM[l]
    }
    ...
    function yh(t, e, n, i) {
        var r = t[e];
        if (r) {
            var o = r[_M] || r, a = r[bM], s = r[xM];
            if (s !== n || a !== i) {
                if (null == n || !i) return t[e] = o;
                r = t[e] = gh(o, n, "debounce" === i), r[_M] = o, r[bM] = i, r[xM] = n
            }
            return r
        }
    }
    ...
    function vh(t, e) {
        var n = t.visualStyleMapper || SM[e];
        return n ? n : (console.warn("Unkown style type '" + e + "'."), SM.itemStyle)
    }

    function mh(t, e) {
        var n = t.visualDrawType || MM[e];
    ...
    function _h(t, e) {
        ...
        var n = new $m, i = new Ex({style: {fill: e.maskColor}, zlevel: e.zlevel, z: 1e4});
        n.add(i);
        var r = new Fx({
            style: {
                text: e.text,
        ...
        n.add(o);
        var a;
        return e.showSpinner && (a = new qb({
            shape: {startAngle: -AM / 2, endAngle: -AM / 2 + .1, r: e.spinnerRadius},
            style: {stroke: e.color, lineCap: "round", lineWidth: e.lineWidth},
            zlevel: e.zlevel,
            z: 10001
        }), a.animateShape(!0).when(1e3, {endAngle: 3 * AM / 2}).start("circularInOut"), a.animateShape(!0).when(1e3, {startAngle: 3 * AM / 2}).delay(300).start("circularInOut"), n.add(a)), n.resize = function () {
    ...
    function Rh(t, e, n, i, r, o, a, s, l) {
        ...
        a /= u, s /= u;
        var h = a * n + t, c = s * n + e;
        if (Math.abs(i - r) % jM < 1e-4) return l[0] = h, l[1] = c, u - n;
        if (o) {
            var p = i;
            i = co(r), r = co(p)
        } else i = co(i), r = co(r);
        ...
        if (0 > f && (f += jM), f >= i && r >= f || f + jM >= i && r >= f + jM) return l[0] = h, l[1] = c, u - n;
    ...
    function zh(t, e, n) {
        var i = Bh(e.x, e.y, e.width, e.height, t.x, t.y, KM);
        return n.set(KM[0], KM[1]), i
    }
        ...
        for (var i, r, o = 0, a = 0, s = 0, l = 0, u = 1 / 0, h = e.data, c = t.x, p = t.y, f = 0; f < h.length;) {
            ...
            switch (d) {
                case qM.M:
                    ...
                    break;
                case qM.L:
                    g = Eh(o, a, h[f], h[f + 1], c, p, KM, !0), o = h[f++], a = h[f++];
                    break;
                case qM.C:
                    g = Xr(o, a, h[f++], h[f++], h[f++], h[f++], h[f], h[f + 1], c, p, KM), o = h[f++], a = h[f++];
                    break;
                case qM.Q:
                    g = Jr(o, a, h[f++], h[f++], h[f], h[f + 1], c, p, KM), o = h[f++], a = h[f++];
                    break;
                case qM.A:
                    ...
                    var S = (c - y) * _ / m + y;
                    g = Rh(y, v, _, x, x + b, w, S, p, KM), o = Math.cos(x + b) * m + y, a = Math.sin(x + b) * _ + v;
                    break;
                case qM.R:
                    s = o = h[f++], l = a = h[f++];
                    var M = h[f++], T = h[f++];
                    ...
                    break;
                case qM.Z:
                    g = Eh(o, a, s, l, c, p, KM, !0), o = s, a = l
            }
            u > g && (u = g, n.set(KM[0], KM[1]))
        }
        return u
    }
    ...
    function Fh(t, e) {
        if (t) {
            ...
            if (i && n) {
                var r = t.textGuideLineConfig || {}, o = [[0, 0], [0, 0], [0, 0]], a = r.candidates || ZM,
                ...
                for (var f = 0; f < a.length; f++) {
                    var d = a[f];
                    Oh(d, 0, s, $M, tT), um.scaleAndAdd(QM, $M, tT, p), QM.transform(c);
                    var g = t.getBoundingRect(),
                        y = u ? u.distance(QM) : t instanceof Cx ? Nh(QM, t.path, JM) : zh(QM, g, JM);
                    l > y && (l = y, QM.transform(h), JM.transform(h), JM.toArray(o[0]), QM.toArray(o[1]), $M.toArray(o[2]))
                }
                Vh(o, e.get("minTurnAngle")), n.setShape({points: o})
            }
        }
    }
    ...
    function Vh(t, e) {
        if (180 >= e && e > 0) {
            e = e / 180 * Math.PI, $M.fromArray(t[0]), QM.fromArray(t[1]), JM.fromArray(t[2]), um.sub(tT, $M, QM), um.sub(eT, JM, QM);
            var n = tT.len(), i = eT.len();
            if (!(.001 > n || .001 > i)) {
                tT.scale(1 / n), eT.scale(1 / i);
                var r = tT.dot(eT), o = Math.cos(e);
                if (r > o) {
                    var a = Eh(QM.x, QM.y, JM.x, JM.y, $M.x, $M.y, nT, !1);
                    iT.fromArray(nT), iT.scaleAndAdd(eT, a / Math.tan(Math.PI - e));
                    var s = JM.x !== QM.x ? (iT.x - QM.x) / (JM.x - QM.x) : (iT.y - QM.y) / (JM.y - QM.y);
                    if (isNaN(s)) return;
                    0 > s ? um.copy(iT, QM) : s > 1 && um.copy(iT, JM), iT.toArray(t[1])
                }
            }
        }
    }
    ...
    function Hh(t, e, n) {
        if (180 >= n && n > 0) {
            n = n / 180 * Math.PI, $M.fromArray(t[0]), QM.fromArray(t[1]), JM.fromArray(t[2]), um.sub(tT, QM, $M), um.sub(eT, JM, QM);
            var i = tT.len(), r = eT.len();
            if (!(.001 > i || .001 > r)) {
                tT.scale(1 / i), eT.scale(1 / r);
                var o = tT.dot(e), a = Math.cos(n);
                if (a > o) {
                    var s = Eh(QM.x, QM.y, JM.x, JM.y, $M.x, $M.y, nT, !1);
                    iT.fromArray(nT);
                    var l = Math.PI / 2, u = Math.acos(eT.dot(e)), h = l + u - n;
                    if (h >= l) um.copy(iT, JM); else {
                        iT.scaleAndAdd(eT, s / Math.tan(Math.PI / 2 - h));
                        var c = JM.x !== QM.x ? (iT.x - QM.x) / (JM.x - QM.x) : (iT.y - QM.y) / (JM.y - QM.y);
                        if (isNaN(c)) return;
                        0 > c ? um.copy(iT, QM) : c > 1 && um.copy(iT, JM)
                    }
                    iT.toArray(t[1])
                }
            }
    ...
    function Uh(t, e, n) {
        ...
        for (var o = e.normal, a = o.get("show"), s = r.ignore, l = 0; l < Kx.length; l++) {
            var u = Kx[l], h = e[u], p = "normal" === u;
            if (h) {
                ...
                i || (i = new Vb, t.setTextGuideLine(i), p || !s && a || Gh(i, !0, "normal", e.normal), t.stateProxy && (i.stateProxy = t.stateProxy)), Gh(i, !1, u, h)
            }
        }
        if (i) {
    ...
    function Kh(t) {
        ...
        for (var i = new mm(0, 0, 0, 0), r = 0; r < t.length; r++) {
    ...
    function oc(t, e, n, i, r, o, a) {
        ...
        var l;
        return l = 0 === t.indexOf("image://") ? ja(t.slice(8), new mm(e, n, i, r), a ? "center" : "cover") : 0 === t.indexOf("path://") ? Xa(t.slice(7), {}, new mm(e, n, i, r), a ? "center" : "cover") : new _T({
            shape: {
                symbolType: t,
                x: e,
                y: n,
    ...
    function lc(t, e, n) {
        for (var i = "radial" === e.type ? sc(t, e, n) : ac(t, e, n), r = e.colorStops, o = 0; o < r.length; o++) i.addColorStop(r[o].offset, r[o].color);
        return i
    }
    ...
    function yc(t, e, n, i) {
        var r = cc(n), o = pc(n), a = n.strokePercent, s = 1 > a, l = !e.path;
        ...
        if (!i) {
            ...
            (p || f) && (b = e.getBoundingRect()), p && (y = e.__dirty ? lc(t, h, b) : e.__canvasFillGradient, e.__canvasFillGradient = y), f && (m = e.__dirty ? lc(t, c, b) : e.__canvasStrokeGradient, e.__canvasStrokeGradient = m), d && (_ = e.__dirty || !e.__canvasFillPattern ? gc(t, h, e) : e.__canvasFillPattern, e.__canvasFillPattern = _), g && (x = e.__dirty || !e.__canvasStrokePattern ? gc(t, c, e) : e.__canvasStrokePattern, e.__canvasStrokePattern = _), p ? t.fillStyle = y : d && (_ ? t.fillStyle = _ : o = !1), f ? t.strokeStyle = m : g && (x ? t.strokeStyle = x : r = !1)
        }
        var w = n.lineDash && n.lineWidth > 0 && hc(n.lineDash, n.lineWidth), S = n.lineDashOffset, M = !!t.setLineDash,
            T = e.getGlobalScale();
    ...
    function mc(t, e, n) {
        var i = n.text;
        if (null != i && (i += ""), i) {
            t.font = n.font || xm, t.textAlign = n.textAlign, t.textBaseline = n.textBaseline;
            var r = void 0;
            if (t.setLineDash) {
                var o = n.lineDash && n.lineWidth > 0 && hc(n.lineDash, n.lineWidth), a = n.lineDashOffset;
                if (o) {
            ...
            n.strokeFirst ? (cc(n) && t.strokeText(i, n.x, n.y), pc(n) && t.fillText(i, n.x, n.y)) : (pc(n) && t.fillText(i, n.x, n.y), cc(n) && t.strokeText(i, n.x, n.y)), r && t.setLineDash([])
        }
    }
    ...
    function _c(t, e, n, i, r) {
        ...
        (i || e.opacity !== n.opacity) && (o || (Cc(t, r), o = !0), t.globalAlpha = null == e.opacity ? C_.opacity : e.opacity), (i || e.blend !== n.blend) && (o || (Cc(t, r), o = !0), t.globalCompositeOperation = e.blend || C_.blend);
        for (var a = 0; a < bT.length; a++) {
            var s = bT[a];
            (i || e[s] !== n[s]) && (o || (Cc(t, r), o = !0), t[s] = t.dpr * (e[s] || 0))
        }
        return (i || e.shadowColor !== n.shadowColor) && (o || (Cc(t, r), o = !0), t.shadowColor = e.shadowColor || C_.shadowColor), o
    }

    function xc(t, e, n, i, r) {
        var o = Ic(e, r.inHover), a = i ? null : n && Ic(n, r.inHover) || {};
        if (o === a) return !1;
        var s = _c(t, o, a, i, r);
        if ((i || o.fill !== a.fill) && (s || (Cc(t, r), s = !0), t.fillStyle = o.fill), (i || o.stroke !== a.stroke) && (s || (Cc(t, r), s = !0), t.strokeStyle = o.stroke), (i || o.opacity !== a.opacity) && (s || (Cc(t, r), s = !0), t.globalAlpha = null == o.opacity ? 1 : o.opacity), e.hasStroke()) {
            var l = o.lineWidth, u = l / (o.strokeNoScale && e && e.getLineScale ? e.getLineScale() : 1);
            t.lineWidth !== u && (s || (Cc(t, r), s = !0), t.lineWidth = u)
        }
        for (var h = 0; h < wT.length; h++) {
            var c = wT[h], p = c[0];
            (i || o[p] !== a[p]) && (s || (Cc(t, r), s = !0), t[p] = o[p] || c[1])
        }
        return s
    }

    function bc(t, e, n, i, r) {
        return _c(t, Ic(e, r.inHover), n && Ic(n, r.inHover), i, r)
    }
    ...
    function Dc(t, e) {
        Ac(t, e, {inHover: !1, viewWidth: 0, viewHeight: 0}, !0)
    }

    function Ac(t, e, n, i) {
        var r = e.transform;
        if (!e.shouldBePainted(n.viewWidth, n.viewHeight, !1, !1)) return e.__dirty &= ~Om.REDARAW_BIT, void (e.__isRendered = !1);
        var o = e.__clipPaths, a = n.prevElClipPaths, s = !1, l = !1;
        if ((!a || uc(o, a)) && (a && a.length && (Cc(t, n), t.restore(), l = s = !0, n.prevElClipPaths = null, n.allClipped = !1, n.prevEl = null), o && o.length && (Cc(t, n), t.save(), Sc(o, t, n), s = !0), n.prevElClipPaths = o), n.allClipped) return void (e.__isRendered = !1);
        e.beforeBrush && e.beforeBrush(), e.innerBeforeBrush();
        var u = n.prevEl;
        u || (l = s = !0);
        var h = e instanceof Cx && e.autoBatch && Tc(e.style);
        s || Mc(r, u.transform) ? (Cc(t, n), wc(t, e)) : h || Cc(t, n);
        var c = Ic(e, n.inHover);
        e instanceof Cx ? (n.lastDrawType !== ST && (l = !0, n.lastDrawType = ST), xc(t, e, u, l, n), h && (n.batchFill || n.batchStroke) || t.beginPath(), yc(t, e, c, h), h && (n.batchFill = c.fill || "", n.batchStroke = c.stroke || "")) : e instanceof Dx ? (n.lastDrawType !== TT && (l = !0, n.lastDrawType = TT), xc(t, e, u, l, n), mc(t, e, c)) : e instanceof Lx ? (n.lastDrawType !== MT && (l = !0, n.lastDrawType = MT), bc(t, e, u, l, n), vc(t, e, c)) : e instanceof ow && (n.lastDrawType !== CT && (l = !0, n.lastDrawType = CT), kc(t, e, n)), h && i && Cc(t, n), e.innerAfterBrush(), e.afterBrush && e.afterBrush(), n.prevEl = e, e.__dirty = 0, e.__isRendered = !0
    }
    ...
    function kc(t, e, n) {
        ...
        for (o = e.getCursor(), a = i.length; a > o; o++) {
            var l = i[o];
            l.beforeBrush && l.beforeBrush(), l.innerBeforeBrush(), Ac(t, l, s, o === a - 1), l.innerAfterBrush(), l.afterBrush && l.afterBrush(), s.prevEl = l
        }
        for (var u = 0, h = r.length; h > u; u++) {
            var l = r[u];
            l.beforeBrush && l.beforeBrush(), l.innerBeforeBrush(), Ac(t, l, s, u === h - 1), l.innerAfterBrush(), l.afterBrush && l.afterBrush(), s.prevEl = l
        }
    ...
    function Lc(t, e) {
        function n(t) {
            ...
            function n() {
                function t(t, e, n, a, l) {
                    var u = o ? 1 : i, h = oc(l, t * u, e * u, n * u, a * u, s.color, s.symbolKeepAspect);
                    o ? b.appendChild(r.painter.paintOne(h)) : Dc(d, h)
                }
            ...
            for (var a = [i], l = !0, u = 0; u < AT.length; ++u) {
                var h = s[AT[u]], c = typeof h;
            ...
            var d, g = Oc(s.dashArrayX), y = Rc(s.dashArrayY), v = Pc(s.symbol), m = Ec(g), _ = Bc(y), x = !o && cv(),
                b = o && r.painter.createSVGElement("g"), w = e();
            x && (x.width = w.width * i, x.height = w.height * i, d = x.getContext("2d")), n(), l && DT.put(p, x || b), t.image = x, t.svgElement = b, t.svgWidth = w.width, t.svgHeight = w.height
        }
        ...
        var l = {repeat: "repeat"};
        return n(l), l.rotation = s.rotation, l.scaleX = l.scaleY = o ? 1 : 1 / i, IT.set(t, l), t.dirty = !1, l
    }
    ...
    function Vc(t, e, n) {
        return n[0] = n[0] && n[0].toLowerCase(), Sv.prototype[e].apply(t, n)
    }
    ...
    function Hc(t, e, n) {
        ...
        if (i) return i;
        var r = new PC(t, e, n);
        return r.id = "ec_" + XC++, UC[r.id] = r, lr(t, qC, r.id), DC(r), LT(FC, function (t) {
            t(r)
        }), r
    }
    ...
    function Gc(t) {
        if (M(t)) {
            var e = t;
            t = null, LT(e, function (e) {
                null != e.group && (t = e.group)
            }), t = t || "g_" + jC++, LT(e, function (e) {
                e.group = t
            })
        }
        return YC[t] = !0, t
    ...
    function Uc(t) {
        "string" == typeof t ? t = UC[t] : t instanceof PC || (t = Yc(t)), t instanceof PC && !t.isDisposed() && t.dispose()
    }
    ...
    function Kc(t) {
        RT(FC, t) < 0 && t && FC.push(t)
    }

    function $c(t) {
        RT(VC, t) < 0 && t && VC.push(t)
    }

    function Qc(t, e, n) {
        "function" == typeof e && (n = e, e = "");
        var i = OT(t) ? t.type : [t, t = {event: e}][0];
        t.event = (t.event || i).toLowerCase(), e = t.event, BC[e] || (kT(rC.test(i) && rC.test(e)), EC[i] || (EC[i] = {
            action: n,
            actionInfo: t
        }), BC[e] = i)
    }
    ...
    function ip(t, e, n, i, r) {
        if ((PT(e) || OT(e)) && (n = e, e = i), !(RT(KC, n) >= 0)) {
            KC.push(n);
    ...
    function ap(t, e, n) {
        GM.registerMap(t, e, n)
    }

    function sp(t) {
        var e = GM.retrieveMap(t);
    ...
    function hp(t) {
        ...
        y(t.dimensions, function (e) {
            ...
            if (l) {
                ...
                cp(n, l)[u] = e, s.isExtraCoord || (i.set(l, 1), fp(s.type) && (r[0] = e), cp(a.encode, l)[u] = s.index), s.defaultTooltip && o.push(e)
            }
            uS.each(function (t, e) {
                var i = cp(n, e), r = s.otherDims[e];
    ...
    function dp(t, e, n) {
        function i(t, e, n) {
            null != uS.get(e) ? t.otherDims[e] = n : (t.coordDim = e, t.coordDimIndex = n, a.set(e, !0))
        }

        hu(e) || (e = pu(e)), n = n || {}, t = (t || []).slice();
        for (var r = (n.dimsDef || []).slice(), o = X(), a = X(), l = [], u = gp(e, t, r, n.dimCount), p = 0; u > p; p++) {
            var f = r[p], d = r[p] = h({}, A(f) ? f : {name: f}), g = d.name, v = l[p] = new dI;
        ...
        for (var M = b || "value", T = 0; u > T; T++) {
            var v = l[T] = l[T] || new dI, I = v.coordDim;
            null == I && (v.coordDim = yp(M, a, S), v.coordDimIndex = 0, (!b || 0 >= w) && (v.isExtraCoord = !0), w--), null == v.name && (v.name = yp(v.coordDim, o, !1)), null != v.type || Al(e, T) !== mS.Must && (!v.isExtraCoord || null == v.otherDims.itemName && null == v.otherDims.seriesName) || (v.type = "ordinal")
        }
        return l
    }
    ...
    function mp(t) {
        var e = t.get("coordinateSystem"), n = new DI(e), i = AI[e];
    ...
    function wp(t, e) {
        return bp(t, e) ? t.getCalculationInfo("stackResultDimension") : e
    }

    function Sp(t, e, n) {
        n = n || {}, hu(t) || (t = pu(t));
        var i, r = e.get("coordinateSystem"), o = RS.get(r), a = mp(e);
        ...
        var s, l, u = n.useEncodeDefaulter, h = vp(t, {
            coordDimensions: i,
    ...
    function Ip(t, e, n, i) {
        ...
        var s = r.intervalPrecision = Dp(a),
            l = r.niceTickExtent = [PI(Math.ceil(t[0] / a) * a, s), PI(Math.floor(t[1] / a) * a, s)];
        return kp(l, t), r
    }
    ...
    function kp(t, e) {
        !isFinite(t[0]) && (t[0] = e[0]), !isFinite(t[1]) && (t[1] = e[1]), Ap(t, 0, e), Ap(t, 1, e), t[0] > t[1] && (t[0] = t[1])
    }
    ...
    function Rp(t) {
        return t.get("stack") || BI + t.seriesIndex
    }
    ...
    function Hp(t, e) {
        var n = Bp(t, e), i = Np(n), r = {};
        y(n, function (t) {
            var e = t.getData(), n = t.coordinateSystem, o = n.getBaseAxis(), a = Rp(t), s = i[Ep(o)][a], l = s.offset,
                u = s.width, h = n.getOtherAxis(o), c = t.get("barMinHeight") || 0;
            r[a] = r[a] || [], e.setLayout({bandWidth: s.bandWidth, offset: l, size: u});
            for (var p = e.mapDimension(h.dim), f = e.mapDimension(o.dim), d = bp(e, p), g = h.isHorizontal(), y = Up(o, h, d), v = 0, m = e.count(); m > v; v++) {
                var _ = e.get(p, v), x = e.get(f, v), b = _ >= 0 ? "p" : "n", w = y;
                d && (r[a][x] || (r[a][x] = {p: y, n: y}), w = r[a][x][b]);
                var S = void 0, M = void 0, T = void 0, C = void 0;
                if (g) {
                    var I = n.dataToPoint([_, x]);
                    S = w, M = I[1] + l, T = I[0] - y, C = u, Math.abs(T) < c && (T = (0 > T ? -1 : 1) * c), isNaN(T) || d && (r[a][x][b] += T)
                } else {
                    var I = n.dataToPoint([x, _]);
                    S = I[0] + l, M = w, T = u, C = I[1] - y, Math.abs(C) < c && (C = (0 >= C ? -1 : 1) * c), isNaN(C) || d && (r[a][x][b] += C)
                }
                e.setItemLayout(v, {x: S, y: M, width: T, height: C})
            }
        })
    }
    ...
    function Xp(t) {
        return t /= Vw, t > 16 ? 16 : t > 7.5 ? 7 : t > 3.5 ? 4 : t > 1.5 ? 2 : 1
    }
    ...
    function qp(t) {
        return t /= Fw, t > 12 ? 12 : t > 6 ? 6 : t > 3.5 ? 4 : t > 2 ? 2 : 1
    }

    function Zp(t, e) {
        return t /= e ? Nw : zw, t > 30 ? 30 : t > 20 ? 20 : t > 15 ? 15 : t > 10 ? 10 : t > 5 ? 5 : t > 2 ? 2 : 1
    }
    ...
    function Qp(t, e, n, i) {
        ...
        function o(t, o, a) {
            ...
            if (!Yp(Fs(t), i[0], i[1], n)) {
                l && (o = [{value: $p(new Date(i[0]), t, n)}, {value: i[1]}]);
                for (var u = 0; u < o.length - 1; u++) {
                    ...
                    if (h !== c) {
                        ...
                        switch (t) {
                            case"year":
                                p = Math.max(1, Math.round(e / Vw / 365)), f = Xs(n), d = Js(n);
                                break;
                            case"half-year":
                            case"quarter":
                            case"month":
        ...
        for (var a = 1e4, s = Xw, l = 0, u = [], h = [], c = 0, p = 0, f = 0; f < s.length && l++ < a; ++f) {
            var d = Fs(s[f]);
            if (Vs(s[f])) {
    ...
    function tf(t, e, n) {
        ...
        return i ? i : (i = new JI(t, e, n), t.rawExtentInfo = i, i)
    }
    ...
    function nf(t, e) {
        var n = t.type, i = tf(t, e, t.getExtent()).calculate();
    ...
    function rf(t, e, n, i) {
        var r = n.axis.getExtent(), o = r[1] - r[0], a = Vp(i, n.axis);
    ...
    function of(t, e) {
        var n = nf(t, e), i = n.extent, r = e.get("splitNumber");
        t instanceof $I && (t.base = e.get("logBase"));
        var o = t.type;
    ...
    function af(t, e) {
        if (e = e || t.get("type")) switch (e) {
            ...
            case"time":
                return new HI({locale: t.ecModel.getLocaleModel(), useUTC: t.ecModel.get("useUTC")});
            default:
                return new (kI.getClass(e) || EI)
        }
    }
    ...
    function lf(t) {
        ...
        return "time" === t.scale.type ? function (e) {
            ...
            return function (i, r) {
                return null != n && (r = i.value - n), e(uf(t, i), r, null != i.level ? {level: i.level} : null)
            }
        }(e) : function (e) {
    ...
    function hf(t) {
        ...
        if (e.get(["axisLabel", "show"]) && !n.isBlank()) {
            ...
            n instanceof OI ? r = n.count() : (i = n.getTicks(), r = i.length);
            var a, s = t.getLabelModel(), l = lf(t), u = 1;
            r > 40 && (u = Math.ceil(r / 40));
            for (var h = 0; r > h; h += u) {
                var c = i ? i[h] : {value: o[0] + h}, p = l(c, h), f = s.getTextRect(p),
                    d = cf(f, s.get("rotate") || 0);
                a ? a.union(d) : a = d
            }
            return a
        }
    ...
    function cf(t, e) {
        var n = e * Math.PI / 180, i = t.width, r = t.height, o = i * Math.abs(Math.cos(n)) + Math.abs(r * Math.sin(n)),
            a = i * Math.abs(Math.sin(n)) + Math.abs(r * Math.cos(n)), s = new mm(t.x, t.y, o, a);
        return s
    }
    ...
    function ff(t) {
        return "category" === t.type && 0 === pf(t.getLabelModel())
    }
    ...
    function _f(t) {
        return M(t) ? void y(t, function (t) {
            _f(t)
        }) : void (p(oD, t) >= 0 || (oD.push(t), T(t) && (t = {install: t}), t.install(aD)))
    }
    ...
    function bf(t, e, n) {
        ...
        var s = t[0];
        return xf(r[0], s[0]) && xf(r[1], s[1]) || (i += fo(r[0], r[1], s[0], s[1], e, n)), 0 !== i
    }
    ...
    function wf(t) {
        ...
        for (var i = e.features, r = 0; r < i.length; r++) {
            ...
            if ("Polygon" === a.type) for (var s = a.coordinates, l = 0; l < s.length; l++) s[l] = Sf(s[l], a.encodeOffsets[l], n); else if ("MultiPolygon" === a.type) for (var s = a.coordinates, l = 0; l < s.length; l++) for (var u = s[l], h = 0; h < u.length; h++) u[h] = Sf(u[h], a.encodeOffsets[l][h], n)
        }
    ...
    function Mf(t, e) {
        return t = wf(t), v(_(t.features, function (t) {
            ...
            var a = new lD(n[e || "name"], r, n.cp);
            return a.properties = n, a
        })
    }

    function Tf(t) {
        return "category" === t.type ? If(t) : kf(t)
    }
    ...
    function If(t) {
        var e = t.getLabelModel(), n = Df(t, e);
        return !e.get("show") || t.scale.isBlank() ? {labels: [], labelCategoryInterval: n.labelCategoryInterval} : n
    }

    function Df(t, e) {
        var n = Lf(t, "labels"), i = pf(e), r = Pf(n, i);
        if (r) return r;
        var o, a;
        return T(i) ? o = Nf(t, i) : (a = "auto" === i ? Rf(t) : i, o = zf(t, a)), Of(n, i, {
            labels: o,
    ...
    function Af(t, e) {
        var n = Lf(t, "ticks"), i = pf(e), r = Pf(n, i);
        if (r) return r;
        var o, a;
        if ((!e.get("show") || t.scale.isBlank()) && (o = []), T(i)) o = Nf(t, i, !0); else if ("auto" === i) {
            var s = Df(t, t.getLabelModel());
            a = s.labelCategoryInterval, o = v(s.labels, function (t) {
                return t.tickValue
            })
        } else a = i, o = zf(t, a, !0);
        return Of(n, i, {ticks: o, tickCategoryInterval: a})
    }

    function kf(t) {
        var e = t.scale.getTicks(), n = lf(t);
        return {
    ...
    function Rf(t) {
        var e = dD(t).autoInterval;
        return null != e ? e : dD(t).autoInterval = t.calculateCategoryInterval()
    }

    function Ef(t) {
        var e = Bf(t), n = lf(t), i = (e.axisRotate - e.labelRotate) / 180 * Math.PI, r = t.scale, o = r.getExtent(),
            a = r.count();
        ...
        var _ = Math.max(0, Math.floor(Math.min(v, m))), x = dD(t.model), b = t.getExtent(), w = x.lastAutoInterval,
            S = x.lastTickCount;
    ...
    function zf(t, e, n) {
        ...
        var r = lf(t), o = t.scale, a = o.getExtent(), s = t.getLabelModel(), l = [], u = Math.max((e || 0) + 1, 1),
            h = a[0], c = o.count();
        0 !== h && u > 1 && c / u > 2 && (h = Math.round(Math.ceil(h / u) * u));
        var p = ff(t), f = s.get("showMinLabel") || p, d = s.get("showMaxLabel") || p;
        f && h !== a[0] && i(a[0]);
    ...
    function Hf(t) {
        var e = iS.extend(t);
        return iS.registerClass(e), e
    }

    function Gf(t) {
        var e = fM.extend(t);
        return fM.registerClass(e), e
    }

    function Wf(t) {
        var e = pM.extend(t);
        return pM.registerClass(e), e
    }

    function Uf(t) {
        var e = yM.extend(t);
        return yM.registerClass(e), e
    }
    ...
    function Xf(t, e, n) {
        var i = cv(), r = e.getWidth(), o = e.getHeight(), a = i.style;
    ...
    function Kf(t) {
        t.registerPainter("canvas", wD)
    }

    function $f(t) {
        t.registerComponentModel(SD), t.registerComponentView(MD)
    }
            ...
            seriesType: t, reset: function (t, e, n) {
                ...
                if (a > 10 && "cartesian2d" === o.type && r) {
                    ...
                    if (p > 1) {
                        ...
                        var f = void 0;
                        "string" == typeof r ? f = TD[r] : "function" == typeof r && (f = r), f && t.setData(i.downSample(i.mapDimension(l.dim), 1 / p, f, CD))
                    }
                }
            }
        }
    ...
    function Jf(t, e, n, i, r) {
        ...
        var c = new Ex({shape: {x: a, y: s, width: l, height: u}});
        if (e) {
            ...
            ts(c, {shape: {width: l, height: u, x: a, y: s}}, n, null, i, g)
        }
        return c
    }

    function td(t, e, n) {
        var i = t.getArea(), r = xi(i.r0, 1), o = xi(i.r, 1), a = new Rb({
            shape: {
                cx: xi(t.cx, 1),
                cy: xi(t.cy, 1),
                r0: r,
        ...
        if (e) {
            ...
            s ? a.shape.endAngle = i.startAngle : a.shape.r = r, ts(a, {shape: {endAngle: i.endAngle, r: o}}, n)
        }
        return a
    }

    function ed(t, e, n, i, r) {
        return t ? "polar" === t.type ? td(t, e, n) : "cartesian2d" === t.type ? Jf(t, e, n, i, r) : null : null
    }
    ...
    function sd(t, e, n, i, r, o, a, s) {
        ...
        o ? (u = {x: i.x, width: i.width}, l = {y: i.y, height: i.height}) : (u = {
            y: i.y,
            height: i.height
        }, l = {x: i.x, width: i.width}), s || (a ? Ja : ts)(n, {shape: l}, e, r, null);
        var h = e ? t.baseAxis.model : null;
        (a ? Ja : ts)(n, {shape: u}, h, r)
    }
    ...
    function ud(t, e, n, i, r, o, a, s) {
        ...
        da(t, f.get("focus"), f.get("blurScope")), ya(t, i), ld(r) && (t.style.fill = "none", t.style.stroke = "none", y(t.states, function (t) {
            t.style && (t.style.fill = t.style.stroke = "none")
        }))
    }

    function hd(t, e) {
        var n = t.get(LD) || 0, i = isNaN(e.width) ? Number.MAX_VALUE : Math.abs(e.width),
    ...
    function cd(t, e, n) {
        ...
        if (u) {
            ...
            var p = new HD({shape: {points: h}, incremental: !!n, silent: !0, z2: 0});
            p.__startPoint = c, p.__baseDimIdx = o, p.__largeDataIndices = a, p.__barWidth = s, dd(p, l, i), e.add(p)
        }
        var f = new HD({shape: {points: i.getLayout("largePoints")}, incremental: !!n});
        f.__startPoint = r, f.__baseDimIdx = o, f.__largeDataIndices = a, f.__barWidth = s, e.add(f), fd(f, t, i), Gx(f).seriesIndex = t.seriesIndex, t.get("silent") || (f.on("mousedown", GD), f.on("mousemove", GD))
    }
    ...
    function pd(t, e, n) {
        var i = t.__baseDimIdx, r = 1 - i, o = t.shape.points, a = t.__largeDataIndices, s = Math.abs(t.__barWidth / 2),
            l = t.__startPoint[r];
        OD[0] = e, OD[1] = n;
        for (var u = OD[i], h = OD[1 - i], c = u - s, p = u + s, f = 0, d = o.length / 2; d > f; f++) {
    ...
    function yd(t, e, n) {
        var i = "polar" === t.type ? Rb : Ex;
        return new i({shape: gd(e, n, t), silent: !0, z2: 0})
    }

    function vd(t) {
        t.registerChartView(BD), t.registerSeriesModel(DD), t.registerLayout(t.PRIORITY.VISUAL.LAYOUT, S(Hp, "bar")), t.registerLayout(t.PRIORITY.VISUAL.PROGRESSIVE_LAYOUT, FI), t.registerVisual({
            seriesType: "bar",
            reset: function (t) {
    ...
    function bd(t) {
        ...
        return {
            ...
            labelStatesModels: bs(e),
            cursorStyle: e.get("cursor")
        }
    }

    function wd(t, e, n) {
        var i = t.getBaseAxis(), r = t.getOtherAxis(i), o = Sd(r, n), a = i.dim, s = r.dim, l = e.mapDimension(s),
            u = e.mapDimension(a), h = "x" === s || "radius" === s ? 1 : 0, c = v(t.dimensions, function (t) {
                return e.mapDimension(t)
            }), p = !1, f = e.getCalculationInfo("stackResultDimension");
        return bp(e, c[0]) && (p = !0, c[0] = f), bp(e, c[1]) && (p = !0, c[1] = f), {
            dataDimsForPoint: c,
            valueStart: o,
            valueAxisDim: s,
            baseAxisDim: a,
    ...
    function Td(t) {
        return M(t) ? XD ? new Float32Array(t) : t : new jD(t)
    }
    ...
    function Id(t, e, n, i, r, o, a, s) {
        for (var l = Cd(t, e), u = [], h = [], c = [], p = [], f = [], d = [], g = [], y = wd(r, e, a), v = wd(o, t, s), m = t.getLayout("points") || [], _ = e.getLayout("points") || [], x = 0; x < l.length; x++) {
            var b = l[x], w = !0, S = void 0, M = void 0;
            switch (b.cmd) {
                case"=":
                    S = 2 * b.idx, M = 2 * b.idx1;
                    var T = m[S], C = m[S + 1], I = _[M], D = _[M + 1];
                    (isNaN(T) || isNaN(C)) && (T = I, C = D), u.push(T, C), h.push(I, D), c.push(n[S], n[S + 1]), p.push(i[M], i[M + 1]), g.push(e.getRawIndex(b.idx1));
                    break;
                case"+":
                    var A = b.idx, k = y.dataDimsForPoint, L = r.dataToPoint([e.get(k[0], A), e.get(k[1], A)]);
                    M = 2 * A, u.push(L[0], L[1]), h.push(_[M], _[M + 1]);
                    var P = Md(y, r, e, A);
                    c.push(P[0], P[1]), p.push(i[M], i[M + 1]), g.push(e.getRawIndex(A));
                    break;
                case"-":
                    var O = b.idx, R = t.getRawIndex(O), E = v.dataDimsForPoint;
                    if (S = 2 * O, R !== O) {
                        var B = o.dataToPoint([t.get(E[0], O), t.get(E[1], O)]), z = Md(v, o, t, O);
                        u.push(m[S], m[S + 1]), h.push(B[0], B[1]), c.push(n[S], n[S + 1]), p.push(z[0], z[1]), g.push(R)
                    } else w = !1
            }
        ...
        for (var N = u.length, F = Td(N), V = Td(N), H = Td(N), G = Td(N), W = [], x = 0; x < d.length; x++) {
            var U = d[x], Y = 2 * x, X = 2 * U;
            F[Y] = u[X], F[Y + 1] = u[X + 1], V[Y] = h[X], V[Y + 1] = h[X + 1], H[Y] = c[X], H[Y + 1] = c[X + 1], G[Y] = p[X], G[Y + 1] = p[X + 1], W[x] = f[U]
        }
        return {current: F, next: V, stackedOnCurrent: H, stackedOnNext: G, status: W}
    }
        ...
        for (var u, h, c, p, f, d, g = n, y = 0; i > y; y++) {
            ...
            if (g === n) t[o > 0 ? "moveTo" : "lineTo"](v, m), c = v, p = m;
                ...
                if (a > 0) {
                    ...
                    if (l) for (; Dd(w, S) && i > M;) M++, b += o, w = e[2 * b], S = e[2 * b + 1];
                    var T = .5, C = 0, I = 0, D = void 0, A = void 0;
                    if (M >= i || Dd(w, S)) f = v, d = m; else {
                        C = w - u, I = S - h;
                    ...
                    t.bezierCurveTo(c, p, f, d, v, m), c = D, p = A
                } else t.lineTo(v, m)
            }
            u = v, h = m, g += o
        }
    ...
    function Pd(t, e) {
        var n = Ld(t), i = n[0], r = n[1], o = Ld(e), a = o[0], s = o[1];
    ...
    function Rd(t, e, n) {
        ...
        for (var i = e.count(), r = Td(2 * i), o = 0; i > o; o++) {
            var a = Md(n, t, e, o);
    ...
    function Nd(t, e) {
        ...
        isNaN(i) && (i = 0);
        for (var r = e.count(), o = Math.max(1, Math.round(r / 5)), a = 0; r > a; a += o) if (1.5 * UD.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i) return !1;
        return !0
    }
    ...
    function Vd(t) {
        for (var e = t.length / 2; e > 0 && Fd(t[2 * e - 2], t[2 * e - 1]); e--) ;
        return e - 1
    }
    ...
    function Wd(t, e, n, i) {
        if (nd(e, "cartesian2d")) {
            var r = i.getModel("endLabel"), o = r.get("show"), a = r.get("valueAnimation"), s = i.getData(),
                ...
                } : null, h = e.getBaseAxis().isHorizontal(), c = Jf(e, n, i, function () {
                    var e = t._endLabel;
    ...
    function Yd(t, e) {
        return {
            seriesType: t, plan: hh(), reset: function (t) {
                ...
                if (i) {
                    ...
                    bp(n, a[0]) && (a[0] = l), bp(n, a[1]) && (a[1] = l);
                    var u = n.getDimensionInfo(a[0]), h = n.getDimensionInfo(a[1]), c = u && u.index, p = h && h.index;
                    return s && {
                        progress: function (t, e) {
                            for (var n = t.end - t.start, r = o && Td(n * s), a = [], l = [], u = t.start, h = 0; u < t.end; u++) {
                                var f = void 0;
                                if (1 === s) {
    ...
    function Xd(t) {
        t.registerChartView(tA), t.registerSeriesModel(WD), t.registerLayout(Yd("line", !0)), t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, Qf("line"))
    }

    function jd(t, e) {
        return ml(t.getBoxLayoutParams(), {width: e.getWidth(), height: e.getHeight()})
    }

    function qd(t, e, n) {
        e.eachSeriesByType(t, function (t) {
            var e = t.getData(), i = e.mapDimension("value"), r = jd(t, n), o = t.get("center"), a = t.get("radius");
            M(a) || (a = [0, a]), M(o) || (o = [o, o]);
            var s = _i(r.width, n.getWidth()), l = _i(r.height, n.getHeight()), u = Math.min(s, l),
                ...
                d = -t.get("startAngle") * nA, g = t.get("minAngle") * nA, y = 0;
            e.each(i, function (t) {
                !isNaN(t) && y++
            });
            ...
            if (e.setLayout({viewRect: r, r: f}), e.each(i, function (t, n) {
                ...
                i = "area" !== x ? 0 === v && b ? m : t * m : eA / y, g > i ? (i = g, S -= g) : T += t;
                var r = C + I * i;
                e.setItemLayout(n, {
                    angle: i,
                    startAngle: C,
    ...
    function Kd(t, e, n, i, r, o, a, s, l, u) {
        function h(t) {
    ...
    function $d(t, e, n, i, r, o, a, s) {
        ...
        Kd(u, e, n, i, 1, r, o, a, s, c), Kd(l, e, n, i, -1, r, o, a, s, h);
    ...
    function Jd(t) {
        ...
        var i, r, o = t.getData(), a = [], s = !1, l = (t.get("minShowLabelAngle") || 0) * iA,
        ...
        o.each(function (t) {
            ...
            if (n(d)) {
                ...
                if ("center" === _) I = f.cx, D = f.cy, k = "center"; else {
                    ...
                    if (I = E + 3 * P, D = B + 3 * O, !R) {
                        var z = E + P * (T + h - f.r), N = B + O * (T + h - f.r), F = z + (0 > P ? -1 : 1) * C, V = N;
                        I = "edge" === b ? 0 > P ? p + w : p + c - w : F + (0 > P ? -x : x), D = V, A = [[E, B], [z, N], [F, V]]
                    }
                    k = R ? "center" : "edge" === b ? P > 0 ? "right" : "left" : P > 0 ? "left" : "right"
                }
                var H, G = m.get("rotate");
                if (H = "number" == typeof G ? G * (Math.PI / 180) : G ? 0 > P ? -L + Math.PI : -L : 0, s = !!H, d.x = I, d.y = D, d.rotation = H, d.setStyle({verticalAlign: "middle"}), R) {
                    d.setStyle({align: k});
        ...
        }), !s && t.get("avoidLabelOverlap") && $d(a, i, r, h, c, d, p, f);
        for (var g = 0; g < a.length; g++) {
            ...
            if (_) {
                var w = v.linePoints;
                x || !w ? (y(_.states, e), _.ignore = !0) : (Vh(w, v.minTurnAngle), Hh(w, v.surfaceNormal, v.maxSurfaceAngle), _.setShape({points: w}), m.__hostTarget.textGuideLineConfig = {anchor: new um(w[0][0], w[0][1])})
            }
        }
    }
    ...
    function eg(t, e, n) {
        ...
        var i = t.getSource(), r = vp(i, e), o = new II(r, t);
        return o.initData(i, n), o
    }

    function ng(t) {
        t.registerChartView(oA), t.registerSeriesModel(sA), tc("pie", t.registerAction), t.registerLayout(S(qd, "pie")), t.registerProcessor(Zd("pie"))
    }

    function ig(t, n, i, r) {
        y(yA, function (o, a) {
            var s = l(l({}, gA[a], !0), r, !0), u = function (t) {
                function i() {
                ...
                return e(i, t), i.prototype.mergeDefaultAndTheme = function (t, e) {
                    var n = _l(this), i = n ? bl(t) : {}, r = e.getTheme();
                    l(t, r.get(a + "Axis")), l(t, this.getDefaultOption()), t.type = rg(t), n && xl(t, i, n)
                }, i.prototype.optionUpdated = function () {
                    var t = this.option;
                    "category" === t.type && (this.__ordinalMeta = LI.createByAxisModel(this))
        ...
        }), t.registerSubTypeDefaulter(n + "Axis", rg)
    }
    ...
    function lg(t) {
        ...
        return y(e, function (n, i) {
            var r = i.replace(/Model$/, ""), o = t.getReferringComponents(r, c_).models[0];
            e[i] = o
        }), e
    }
    ...
    function hg(t, e, n, i) {
        ...
        if (l) {
            if (null != u) cg(a[u]) && (o = a[u]); else for (var h in a) if (a.hasOwnProperty(h) && cg(a[h]) && !i[r(a[h])]) {
                o = a[h];
                break
            }
            o && (i[r(o)] = !0)
    ...
    function fg(t, e, n, i) {
        ...
        return Ii(a - wA / 2) ? (o = l ? "bottom" : "top", r = "center") : Ii(a - 1.5 * wA) ? (o = l ? "top" : "bottom", r = "center") : (o = "middle", r = 1.5 * wA > a && a > wA / 2 ? l ? "left" : "right" : l ? "right" : "left"), {
            rotation: a,
            textAlign: r,
            textVerticalAlign: o
        }
    ...
    function dg(t, e, n) {
        if (!ff(t.axis)) {
            ...
            var o = e[0], a = e[1], s = e[e.length - 1], l = e[e.length - 2], u = n[0], h = n[1], c = n[n.length - 1],
                p = n[n.length - 2];
            i === !1 ? (gg(o), gg(u)) : yg(o, a) && (i ? (gg(a), gg(h)) : (gg(o), gg(u))), r === !1 ? (gg(s), gg(c)) : yg(l, s) && (r ? (gg(l), gg(p)) : (gg(s), gg(c)))
        }
    }
    ...
    function yg(t, e) {
        ...
        if (n && i) {
            var r = Fe([]);
            return We(r, r, -t.rotation), n.applyTransform(He([], r, t.getLocalTransform())), i.applyTransform(He([], r, e.getLocalTransform())), n.intersect(i)
        }
    }
    ...
    function _g(t, e, n, i) {
        ...
        if ("auto" === a && i.handleAutoShown && (a = i.handleAutoShown("axisTick")), a && !r.scale.isBlank()) {
            for (var s = o.getModel("lineStyle"), l = i.tickDirection * o.get("length"), u = r.getTicksCoords(), h = mg(u, e.transform, l, c(s.getLineStyle(), {stroke: n.get(["axisLine", "lineStyle", "color"])}), "ticks"), p = 0; p < h.length; p++) t.add(h[p]);
            return h
        }
    }
    ...
    function xg(t, e, n, i) {
        ...
        if (o.get("show") && !r.scale.isBlank()) {
            ...
            if (a.length) for (var s = o.getModel("lineStyle"), l = i * o.get("length"), u = c(s.getLineStyle(), c(n.getModel("axisTick").getLineStyle(), {stroke: n.get(["axisLine", "lineStyle", "color"])})), h = 0; h < a.length; h++) for (var p = mg(a[h], e.transform, l, u, "minorticks_" + h), f = 0; f < p.length; f++) t.add(p[f])
        }
    }
    ...
    function bg(t, e, n, i) {
        ...
        if (o && !r.scale.isBlank()) {
            var a = n.getModel("axisLabel"), s = a.get("margin"), l = r.getViewLabels(),
                u = (z(i.labelRotate, a.get("rotate")) || 0) * wA / 180,
                h = SA.innerTextLayout(i.rotation, u, i.labelDirection), c = n.getCategories && n.getCategories(!0),
                p = [], f = SA.isLabelSilent(n), d = n.get("triggerEvent");
            return y(l, function (o, l) {
                ...
                if (c && c[u]) {
                    var m = c[u];
                    A(m) && m.textStyle && (v = new Iw(m.textStyle, a, n.ecModel))
                }
                ...
                if (b.anid = "label_" + u, d) {
                    var w = SA.makeAxisEventDataBase(n);
                    w.targetType = "axisLabel", w.value = y, Gx(b).eventData = w
                }
    ...
    function wg(t, e) {
        ...
        return Sg(n, t, e), n.seriesInvolved && Tg(n, t), n
    }
        ...
        y(n.getCoordinateSystems(), function (n) {
            function s(i, s, l) {
                ...
                if (p && ("auto" !== p || i || Lg(h))) {
                    ...
                    var f = h.get("snap"), d = Pg(l.model), g = s || f || "category" === l.type, y = t.axesInfo[d] = {
                        key: d,
                        axis: l,
                        coordSys: n,
                        axisPointerModel: h,
            ...
            if (n.axisPointerEnabled) {
                var l = Pg(n.model), u = t.coordSysAxesInfo[l] = {};
                t.coordSysMap[l] = n;
    ...
    function Mg(t, e, n, i, r, o) {
        ...
        return t.model.getModel("axisPointer", new Iw(u, n, i))
    }

    function Tg(t, e) {
        e.eachSeries(function (e) {
            var n = e.coordinateSystem, i = e.get(["tooltip", "trigger"], !0), r = e.get(["tooltip", "show"], !0);
            n && "none" !== i && i !== !1 && "item" !== i && r !== !1 && e.get(["axisPointer", "show"], !0) !== !1 && y(t.coordSysAxesInfo[Pg(n.model)], function (t) {
                var i = t.axis;
    ...
    function Cg(t, e) {
        for (var n = e.model, i = e.dim, r = 0; r < t.length; r++) {
            var o = t[r] || {};
            if (Ig(o[i + "AxisId"], n.id) || Ig(o[i + "AxisIndex"], n.componentIndex) || Ig(o[i + "AxisName"], n.name)) return r
        }
    }
    ...
    function Og(t, e, n, i) {
        ...
        if (!r.scale.isBlank()) {
            ...
            if (u.length) {
                var h = s.length, p = IA(t).splitAreaColors, f = X(), d = 0;
                ...
                IA(t).splitAreaColors = f
            }
        }
    }

    function Rg(t) {
        IA(t).splitAreaColors = null
    }

    function Eg(t) {
        t.registerComponentView(RA), t.registerComponentModel(lA), t.registerCoordinateSystem("cartesian2d", bA), ig(t, "x", uA, EA), ig(t, "y", uA, EA), t.registerComponentView(PA), t.registerComponentView(OA), t.registerPreprocessor(function (t) {
            t.xAxis && t.yAxis && !t.grid && (t.grid = {})
        })
    }

    function Bg(t) {
        t.registerComponentModel(BA), t.registerComponentView(zA)
    }

    function zg(t, e) {
        var n = jw(e.get("padding")), i = e.getItemStyle(["color", "opacity"]);
        return i.fill = e.get("backgroundColor"), t = new Ex({
            shape: {
                x: t.x - n[3],
                y: t.y - n[0],
    ...
    function Fg(t, e, n, i) {
        Gg(t, e, n, i), n.dispatchAction({type: "legendToggleSelect", name: null != t ? t : e}), Hg(t, e, n, i)
    }
    ...
    function Yg(t) {
        t.registerAction("legendToggleSelect", "legendselectchanged", S(Ug, "toggleSelected")), t.registerAction("legendAllSelect", "legendselectall", S(Ug, "allSelect")), t.registerAction("legendInverseSelect", "legendinverseselect", S(Ug, "inverseSelect")), t.registerAction("legendSelect", "legendselected", S(Ug, "select")), t.registerAction("legendUnSelect", "legendunselected", S(Ug, "unSelect"))
    }

    function Xg(t) {
        t.registerComponentModel(FA), t.registerComponentView(WA), t.registerProcessor(t.PRIORITY.PROCESSOR.SERIES_FILTER, Wg), t.registerSubTypeDefaulter("legend", function () {
            return "plain"
        }), Yg(t)
    }
    ...
    function jg(t, e, n) {
        ...
        r[i.index] = 0, xl(e, n, {type: "box", ignoreSize: !!r})
    }
    ...
    function Zg(t) {
        _f(Xg), t.registerComponentModel(UA), t.registerComponentView(qA), qg(t)
    }

    function Kg(t, e, n, i) {
        $g(ZA(n).lastProp, i) || (ZA(n).lastProp = i, e ? Ja(n, i, t) : (n.stopAnimation(), n.attr(i)))
    }
    ...
    function ny(t, e, n, i, r) {
        var o = n.get("value"), a = ry(o, e.axis, e.ecModel, n.get("seriesDataIndices"), {
                precision: n.get(["label", "precision"]),
                formatter: n.get(["label", "formatter"])
            }), s = n.getModel("label"), l = jw(s.get("padding") || 0), u = s.getFont(), h = Rn(a, u), c = r.position,
            p = h.width + l[1] + l[3], f = h.height + l[0] + l[2], d = r.align;
        "right" === d && (c[0] -= p), "center" === d && (c[0] -= p / 2);
        var g = r.verticalAlign;
        "bottom" === g && (c[1] -= f), "middle" === g && (c[1] -= f / 2), iy(c, p, f, i);
    ...
    function ry(t, e, n, i, r) {
        ...
        if (a) {
            var s = {value: uf(e, {value: t}), axisDimension: e.dim, axisIndex: e.index, seriesData: []};
            y(i, function (t) {
    ...
    function oy(t, e, n) {
        var i = Ne();
        return We(i, i, n.rotation), Ge(i, i, n.position), as([t.dataToCoord(e), (n.labelOffset || 0) + (n.labelDirection || 1) * (n.labelMargin || 0)], i)
    }

    function ay(t, e, n, i, r, o) {
        var a = SA.innerTextLayout(n.rotation, 0, n.labelDirection);
        n.labelMargin = r.get(["label", "margin"]), ny(e, i, r, o, {
            position: oy(i.axis, t, n),
            align: a.textAlign,
    ...
    function cy(t, e, n) {
        if (!Qy.node) {
            var i = e.getZr();
            nk(i).records || (nk(i).records = {}), py(i, e);
            var r = nk(i).records[t] || (nk(i).records[t] = {});
            r.handler = n
        }
    }
    ...
    function py(t, e) {
        function n(n, i) {
            t.on(n, function (n) {
                var r = yy(e);
                ik(nk(t).records, function (t) {
                    t && i(t, n, r.dispatchAction)
                }), fy(r.pendings, e)
            })
        }

        nk(t).initialized || (nk(t).initialized = !0, n("click", S(gy, "click")), n("mousemove", S(gy, "mousemove")), n("globalout", dy))
    }
    ...
    function vy(t, e) {
        if (!Qy.node) {
            var n = e.getZr(), i = (nk(n).records || {})[t];
            i && (nk(n).records[t] = null)
        }
    }
    ...
    function _y(t, e, n) {
        var i = t.currTrigger, r = [t.x, t.y], o = t, a = t.dispatchAction || pv(n.dispatchAction, n),
            s = e.getComponent("axisPointer").coordSysAxesInfo;
        if (s) {
            Ay(r) && (r = my({seriesIndex: o.seriesIndex, dataIndex: o.dataIndex}, e).point);
            var l = Ay(r), u = o.axesInfo, h = s.axesInfo, c = "leave" === i || Ay(r), p = {}, f = {},
                d = {list: [], map: {}}, g = {showPointer: S(wy, f), showTooltip: S(Sy, d)};
            y(s.coordSysMap, function (t, e) {
                var n = l || t.containPoint(r);
                y(s.coordSysAxesInfo[e], function (t) {
                    var e = t.axis, i = Iy(u, t);
                    if (!c && n && (!u || i)) {
                        var o = i && i.value;
                        null != o || l || (o = e.pointToData(r)), null != o && xy(t, o, g, !1, p)
                    }
                })
            });
            var v = {};
            return y(h, function (t, e) {
                ...
                n && !f[e] && y(n.axesInfo, function (e, i) {
                    ...
                    if (e !== t && r) {
                        var o = r.value;
                        n.mapper && (o = t.axis.scale.parse(n.mapper(o, Dy(e), Dy(t)))), v[t.key] = o
                    }
                })
            }), y(v, function (t, e) {
                xy(h[e], t, g, !0, p)
            }), My(f, h, p), Ty(d, r, t, a), Cy(h, a, n), p
        }
    }
    ...
    function xy(t, e, n, i, r) {
        ...
        if (!o.scale.isBlank() && o.containData(e)) {
            ...
            var a = by(e, t), s = a.payloadBatch, l = a.snapToValue;
    ...
    function Sy(t, e, n, i) {
        ...
        if (e.triggerTooltip && r.length) {
            var l = e.coordSys.model, u = Pg(l), h = t.map[u];
            h || (h = t.map[u] = {
                coordSysId: l.id,
    ...
    function Ty(t, e, n, i) {
        if (Ay(e) || !t.list.length) return void i({type: "hideTip"});
    ...
    function Cy(t, e, n) {
        var i = n.getZr(), r = "axisPointerLastHighlights", o = ok(i)[r] || {}, a = ok(i)[r] = {};
        y(t, function (t) {
    ...
    function ky(t) {
        CA.registerAxisPointerClass("CartesianAxisPointer", JA), t.registerComponentModel(ek), t.registerComponentView(rk), t.registerPreprocessor(function (t) {
            if (t) {
            ...
            t.getComponent("axisPointer").coordSysAxesInfo = wg(t, e)
        }), t.registerAction({type: "updateAxisPointer", event: "updateAxisPointer", update: ":updateAxisPointer"}, _y)
    }
    ...
    function Oy(t, e, n) {
        ...
        e = gl(e);
        var i = Py(n), r = "", o = "";
        p(["left", "right"], i) > -1 ? (r = i + ":-6px;top:50%;", o = "translateY(-50%) rotate(" + ("left" === i ? -225 : -45) + "deg)") : (r = i + ":-6px;left:50%;", o = "translateX(-50%) rotate(" + ("top" === i ? 225 : 45) + "deg)"), o = v(sk, function (t) {
    ...
    function Ry(t, e) {
        ...
        return e || (i += ",left " + t + "s " + n + ",top " + t + "s " + n), v(sk, function (t) {
    ...
    function By(t, e, n) {
        var i = [], r = t.get("transitionDuration"), o = t.get("backgroundColor"), a = t.get("shadowBlur"),
            ...
            h = t.getModel("textStyle"), c = Qu(t, "html"), p = l + "px " + u + "px " + a + "px " + s;
        return i.push("box-shadow:" + p), e && r && i.push(Ry(r, n)), o && (Qy.canvasSupported ? i.push("background-Color:" + o) : (i.push("background-Color:#" + un(o)), i.push("filter:alpha(opacity=70)"))), y(["width", "color", "radius"], function (e) {
            var n = "border-" + e, r = ll(n), o = t.get(r);
            null != o && i.push(n + ":" + o + ("color" === e ? "" : "px"))
        }), i.push(Ey(h)), null != c && i.push("padding:" + jw(c).join("px ") + "px"), i.join(";") + ";"
    }
    ...
    function Hy(t) {
        for (var e = t.pop(); t.length;) {
            var n = t.pop();
            n && (n instanceof Iw && (n = n.get("tooltip", !0)), C(n) && (n = {formatter: n}), e = new Iw(n, e, e.ecModel))
        }
        return e
    }

    function Gy(t, e) {
        return t.dispatchAction || pv(e.dispatchAction, e)
    }
    ...
    function jy(t) {
        _f(ky), t.registerComponentModel(ak), t.registerComponentView(gk), t.registerAction({
            type: "showTip",
            event: "showTip",
    ...
    var qy = function (t, e) {
        ...
        function t() {
            this.browser = new Ky, this.node = !1, this.wxa = !1, this.worker = !1, this.canvasSupported = !1, this.svgSupported = !1, this.touchEventsSupported = !1, this.pointerEventsSupported = !1, this.domSupported = !1
        }

        return t
    }(), Qy = new $y;
    "object" == typeof wx && "function" == typeof wx.getSystemInfoSync ? (Qy.wxa = !0, Qy.canvasSupported = !0, Qy.touchEventsSupported = !0) : "undefined" == typeof document && "undefined" != typeof self ? (Qy.worker = !0, Qy.canvasSupported = !0) : "undefined" == typeof navigator ? (Qy.node = !0, Qy.canvasSupported = !0, Qy.svgSupported = !0) : i(navigator.userAgent, Qy);
    var Jy = {
            "[object Function]": !0,
            "[object RegExp]": !0,
            "[object Date]": !0,
        ...
        }, ev = Object.prototype.toString, nv = Array.prototype, iv = nv.forEach, rv = nv.filter, ov = nv.slice,
        av = nv.map, sv = function () {
        }.constructor, lv = sv ? sv.prototype : null, uv = {}, hv = 2311, cv = function () {
            return uv.createCanvas()
        };
    uv.createCanvas = function () {
        return document.createElement("canvas")
    };
    var pv = lv && T(lv.bind) ? lv.call.bind(lv.bind) : w, fv = "__ec_primitive__", dv = function () {
            function t(e) {
                function n(t, e) {
            ...
            hasOwn: Z,
            noop: K
        }), yv = re, vv = oe, mv = ce, _v = pe, xv = (Object.freeze || Object)({
            create: $,
            copy: Q,
            clone: J,
            set: te,
            ...
            return t.prototype._dragStart = function (t) {
                ...
                e && (this._draggingTarget = e, e.dragging = !0, this._x = t.offsetX, this._y = t.offsetY, this.handler.dispatchToElement(new bv(e, t), "dragstart", t.event))
            }, t.prototype._drag = function (t) {
                var e = this._draggingTarget;
                if (e) {
                    var n = t.offsetX, i = t.offsetY, r = n - this._x, o = i - this._y;
                    this._x = n, this._y = i, e.drift(r, o, t), this.handler.dispatchToElement(new bv(e, t), "drag", t.event);
                    var a = this.handler.findHover(n, i, e).target, s = this._dropTarget;
                    this._dropTarget = a, e !== a && (s && a !== s && this.handler.dispatchToElement(new bv(s, t), "dragleave", t.event), a && a !== s && this.handler.dispatchToElement(new bv(a, t), "dragenter", t.event))
                }
            }, t.prototype._dragEnd = function (t) {
                var e = this._draggingTarget;
                e && (e.dragging = !1), this.handler.dispatchToElement(new bv(e, t), "dragend", t.event), this._dropTarget && this.handler.dispatchToElement(new bv(this._dropTarget, t), "drop", t.event), this._draggingTarget = null, this._dropTarget = null
            }, t
        }(), Sv = function () {
            function t(t) {
        ...
        }(), Mv = Math.log(2), Tv = "___zrEVENTSAVED", Cv = [],
        Iv = "undefined" != typeof window && !!window.addEventListener,
        Dv = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Av = [], kv = Iv ? function (t) {
            ...
            return t.prototype.recognize = function (t, e, n) {
                ...
                for (var e in Pv) if (Pv.hasOwnProperty(e)) {
                    var n = Pv[e](this._track, t);
                    if (n) return n
                }
            }, t
        }(), Pv = {
            ...
            return t
        }(), Bv = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
        zv = function (t) {
            function n(e, n, i, r) {
                var o = t.call(this) || this;
                return o._hovered = new Ev(0, 0), o.storage = e, o.painter = n, o.painterRoot = r, i = i || new Rv, o.proxy = null, o.setHandlerProxy(i), o._draggingMgr = new wv(o), o
            }

            return e(n, t), n.prototype.setHandlerProxy = function (t) {
                this.proxy && this.proxy.dispose(), t && (y(Bv, function (e) {
                ...
                var a = this._hovered = i ? new Ev(e, n) : this.findHover(e, n), s = a.target, l = this.proxy;
                ...
                for (var i = this.storage.getDisplayList(), r = new Ev(t, e), o = i.length - 1; o >= 0; o--) {
                    var a = void 0;
                    if (i[o] !== n && !i[o].ignore && (a = Be(i[o], t, e)) && (!r.topTarget && (r.topTarget = i[o]), a !== Ov)) {
                        r.target = i[o];
                        break
                    }
                }
                ...
                this._gestureMgr || (this._gestureMgr = new Lv);
    ...
    var Nv, Fv, Vv = (Object.freeze || Object)({
            create: Ne,
            identity: Fe,
            copy: Ve,
            mul: He,
            ...
            invert: Ye,
            clone: Xe
        }), Hv = Fe, Gv = 5e-5, Wv = [], Uv = [], Yv = Ne(), Xv = Math.abs, jv = function () {
            function t() {
            }
            ...
            return t.prototype.setPosition = function (t) {
                ...
                return n || e ? (i = i || Ne(), n ? this.getLocalTransform(i) : Hv(i), e && (n ? He(i, t.transform, i) : Ve(i, t.transform)), this.transform = i, void this._resolveGlobalScaleRatio(i)) : void (i && Hv(i))
            }, t.prototype._resolveGlobalScaleRatio = function (t) {
                var e = this.globalScaleRatio;
                if (null != e && 1 !== e) {
                    this.getGlobalScale(Wv);
                    var n = Wv[0] < 0 ? -1 : 1, i = Wv[1] < 0 ? -1 : 1, r = ((Wv[0] - n) * e + n) / Wv[0] || 0,
                        o = ((Wv[1] - i) * e + i) / Wv[1] || 0;
                ...
                if (this.transform) {
                    ...
                    t && t.transform && (He(Uv, t.invTransform, e), e = Uv);
                    var n = this.originX, i = this.originY;
                    (n || i) && (Yv[4] = n, Yv[5] = i, He(Uv, e, Yv), Uv[4] -= n, Uv[5] -= i, e = Uv), this.setLocalTransform(e)
                }
            ...
            return t.prototype.put = function (t, e) {
                ...
                if (null == i[t]) {
                    ...
                    a ? a.value = e : a = new Kv(e), a.key = t, n.insertEntry(a), i[t] = a
                }
                return r
        ...
        }, tm = new Qv(20), em = null, nm = hn, im = cn, rm = (Object.freeze || Object)({
            parse: on,
            lift: ln,
            toHex: un,
            fastLerp: hn,
            ...
            lum: gn,
            random: yn
        }), om = Array.prototype.slice, am = [0, 0, 0, 0], sm = function () {
            function t(t) {
            ...
            return t.prototype.isFinished = function () {
                ...
                if (!this._finished) {
                    ...
                    if (p && c) {
                        ...
                        if (0 !== f) {
                            var d = (e - p.percent) / f, g = i ? this._additiveValue : u ? am : t[s];
                ...
                0 === e ? this.isValueColor ? (on(t[n], am), bn(am, am, i, 1), t[n] = An(am)) : t[n] = t[n] + i : 1 === e ? bn(t[n], t[n], i, 1) : 2 === e && wn(t[n], t[n], i, 1)
            }, t
        }(), lm = function () {
            function t(t, e, n) {
        ...
        }(), hm = Math.min, cm = Math.max, pm = new um, fm = new um, dm = new um, gm = new um, ym = new um, vm = new um,
        mm = function () {
            function t(t, e, n, i) {
            ...
            return t.prototype.union = function (t) {
                var e = hm(t.x, this.x), n = hm(t.y, this.y);
                this.width = isFinite(this.x) && isFinite(this.width) ? cm(t.x + t.width, this.x + this.width) - e : t.width, this.height = isFinite(this.y) && isFinite(this.height) ? cm(t.y + t.height, this.y + this.height) - n : t.height, this.x = e, this.y = n
                ...
                if (n) {
                    ...
                    l > o || r > u ? _ > d && (d = _, y > g ? um.set(vm, -g, 0) : um.set(vm, y, 0)) : f > _ && (f = _, y > g ? um.set(ym, g, 0) : um.set(ym, -y, 0)), h > s || a > c ? x > d && (d = x, m > v ? um.set(vm, 0, -v) : um.set(vm, 0, m)) : f > _ && (f = _, m > v ? um.set(ym, 0, v) : um.set(ym, 0, -m))
                }
                return n && um.copy(n, p ? ym : vm), p
                ...
                pm.x = dm.x = n.x, pm.y = gm.y = n.y, fm.x = gm.x = n.x + n.width, fm.y = dm.y = n.y + n.height, pm.transform(i), gm.transform(i), fm.transform(i), dm.transform(i), e.x = hm(pm.x, fm.x, dm.x, gm.x), e.y = hm(pm.y, fm.y, dm.y, gm.y);
                var l = cm(pm.x, fm.x, dm.x, gm.x), u = cm(pm.y, fm.y, dm.y, gm.y);
                e.width = l - e.x, e.height = u - e.y
            }, t
        }(), _m = {}, xm = "12px sans-serif", bm = {measureText: Ln}, wm = 1;
    "undefined" != typeof window && (wm = Math.max(window.devicePixelRatio || window.screen && window.screen.deviceXDPI / window.screen.logicalXDPI || 1, 1));
    var Sm = wm, Mm = .4, Tm = "#333", Cm = "#ccc", Im = "#eee", Dm = "__zr_normal__",
        Am = ["x", "y", "scaleX", "scaleY", "originX", "originY", "rotation", "ignore"],
        km = {x: !0, y: !0, scaleX: !0, scaleY: !0, originX: !0, originY: !0, rotation: !0, ignore: !1}, Lm = {},
        Pm = new mm(0, 0, 0, 0), Om = function () {
            function t(t) {
            ...
            return t.prototype._init = function (t) {
                ...
                if (e && (!e.ignore || t)) {
                    ...
                    if (r.x = e.x, r.y = e.y, r.originX = e.originX, r.originY = e.originY, r.rotation = e.rotation, r.scaleX = e.scaleX, r.scaleY = e.scaleY, null != n.position) {
                        var u = Pm;
                        u.copy(n.layoutRect ? n.layoutRect : this.getBoundingRect()), i || u.applyTransform(this.transform), this.calculateTextPosition ? this.calculateTextPosition(Lm, n, u) : Fn(Lm, n, u), r.x = Lm.x, r.y = Lm.y, o = Lm.align, a = Lm.verticalAlign;
                        var h = n.origin;
                ...
                return this.__zr && this.__zr.isDarkMode() ? Cm : Tm
                ...
                if ("string" == typeof t) this.attrKV(t, e); else if (A(t)) for (var n = t, i = b(n), r = 0; r < i.length; r++) {
                    var o = i[r];
                    this.attrKV(o, t[o])
                }
                ...
                this.useState(Dm, !1, t)
            }, t.prototype.useState = function (e, n, i) {
                var r = e === Dm, o = this.hasState();
                if (o || !r) {
                ...
                if (e !== t) {
                    ...
                    t.attachedTransform = new jv, this._attachComponent(t), this._textContent = t, this.markRedraw()
                }
                ...
                var r = {};
                Object.defineProperty && (!Qy.browser.ie || Qy.browser.version > 8) && (n("position", "_legacyPos", "x", "y"), n("scale", "_legacyScale", "scaleX", "scaleY"), n("origin", "_legacyOrigin", "originX", "originY"))
            }(), t
        }();
    d(Om, Sv), d(Om, jv);
    var Rm, Em = 32, Bm = 7, zm = !1, Nm = function () {
        function t() {
        ...
        return t.prototype.traverse = function (t, e) {
            ...
            n.length = this._displayListLen, Qy.canvasSupported && Qn(n, ti)
            ...
            if (!t.ignore || n) {
                ...
                if (t.childrenRef) {
                    for (var a = t.childrenRef(), s = 0; s < a.length; s++) {
                        var l = a[s];
                        t.__dirty && (l.__dirty |= Om.REDARAW_BIT), this._updateAndAddDisplayable(l, e, n)
                    }
                    t.__dirty = 0
                } else {
                    var u = t;
    ...
    var Fm = Rm, Vm = function (t) {
        ...
        return e(n, t), n.prototype.addClip = function (t) {
            ...
            function t() {
                e._running && (Fm(t), !e._paused && e.update())
            }

            var e = this;
            this._running = !0, Fm(t)
            ...
            e = e || {}, this.start();
            var n = new lm(t, e.loop);
            return this.addAnimator(n), n
        }, n
    }(Sv), Hm = 300, Gm = Qy.domSupported, Wm = function () {
    ...
    }(), Um = {mouse: ["mousemove", "mouseup"], pointer: ["pointermove", "pointerup"]}, Ym = !1, Xm = function () {
        function t(t, e) {
        ...
        mousedown: function (t) {
            ...
            Ym = !0, t = De(this.dom, t), this.trigger("mousewheel", t)
        }, mousewheel: function (t) {
            Ym || (t = De(this.dom, t), this.trigger("mousewheel", t))
        }, touchstart: function (t) {
            t = De(this.dom, t), ii(t), this.__lastTouchMoment = new Date, this.handler.processGesture(t, "start"), jm.mousemove.call(this, t), jm.mousedown.call(this, t)
        }, touchmove: function (t) {
            t = De(this.dom, t), ii(t), this.handler.processGesture(t, "change"), jm.mousemove.call(this, t)
        }, touchend: function (t) {
            t = De(this.dom, t), ii(t), this.handler.processGesture(t, "end"), jm.mouseup.call(this, t), +new Date - +this.__lastTouchMoment < Hm && jm.click.call(this, t)
    ...
    var qm = {
        ...
        function n(e, n) {
            ...
            return i.__pointerCapturing = !1, i.dom = e, i.painterRoot = n, i._localHandlerScope = new Zm(e, jm), Gm && (i._globalHandlerScope = new Zm(document, qm)), ai(i, i._localHandlerScope), i
        }

        return e(n, t), n.prototype.dispose = function () {
            ui(this._localHandlerScope), Gm && ui(this._globalHandlerScope)
        }, n.prototype.setCursor = function (t) {
            this.dom.style && (this.dom.style.cursor = t || "default")
        }, n.prototype.__togglePointerCapture = function (t) {
            if (this.__mayPointerCapture = null, Gm && +this.__pointerCapturing ^ +t) {
        ...
        return e(n, t), n.prototype.childrenRef = function () {
            ...
            for (var e = new mm(0, 0, 0, 0), n = t || this._children, i = [], r = null, o = 0; o < n.length; o++) {
                var a = n[o];
                if (!a.ignore && !a.invisible) {
                    var s = a.getBoundingRect(), l = a.getLocalTransform(i);
                    l ? (mm.applyTransform(e, s, l), r = r || e.clone(), r.union(e)) : (r = r || s.clone(), r.union(s))
                }
            }
            return r || e
        }, n
    ...
    var Qm = !Qy.canvasSupported, Jm = {}, t_ = {}, e_ = function () {
            function t(t, e, n) {
                var i = this;
                ...
                var r = new Nm, o = n.renderer || "canvas";
                if (Qm) throw new Error("IE8 support has been dropped since 5.0");
                if (Jm[o] || (o = b(Jm)[0]), !Jm[o]) throw new Error("Renderer '" + o + "' is not imported. Please import it first.");
                n.useDirtyRect = null == n.useDirtyRect ? !1 : n.useDirtyRect;
                var a = new Jm[o](e, r, n, t);
                this.storage = r, this.painter = a;
                var s = Qy.node || Qy.worker ? null : new Km(a.getViewportRoot(), a.root);
                this.handler = new zv(r, a, s, a.root), this.animation = new Vm({
                    stage: {
                        update: function () {
                            return i._flush(!0)
                        }
            ...
            return t.prototype.add = function (t) {
                ...
                for (var t = this.storage.getRoots(), e = 0; e < t.length; e++) t[e] instanceof $m && t[e].removeSelfFromZr(this);
        ...
        }(), n_ = "5.0.4", i_ = (Object.freeze || Object)({
            init: pi,
            dispose: fi,
            disposeAll: di,
            getInstance: gi,
            registerPainter: yi,
            version: n_
        }), r_ = 1e-4, o_ = 9007199254740991,
        a_ = /^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d{1,2})(?::(\d{1,2})(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/,
        s_ = "series\x00", l_ = "\x00_ec_\x00",
        u_ = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "rich", "tag", "color", "textBorderColor", "textBorderWidth", "width", "height", "lineHeight", "align", "verticalAlign", "baseline", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY", "backgroundColor", "borderColor", "borderWidth", "borderRadius", "padding"],
        h_ = Bi(), c_ = {useDefault: !0, enableAll: !1, enableNone: !1}, p_ = ".",
        f_ = "___EC__COMPONENT__CONTAINER___", d_ = "___EC__EXTENDED_CLASS___", g_ = Math.round(10 * Math.random()),
        y_ = [["fill", "color"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["opacity"], ["shadowColor"]],
        v_ = wr(y_), m_ = function () {
            function t() {
            }
        ...
        }(), __ = new Qv(50), x_ = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, b_ = function () {
            function t() {
            }
            ...
            return t
        }(), M_ = m(",&?/;] ".split(""), function (t, e) {
            return t[e] = !0, t
        }, {}), T_ = "__zr_style_" + Math.round(10 * Math.random()),
        C_ = {shadowBlur: 0, shadowOffsetX: 0, shadowOffsetY: 0, shadowColor: "#000", opacity: 1, blend: "source-over"},
        I_ = {style: {shadowBlur: !0, shadowOffsetX: !0, shadowOffsetY: !0, shadowColor: !0, opacity: !0}};
    C_[T_] = !0;
    var D_ = ["z", "z2", "invisible"], A_ = function (t) {
            function n(e) {
            ...
            return e(n, t), n.prototype._init = function (e) {
                ...
                if (!this._paintRect || this.__dirty) {
                    ...
                    t = this._paintRect || (this._paintRect = new mm(0, 0, 0, 0)), e ? mm.applyTransform(t, n, e) : t.copy(n), (r || o || a) && (t.width += 2 * r + Math.abs(o), t.height += 2 * r + Math.abs(a), t.x = Math.min(t.x, t.x + o - r), t.y = Math.min(t.y, t.y + a - r));
                ...
                t ? (this._prevPaintRect = this._prevPaintRect || new mm(0, 0, 0, 0), this._prevPaintRect.copy(t)) : this._prevPaintRect = null
                ...
                t[T_] || (t = this.createStyle(t)), this.__inHover ? this.__hoverStyle = t : this.style = t, this.dirtyStyle()
                ...
                e.style && !n.style && (n.style = this._mergeStyle(this.createStyle(), this.style)), this._savePrimaryToNormal(e, n, D_)
                ...
                var t = n.prototype;
                t.type = "displayable", t.invisible = !1, t.z = 0, t.z2 = 0, t.zlevel = 0, t.culling = !1, t.cursor = "pointer", t.rectHover = !1, t.incremental = !1, t._rect = null, t.dirtyRectTolerance = 0, t.__dirty = Om.REDARAW_BIT | n.STYLE_CHANGED_BIT
            }(), n
        }(Om), k_ = new mm(0, 0, 0, 0), L_ = new mm(0, 0, 0, 0), P_ = Math.pow, O_ = Math.sqrt, R_ = 1e-8, E_ = 1e-4,
        B_ = O_(3), z_ = 1 / 3, N_ = $(), F_ = $(), V_ = $(), H_ = Math.min, G_ = Math.max, W_ = Math.sin,
        U_ = Math.cos, Y_ = 2 * Math.PI, X_ = $(), j_ = $(), q_ = $(), Z_ = [], K_ = [],
        $_ = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, Q_ = [], J_ = [], tx = [], ex = [], nx = [], ix = [],
        rx = Math.min, ox = Math.max, ax = Math.cos, sx = Math.sin, lx = Math.sqrt, ux = Math.abs, hx = Math.PI,
        cx = 2 * hx, px = "undefined" != typeof Float32Array, fx = [], dx = function () {
            function t(t) {
            ...
            return t.prototype.increaseVersion = function () {
                ...
                n = n || 0, n > 0 && (this._ux = ux(n / Sm / t) || 0, this._uy = ux(n / Sm / e) || 0)
                ...
                return this.addData($_.M, t, e), this._ctx && this._ctx.moveTo(t, e), this._x0 = t, this._y0 = e, this._xi = t, this._yi = e, this
            }, t.prototype.lineTo = function (t, e) {
                var n = ux(t - this._xi) > this._ux || ux(e - this._yi) > this._uy || this._len < 5;
                return this.addData($_.L, t, e), this._ctx && n && (this._needsDash ? this._dashedLineTo(t, e) : this._ctx.lineTo(t, e)), n && (this._xi = t, this._yi = e), this
            }, t.prototype.bezierCurveTo = function (t, e, n, i, r, o) {
                return this.addData($_.C, t, e, n, i, r, o), this._ctx && (this._needsDash ? this._dashedBezierTo(t, e, n, i, r, o) : this._ctx.bezierCurveTo(t, e, n, i, r, o)), this._xi = r, this._yi = o, this
            }, t.prototype.quadraticCurveTo = function (t, e, n, i) {
                return this.addData($_.Q, t, e, n, i), this._ctx && (this._needsDash ? this._dashedQuadraticTo(t, e, n, i) : this._ctx.quadraticCurveTo(t, e, n, i)), this._xi = n, this._yi = i, this
            }, t.prototype.arc = function (t, e, n, i, r, o) {
                fx[0] = i, fx[1] = r, so(fx, o), i = fx[0], r = fx[1];
                var a = r - i;
                return this.addData($_.A, t, e, n, n, i, a, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, n, i, r, o), this._xi = ax(r) * n + t, this._yi = sx(r) * n + e, this
            }, t.prototype.arcTo = function (t, e, n, i, r) {
                return this._ctx && this._ctx.arcTo(t, e, n, i, r), this
            }, t.prototype.rect = function (t, e, n, i) {
                return this._ctx && this._ctx.rect(t, e, n, i), this.addData($_.R, t, e, n, i), this
                ...
                var e = t.length;
                this.data && this.data.length === e || !px || (this.data = new Float32Array(e));
                ...
                px && this.data instanceof Float32Array && (this.data = new Float32Array(i + n));
                ...
                var n, i, r = this._dashSum, o = this._lineDash, a = this._ctx, s = this._dashOffset, l = this._xi,
                    u = this._yi, h = t - l, c = e - u, p = lx(h * h + c * c), f = l, d = u, g = o.length;
                for (h /= p, c /= p, 0 > s && (s = r + s), s %= r, f -= s * h, d -= s * c; h > 0 && t >= f || 0 > h && f >= t || 0 === h && (c > 0 && e >= d || 0 > c && d >= e);) i = this._dashIdx, n = o[i], f += h * n, d += c * n, this._dashIdx = (i + 1) % g, h > 0 && l > f || 0 > h && f > l || c > 0 && u > d || 0 > c && d > u || a[i % 2 ? "moveTo" : "lineTo"](h >= 0 ? rx(f, t) : ox(f, t), c >= 0 ? rx(d, e) : ox(d, e));
                h = f - t, c = d - e, this._dashOffset = -lx(h * h + c * c)
                ...
                for (0 > f && (f = p + f), f %= p, a = 0; 1 > a; a += .1) s = Hr(g, t, n, r, a + .1) - Hr(g, t, n, r, a), l = Hr(y, e, i, o, a + .1) - Hr(y, e, i, o, a), v += lx(s * s + l * l);
                for (; _ > m && (x += d[m], !(x > f)); m++) ;
                for (a = (x - f) / v; 1 >= a;) u = Hr(g, t, n, r, a), h = Hr(y, e, i, o, a), m % 2 ? c.moveTo(u, h) : c.lineTo(u, h), a += d[m] / v, m = (m + 1) % _;
                m % 2 !== 0 && c.lineTo(r, o), s = r - u, l = o - h, this._dashOffset = -lx(s * s + l * l)
                ...
                if (this._saveData) {
                    var t = this.data;
                    t instanceof Array && (t.length = this._len, px && this._len > 11 && (this.data = new Float32Array(t)))
                }
            }, t.prototype.getBoundingRect = function () {
                tx[0] = tx[1] = nx[0] = nx[1] = Number.MAX_VALUE, ex[0] = ex[1] = ix[0] = ix[1] = -Number.MAX_VALUE;
                var t, e = this.data, n = 0, i = 0, r = 0, o = 0;
                for (t = 0; t < this._len;) {
                    var a = e[t++], s = 1 === t;
                    switch (s && (n = e[t], i = e[t + 1], r = n, o = i), a) {
                        case $_.M:
                            n = r = e[t++], i = o = e[t++], nx[0] = r, nx[1] = o, ix[0] = r, ix[1] = o;
                            break;
                        case $_.L:
                            no(n, i, e[t], e[t + 1], nx, ix), n = e[t++], i = e[t++];
                            break;
                        case $_.C:
                            io(n, i, e[t++], e[t++], e[t++], e[t++], e[t], e[t + 1], nx, ix), n = e[t++], i = e[t++];
                            break;
                        case $_.Q:
                            ro(n, i, e[t++], e[t++], e[t], e[t + 1], nx, ix), n = e[t++], i = e[t++];
                            break;
                        case $_.A:
                            var l = e[t++], u = e[t++], h = e[t++], c = e[t++], p = e[t++], f = e[t++] + p;
                            t += 1;
                            var d = !e[t++];
                            s && (r = ax(p) * h + l, o = sx(p) * c + u), oo(l, u, h, c, p, f, d, nx, ix), n = ax(f) * h + l, i = sx(f) * c + u;
                            break;
                        case $_.R:
                            r = n = e[t++], o = i = e[t++];
                            var g = e[t++], y = e[t++];
                            no(r, o, r + g, o + y, nx, ix);
                            break;
                        case $_.Z:
                            n = r, i = o
                    }
                    ye(tx, tx, nx), ve(ex, ex, ix)
                }
                return 0 === t && (tx[0] = tx[1] = ex[0] = ex[1] = 0), new mm(tx[0], tx[1], ex[0] - tx[0], ex[1] - tx[1])
                ...
                for (var l = this._pathSegLen, u = 0, h = 0, c = 0; e > c;) {
                    ...
                    switch (p) {
                        ...
                        case $_.L:
                            ...
                            (ux(v) > n || ux(m) > i || c === e - 1) && (d = Math.sqrt(v * v + m * m), r = g, o = y);
                            break;
                        case $_.C:
                        ...
                        case $_.Q:
                            ...
                            break;
                        case $_.A:
                            var S = t[c++], M = t[c++], T = t[c++], C = t[c++], I = t[c++], D = t[c++], A = D + I;
                            c += 1;
                        {
                            !t[c++]
                        }
                            f && (a = ax(I) * T + S, s = sx(I) * C + M), d = ox(T, C) * rx(cx, Math.abs(D)), r = ax(A) * T + S, o = sx(A) * C + M;
                            break;
                        case $_.R:
                            a = r = t[c++], s = o = t[c++];
                            var k = t[c++], L = t[c++];
                ...
                if (!g || (this._pathSegLen || this._calculateLength(), l = this._pathSegLen, u = this._pathLen, h = e * u)) t:for (var m = 0; d > m;) {
                    ...
                    switch (x && (r = c[m], o = c[m + 1], n = r, i = o), _) {
                        case $_.M:
                            ...
                            break;
                        case $_.L:
                            if (a = c[m++], s = c[m++], ux(a - r) > p || ux(s - o) > f || m === d - 1) {
                                if (g) {
                                    var b = l[v++];
                                    if (y + b > h) {
                                        var w = (h - y) / b;
                            ...
                            break;
                        case $_.C:
                            var S = c[m++], M = c[m++], T = c[m++], C = c[m++], I = c[m++], D = c[m++];
                            if (g) {
                                var b = l[v++];
                                if (y + b > h) {
                                    var w = (h - y) / b;
                                    Yr(r, S, T, I, w, Q_), Yr(o, M, C, D, w, J_), t.bezierCurveTo(Q_[1], J_[1], Q_[2], J_[2], Q_[3], J_[3]);
                                    break t
                                }
                                y += b
                            }
                            t.bezierCurveTo(S, M, T, C, I, D), r = I, o = D;
                            break;
                        case $_.Q:
                            var S = c[m++], M = c[m++], T = c[m++], C = c[m++];
                            if (g) {
                                var b = l[v++];
                                if (y + b > h) {
                                    var w = (h - y) / b;
                                    Qr(r, S, T, w, Q_), Qr(o, M, C, w, J_), t.quadraticCurveTo(Q_[1], J_[1], Q_[2], J_[2]);
                                    break t
                                }
                                y += b
                            }
                            ...
                            break;
                        case $_.A:
                            var A = c[m++], k = c[m++], L = c[m++], P = c[m++], O = c[m++], R = c[m++], E = c[m++],
                                B = !c[m++], z = L > P ? L : P, N = ux(L - P) > .001, F = O + R, V = !1;
                            if (g) {
                                var b = l[v++];
                                y + b > h && (F = O + R * (h - y) / b, V = !0), y += b
                            }
                            if (N && t.ellipse ? t.ellipse(A, k, L, P, E, O, F, B) : t.arc(A, k, z, O, F, B), V) break t;
                            x && (n = ax(O) * L + A, i = sx(O) * P + k), r = ax(F) * L + A, o = sx(F) * P + k;
                            break;
                        case $_.R:
                            ...
                            if (g) {
                                ...
                                if (y + b > h) {
                                    var W = h - y;
                                    t.moveTo(a, s), t.lineTo(a + rx(W, H), s), W -= H, W > 0 && t.lineTo(a + H, s + rx(W, G)), W -= G, W > 0 && t.lineTo(a + ox(H - W, 0), s + G), W -= H, W > 0 && t.lineTo(a, s + ox(G - W, 0));
                                    break t
                                }
                                y += b
                            }
            ...
            }, t.CMD = $_, t.initDefaultProps = function () {
                var e = t.prototype;
                e._saveData = !0, e._needsDash = !1, e._dashOffset = 0, e._dashIdx = 0, e._dashSum = 0, e._ux = 0, e._uy = 0
            }(), t
        }(), gx = 2 * Math.PI, yx = 2 * Math.PI, vx = dx.CMD, mx = 2 * Math.PI, _x = 1e-4, xx = [-1, -1, -1], bx = [-1, -1],
        Sx = c({
            fill: "#000",
            stroke: null,
            strokePercent: 1,
        ...
        Tx = ["x", "y", "rotation", "scaleX", "scaleY", "originX", "originY", "invisible", "culling", "z", "z2", "zlevel", "parent"],
        Cx = function (t) {
            function n(e) {
                return t.call(this, e) || this
            }
            ...
            return e(n, t), n.prototype.update = function () {
                ...
                if (i.decal) {
                    ...
                    for (var s = 0; s < Tx.length; ++s) r[Tx[s]] = this[Tx[s]];
                    r.__dirty |= Om.REDARAW_BIT
                ...
                if (C(e)) {
                    var n = this.__zr, i = !(!n || !n.isDarkMode()), r = gn(t, 0) < Mm;
                    if (i === r) return e
                }
                ...
                var t = n.prototype;
                t.type = "path", t.strokeContainThreshold = 5, t.segmentIgnoreThreshold = 0, t.subPixelOptimize = !1, t.autoBatch = !1, t.__dirty = Om.REDARAW_BIT | A_.STYLE_CHANGED_BIT | n.SHAPE_CHANGED_BIT
            }(), n
        }(A_),
        Ix = c({strokeFirst: !0, font: xm, x: 0, y: 0, textAlign: "left", textBaseline: "top", miterLimit: 2}, Sx),
        Dx = function (t) {
            function n() {
    ...
    var Ax = c({x: 0, y: 0}, C_),
        kx = {style: c({x: !0, y: !0, width: !0, height: !0, sx: !0, sy: !0, sWidth: !0, sHeight: !0}, I_.style)},
        Lx = function (t) {
            function n() {
                return null !== t && t.apply(this, arguments) || this
            }
            ...
            return e(n, t), n.prototype.createStyle = function (t) {
                ...
                var t = this.style;
                return this._rect || (this._rect = new mm(t.x || 0, t.y || 0, this.getWidth(), this.getHeight())), this._rect
            }, n
        }(A_);
    Lx.prototype.type = "image";
    var Px = Math.round, Ox = function () {
        function t() {
    ...
    Ex.prototype.type = "rect";
    var Bx = {fill: "#000"}, zx = 2, Nx = {
            style: c({
                fill: !0,
                stroke: !0,
                fillOpacity: !0,
            ...
            function n(e) {
                var n = t.call(this) || this;
                return n.type = "text", n._children = [], n._defaultStyle = Bx, n.attr(e), n
            }
            ...
            return e(n, t), n.prototype.childrenRef = function () {
                ...
                if (this.styleChanged() && this._updateSubTexts(), !this._rect) {
                    for (var t = new mm(0, 0, 0, 0), e = this._children, n = [], i = null, r = 0; r < e.length; r++) {
                ...
                var t = this.style, e = t.font || xm, n = t.padding, i = Oo(t), r = Lr(i, t), o = Ro(t),
                ...
                for (var x = 0, b = !1, w = (Lo("fill" in t ? t.fill : (b = !0, h.fill))), S = (ko("stroke" in t ? t.stroke : a || h.autoStroke && !b ? null : (x = zx, h.stroke))), M = t.textShadowBlur > 0, T = null != t.width && ("truncate" === t.overflow || "break" === t.overflow || "breakAll" === t.overflow), C = r.calculatedLineHeight, I = 0; I < l.length; I++) {
                    var D = this._getOrCreateChild(Dx), A = D.createStyle();
                    D.useStyle(A), A.text = l[I], A.x = g, A.y = y, f && (A.textAlign = f), A.textBaseline = "middle", A.opacity = t.opacity, A.strokeFirst = !0, M && (A.shadowBlur = t.textShadowBlur || 0, A.shadowColor = t.textShadowColor || "transparent", A.shadowOffsetX = t.textShadowOffsetX || 0, A.shadowOffsetY = t.textShadowOffsetY || 0), S && (A.stroke = S, A.lineWidth = t.lineWidth || x, A.lineDash = t.lineDash, A.lineDashOffset = t.lineDashOffset || 0), w && (A.fill = w), A.font = e, y += u, T && D.setBoundingRect(new mm(En(A.x, t.width, A.textAlign), Bn(A.y, C, A.textBaseline), t.width, C))
                }
                ...
                var f = this._getOrCreateChild(Dx), d = f.createStyle();
                f.useStyle(d);
                var g = this._defaultStyle, y = !1, v = 0,
                    m = ko("fill" in s ? s.fill : "fill" in e ? e.fill : (y = !0, g.fill)),
                    _ = ko("stroke" in s ? s.stroke : "stroke" in e ? e.stroke : c || a || g.autoStroke && !y ? null : (v = zx, g.stroke)),
                ...
                f.setBoundingRect(new mm(En(d.x, b, d.textAlign), Bn(d.y, w, d.textBaseline), b, w))
                ...
                var a, s, l = t.backgroundColor, u = t.borderWidth, h = t.borderColor, c = C(l), p = t.borderRadius,
                    f = this;
                if (c || u && h) {
                    a = this._getOrCreateChild(Ex), a.useStyle(a.createStyle()), a.style.fill = null;
                    var d = a.shape;
                ...
                if (c) {
                    ...
                    s = this._getOrCreateChild(Lx), s.onload = function () {
                        f.dirtyStyle()
                    };
                    var y = s.style;
        ...
        }(A_), Vx = {left: !0, right: 1, center: 1}, Hx = {top: 1, bottom: 1, middle: 1}, Gx = or(), Wx = 1, Ux = {},
        Yx = or(), Xx = 0, jx = 1, qx = 2, Zx = ["emphasis", "blur", "select"],
        Kx = ["normal", "emphasis", "blur", "select"], $x = 10, Qx = 9, Jx = "highlight", tb = "downplay",
        eb = "select", nb = "unselect", ib = "toggleSelect", rb = new Qv(100), ob = ["emphasis", "blur", "select"],
        ab = {itemStyle: "getItemStyle", lineStyle: "getLineStyle", areaStyle: "getAreaStyle"}, sb = dx.CMD,
        lb = [[], [], []], ub = Math.sqrt, hb = Math.atan2, cb = Math.sqrt, pb = Math.sin, fb = Math.cos, db = Math.PI,
        gb = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi, yb = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g, vb = function (t) {
            function n() {
                return null !== t && t.apply(this, arguments) || this
            }
    ...
    var wb = Math.PI, Sb = 2 * wb, Mb = Math.sin, Tb = Math.cos, Cb = Math.acos, Ib = Math.atan2, Db = Math.abs,
        Ab = Math.sqrt, kb = Math.max, Lb = Math.min, Pb = 1e-4, Ob = function () {
            function t() {
    ...
    var Ub = [], Yb = function () {
        ...
        return e(n, t), n.prototype.getDefaultStyle = function () {
            ...
            0 !== h && (t.moveTo(n, i), null == l || null == u ? (1 > h && (Qr(n, a, r, h, Ub), a = Ub[1], r = Ub[2], Qr(i, s, o, h, Ub), s = Ub[1], o = Ub[2]), t.quadraticCurveTo(a, s, r, o)) : (1 > h && (Yr(n, a, l, r, h, Ub), a = Ub[1], l = Ub[2], r = Ub[3], Yr(i, s, u, o, h, Ub), s = Ub[1], u = Ub[2], o = Ub[3]), t.bezierCurveTo(a, s, l, u, r, o)))
        }, n.prototype.pointAt = function (t) {
    ...
    Xb.prototype.type = "bezier-curve";
    var jb = function () {
        function t() {
    ...
    var Zb = function (t) {
        ...
        return e(n, t), n.prototype._updatePathDirty = function () {
            ...
            return this._updatePathDirty.call(this), Cx.prototype.getBoundingRect.call(this)
        }, n
    }(Cx), Kb = function () {
        function t(t) {
            this.colorStops = t || []
        ...
        return e(n, t), n
    }(Kb), Jb = [0, 0], tw = [0, 0], ew = new um, nw = new um, iw = function () {
        function t(t, e) {
            this._corners = [], this._axes = [], this._origin = [0, 0];
            for (var n = 0; 4 > n; n++) this._corners[n] = new um;
            for (var n = 0; 2 > n; n++) this._axes[n] = new um;
        ...
        return t.prototype.fromBoundingRect = function (t, e) {
            ...
            um.sub(i[0], n[1], n[0]), um.sub(i[1], n[3], n[0]), i[0].normalize(), i[1].normalize();
            for (var l = 0; 2 > l; l++) this._origin[l] = i[l].dot(n[0])
        }, t.prototype.intersect = function (t, e) {
            var n = !0, i = !e;
            return ew.set(1 / 0, 1 / 0), nw.set(0, 0), !this._intersectCheckOneSide(this, t, ew, nw, i, 1) && (n = !1, i) ? n : !this._intersectCheckOneSide(t, this, ew, nw, i, -1) && (n = !1, i) ? n : (i || um.copy(e, n ? ew : nw), n)
        }, t.prototype._intersectCheckOneSide = function (t, e, n, i, r, o) {
            for (var a = !0, s = 0; 2 > s; s++) {
                var l = this._axes[s];
                if (this._getProjMinMaxOnAxis(s, t._corners, Jb), this._getProjMinMaxOnAxis(s, e._corners, tw), Jb[1] < tw[0] || Jb[0] > tw[1]) {
                    if (a = !1, r) return a;
                    var u = Math.abs(tw[0] - Jb[1]), h = Math.abs(Jb[0] - tw[1]);
                    Math.min(u, h) > i.len() && (h > u ? um.scale(i, l, -u * o) : um.scale(i, l, h * o))
                } else if (n) {
                    var u = Math.abs(tw[0] - Jb[1]), h = Math.abs(Jb[0] - tw[1]);
                    Math.min(u, h) < n.len() && (h > u ? um.scale(n, l, u * o) : um.scale(n, l, -h * o))
                }
            }
            return a
        ...
        return e(n, t), n.prototype.traverse = function (t, e) {
            ...
            if (!this._rect) {
                for (var t = new mm(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0; e < this._displayables.length; e++) {
                    var n = this._displayables[e], i = n.getBoundingRect().clone();
                    n.needLocalTransform() && i.applyTransform(n.getLocalTransform(rw)), t.union(i)
                }
                this._rect = t
            }
            return this._rect
    ...
    }(A_), aw = Math.max, sw = Math.min, lw = {}, uw = Pa, hw = Oa, cw = Io;
    Ua("circle", _b), Ua("ellipse", bb), Ua("sector", Rb), Ua("ring", Bb), Ua("polygon", Nb), Ua("polyline", Vb), Ua("rect", Ex), Ua("line", Wb), Ua("bezierCurve", Xb), Ua("arc", qb);
    var pw = (Object.freeze || Object)({
            extendShape: Ga,
            extendPath: Wa,
            registerShape: Ua,
            getShapeClass: Ya,
        ...
        dw = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY"],
        gw = ["align", "lineHeight", "width", "height", "tag", "verticalAlign"],
        ...
        vw = or(), mw = ["textStyle", "color"], _w = new Fx, xw = function () {
            function t() {
            }
            ...
            return t.prototype.getTextColor = function (t) {
                ...
                }), _w.update(), _w.getBoundingRect()
            }, t
        }(),
        bw = [["lineWidth", "width"], ["stroke", "color"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["lineDash", "type"], ["lineDashOffset", "dashOffset"], ["lineCap", "cap"], ["lineJoin", "join"], ["miterLimit"]],
        ww = wr(bw), Sw = function () {
            function t() {
            }
        ...
        Mw = [["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["lineDash", "borderType"], ["lineDashOffset", "borderDashOffset"], ["lineCap", "borderCap"], ["lineJoin", "borderJoin"], ["miterLimit", "borderMiterLimit"]],
        Tw = wr(Mw), Cw = function () {
            function t() {
            }
    ...
    gr(Iw), mr(Iw), d(Iw, Sw), d(Iw, Cw), d(Iw, m_), d(Iw, xw);
    var Dw = Math.round(10 * Math.random()), Aw = {
        time: {
    ...
    }, Lw = "ZH", Pw = "EN", Ow = Pw, Rw = {}, Ew = {}, Bw = Qy.domSupported ? function () {
        var t = (document.documentElement.lang || navigator.language || navigator.browserLanguage).toUpperCase();
        return t.indexOf(Lw) > -1 ? Lw : Ow
    }() : Ow;
    Rs(Pw, Aw), Rs(Lw, kw);
    var zw = 1e3, Nw = 60 * zw, Fw = 60 * Nw, Vw = 24 * Fw, Hw = 365 * Vw, Gw = {
            year: "{yyyy}",
            month: "{MMM}",
            day: "{d}",
            hour: "{HH}:{mm}",
            ...
            second: Ww + " " + Gw.second,
            millisecond: Gw.none
        }, Yw = ["year", "month", "day", "hour", "minute", "second", "millisecond"],
        Xw = ["year", "half-year", "quarter", "month", "week", "half-week", "day", "half-day", "quarter-day", "hour", "minute", "second", "millisecond"],
        jw = H, qw = /([&<>"'])/g, Zw = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;"},
        Kw = ["a", "b", "c", "d", "e", "f", "g"], $w = function (t, e) {
            return "{" + t + (null == e ? "" : e) + "}"
        }, Qw = y, Jw = ["left", "right", "top", "bottom", "width", "height"],
        tS = [["width", "left", "right"], ["height", "top", "bottom"]], eS = vl,
        nS = (S(vl, "vertical"), S(vl, "horizontal"), or()), iS = function (t) {
            function n(e, n, i) {
                var r = t.call(this, e, n, i) || this;
                return r.uid = ks("ec_cpt_model"), r
            }
    ...
    vr(iS, Iw), br(iS), Ls(iS), Ps(iS, Sl);
    var rS = "";
    "undefined" != typeof navigator && (rS = navigator.platform || "");
    var oS, aS, sS = "rgba(0, 0, 0, 0.2)", lS = {
            darkMode: "auto",
            ...
            aria: {
                decal: {
                    decals: [{
                        ...
                        dashArrayY: [6, 0],
                        symbolSize: .8
                    }, {color: sS, dashArrayX: [1, 0], dashArrayY: [4, 3], rotation: -Math.PI / 4}, {
                        color: sS,
            ...
            textStyle: {
                fontFamily: rS.match(/^Win/) ? "Microsoft YaHei" : "sans-serif",
                fontSize: 12,
                fontStyle: "normal",
                fontWeight: "normal"
            },
            ...
            useUTC: !1
        }, uS = X(["tooltip", "label", "itemName", "itemId", "seriesName"]), hS = "original", cS = "arrayRows",
        pS = "objectRows", fS = "keyedColumns", dS = "typedArray", gS = "unknown", yS = "column", vS = "row",
        mS = {Must: 1, Might: 2, Not: 3}, _S = or(), xS = X(), bS = or(), wS = (or(), function () {
            function t() {
            }

            return t.prototype.getColorFromPalette = function (t, e, n) {
                var i = Vi(this.get("color", !0)), r = this.get("colorLayer", !0);
                return Ol(this, bS, i, r, t, e, n)
            }, t.prototype.clearColorPalette = function () {
                Rl(this, bS)
            }, t
        }()), SS = "\x00_ec_inner", MS = 1, TS = function (t) {
            function n() {
                return null !== t && t.apply(this, arguments) || this
            }

            return e(n, t), n.prototype.init = function (t, e, n, i, r, o) {
                i = i || {}, this.option = null, this._theme = new Iw(i), this._locale = new Iw(r), this._optionManager = o
                ...
                if (!t || "recreate" === t) {
                    ...
                    this.option && "recreate" !== t ? (this.restoreData(), this._mergeOption(r, e)) : aS(this, r), n = !0
                }
                ...
                function n(e) {
                    var n = Ll(this, e, Vi(t[e])), a = r.get(e),
                        s = a ? c && c.get(e) ? "replaceMerge" : "normalMerge" : "replaceAll", l = Ui(a, n, s);
                    nr(l, e, iS), i[e] = null, r.set(e, null), o.set(e, 0);
                    var u = [], p = [], f = 0;
                    y(l, function (t, n) {
                        var i = t.existing, r = t.newOption;
                        if (r) {
                            var o = iS.getClass(e, t.keyInfo.subType, !0);
                    ...
                    }, this), i[e] = u, r.set(e, p), o.set(e, f), "series" === e && oS(this)
                }
                ...
                Ml(this), y(t, function (t, e) {
                    null != t && (iS.hasClass(e) ? e && (a.push(e), u.set(e, !0)) : i[e] = null == i[e] ? s(t) : l(i[e], t, !0))
                }), c && c.each(function (t, e) {
                    iS.hasClass(e) && !u.get(e) && (a.push(e), u.set(e, !0))
                }), iS.topologicalTravel(a, iS.getAllClassMainTypes(), n, this), this._seriesIndices || oS(this)
                ...
                return null != n ? (a = [], y(Vi(n), function (t) {
                    o[t] && a.push(o[t])
                })) : a = null != i ? zl("id", i, o) : null != r ? zl("name", r, o) : _(o, function (t) {
                    return !!t
                }), Nl(a, t)
                ...
                e.each(function (t, e) {
                    iS.hasClass(e) && n.push(e)
                }), iS.topologicalTravel(n, iS.getAllClassMainTypes(), function (n) {
                ...
                oS = function (t) {
                    ...
                    t.option = {}, t.option[SS] = MS, t._componentsMap = X({series: []}), t._componentsCount = X();
                    var n = e.aria;
                    A(n) && null == n.enabled && (n.enabled = !0), Bl(e, t._theme.option), l(e, lS, !1), t._mergeOption(e, null)
                }
            }(), n
        }(Iw);
    d(TS, wS);
    var CS, IS, DS, AS, kS,
        LS = ["getDom", "getZr", "getWidth", "getHeight", "getDevicePixelRatio", "dispatchAction", "isDisposed", "on", "off", "getDataURL", "getConnectedDataURL", "getOption", "getId", "updateLabelLayout"],
        PS = function () {
            function t(t) {
                y(LS, function (e) {
                    this[e] = pv(t[e], t)
            ...
            return t.prototype.setOption = function (t, e) {
                ...
                var n = this._optionBackup, i = Vl(t, e, !n);
        ...
        }(), zS = y, NS = A, FS = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
        VS = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
        HS = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"],
        ...
        WS = function () {
            ...
            function t(t, e) {
                ...
                n.sourceFormat === dS && (this._offset = 0, this._dimSize = e, this._data = i), kS(this, i, n)
            }
            ...
            return t.prototype.getSource = function () {
                ...
                kS = function (t, e, o) {
                    var a = o.sourceFormat, s = o.seriesLayoutBy, l = o.startIndex, u = o.dimensionsDefine,
                        c = AS[Su(a, s)];
                    if (h(t, c), a === dS) t.getItem = n, t.count = r, t.fillStorage = i; else {
                        var p = xu(a, s);
                        t.getItem = pv(p, null, e, l, u);
                        var f = bu(a, s);
                        t.count = pv(f, null, e, l, u)
                    }
                };
                var n = function (t, e) {
                    t -= this._offset, e = e || [];
                ...
                e = {}, e[cS + "_" + yS] = {pure: !0, appendData: t}, e[cS + "_" + vS] = {
                    pure: !0,
                    appendData: function () {
                        throw new Error('Do not support appendData when set seriesLayoutBy: "row".')
                    }
                }, e[pS] = {pure: !0, appendData: t}, e[fS] = {
            ...
            return t[i]
        }, XS = (CS = {}, CS[cS + "_" + yS] = function (t, e, n, i) {
            return t[i + e]
        }, CS[cS + "_" + vS] = function (t, e, n, i) {
            i += e;
            ...
            return r
        }, CS[pS] = YS, CS[fS] = function (t, e, n, i) {
            for (var r = [], o = 0; o < n.length; o++) {
                var a = n[o].name, s = t[a];
                r.push(s ? s[i] : null)
            }
            return r
        }, CS[hS] = YS, CS), jS = function (t) {
            return t.length
        }, qS = (IS = {}, IS[cS + "_" + yS] = function (t, e) {
            return Math.max(0, t.length - e)
        }, IS[cS + "_" + vS] = function (t, e) {
            var n = t[0];
            return n ? Math.max(0, n.length - e) : 0
        }, IS[pS] = jS, IS[fS] = function (t, e, n) {
            var i = n[0].name, r = t[i];
            return r ? r.length : 0
        }, IS[hS] = jS, IS), ZS = function (t, e) {
            return null != e ? t[e] : t
        }, KS = (DS = {}, DS[cS] = ZS, DS[pS] = function (t, e, n) {
            return null != e ? t[n] : t
        }, DS[fS] = ZS, DS[hS] = function (t, e) {
            var n = Gi(t);
            return null != e && n instanceof Array ? n[e] : n
        }, DS[dS] = ZS, DS), $S = /\{@(.+?)\}/g, QS = function () {
            function t() {
            }
            ...
            return t.prototype.getDataParams = function (t, e) {
                ...
                if ("string" == typeof r) {
                    var u = cl(r, s);
                    return u.replace($S, function (e, n) {
            ...
            return t.prototype.perform = function (t) {
                ...
                tM.reset(e, n, i, r), this._callingProgress = t, this._callingProgress({
                    start: e,
                    end: n,
                    count: n - e,
                    next: tM.next
            ...
            function t(t, e) {
                ...
                this._opFn = eM[t], this._rvalFloat = Ri(e)
            }
            ...
            return t.prototype.dirty = function () {
                ...
                if (Nu(n)) {
                    ...
                    t = [cu(a, {seriesLayoutBy: p, sourceHeader: f, dimensions: d}, s, o.get("encode", !0))]
                } else {
                    var g = n;
                    if (r) {
                ...
                }), n ? o = Ru(n, a, {datasetIndex: e.componentIndex}) : null != i && (o = [fu(a[0])]), {
                    sourceList: o,
                    upstreamSignList: s
                }
                ...
                if (Nu(i)) t = i.get("seriesLayoutBy", !0), e = i.get("sourceHeader", !0), n = i.get("dimensions", !0); else if (!this._getUpstreamSourceManagers().length) {
                    var r = i;
                    t = r.get("seriesLayoutBy", !0), e = r.get("sourceHeader", !0), n = r.get("dimensions", !0)
                }
                return {seriesLayoutBy: t, sourceHeader: e, dimensions: n}
            }, t
        }(), aM = "line-height:1", sM = [0, 10, 20, 30], lM = ["", "\n", "\n\n", "\n\n\n"], uM = {
            section: {
                planLayout: function (t) {
                    ...
                    var r = e.noHeader, o = Yu(e), a = Wu(t, e, r ? n : o.html, i);
                    if (r) return a;
                    var s = hl(e.header, "ordinal", t.useUTC), l = Vu(i, t.renderMode).nameStyle;
                    return "richText" === t.renderMode ? Zu(t, s, l) + o.richText + a : Xu('<div style="' + l + ";" + aM + ';">' + ul(s) + "</div>" + a, n)
                }
            }, nameValue: {
                planLayout: function (t) {
                    ...
                    if (!o || !a) {
                        var c = s ? "" : t.markupStyleCreator.makeTooltipMarker(e.markerType, e.markerColor || "#333", r),
                            p = o ? "" : hl(l, "ordinal", h), f = e.valueType, d = a ? [] : M(u) ? v(u, function (t, e) {
                                return hl(t, M(f) ? f[e] : f, h)
                            }) : [hl(u, M(f) ? f[0] : f, h)], g = !s || !o, y = !s && o, m = Vu(i, r), _ = m.nameStyle,
                            x = m.valueStyle;
                        return "richText" === r ? (s ? "" : c) + (o ? "" : Zu(t, p, _)) + (a ? "" : Ku(t, d, g, y, x)) : Xu((s ? "" : c) + (o ? "" : ju(p, !s, _)) + (a ? "" : qu(d, g, y, x)), n)
                    }
                }
            }
        }, hM = function () {
            ...
            return e(n, t), n.prototype.init = function (t, e, n) {
                ...
                var i = cM(this).sourceManager = new oM(this);
                i.prepareSource();
                var r = this.getInitialData(t, n);
                sh(r, this), this.dataTask.context.data = r, cM(this).dataBeforeProcessed = r, nh(this), this._initSelectedMapFromData(r)
            }, n.prototype.mergeDefaultAndTheme = function (t, e) {
                var n = _l(this), i = n ? bl(t) : {}, r = this.subType;
                iS.hasClass(r) && (r += "Series"), l(t, e.getTheme().get(this.subType)), l(t, this.getDefaultOption()), Hi(t, "label", ["show"]), this.fillDataTextStyle(t.data), n && xl(t, i, n)
            }, n.prototype.mergeOption = function (t, e) {
                t = l(this.option, t, !0), this.fillDataTextStyle(t.data);
                var n = _l(this);
                n && xl(this.option, t, n);
                var i = cM(this).sourceManager;
                i.dirty(), i.prepareSource();
                var r = this.getInitialData(t, e);
                sh(r, this), this.dataTask.dirty(), this.dataTask.context.data = r, cM(this).dataBeforeProcessed = r, nh(this), this._initSelectedMapFromData(r)
                ...
                return cM(this).sourceManager.getSource()
                ...
                var i = this.ecModel, r = wS.prototype.getColorFromPalette.call(this, t, e, n);
    ...
    d(pM, QS), d(pM, wS), vr(pM, iS);
    var fM = function () {
        function t() {
            this.group = new $m, this.uid = ks("viewComponent")
        }
    ...
    gr(fM), br(fM);
    var dM = or(), gM = hh(), yM = function () {
        function t() {
            this.group = new $m, this.uid = ks("viewChart"), this.renderTask = Cu({
                plan: fh,
                reset: dh
    ...
    var vM, mM = {
        ...
        }, _M = "\x00__throttleOriginMethod", xM = "\x00__throttleRate", bM = "\x00__throttleType", wM = or(),
        SM = {itemStyle: wr(Mw, !0), lineStyle: wr(bw, !0)}, MM = {lineStyle: "stroke", itemStyle: "fill"}, TM = {
            createOnAllSeries: !0, performRawSeries: !0, reset: function (t, e) {
                var n = t.getData(), i = t.visualStyleAccessPath || "itemStyle", r = t.getModel(i), o = vh(t, i), a = o(r),
                    s = r.getShallow("decal");
                s && (n.setVisual("decal", s), s.dirty = !0);
                var l = mh(t, i), u = a[l], c = T(u) ? u : null;
            ...
            createOnAllSeries: !0, performRawSeries: !0, reset: function (t, e) {
                if (!t.ignoreStyleOnData && !e.isSeriesFiltered(t)) {
                    var n = t.getData(), i = t.visualStyleAccessPath || "itemStyle", r = vh(t, i),
                    ...
                    return {
                        dataEach: n.hasItemOption ? function (t, e) {
                            ...
                            if (n && n[i]) {
                                CM.option = n[i];
                                var a = r(CM), s = t.ensureUniqueItemVisual(e, "style");
                                h(s, a), CM.option.decal && (t.setItemVisual(e, "decal", CM.option.decal), CM.option.decal.dirty = !0), o in a && t.setItemVisual(e, "colorFromPalette", !1)
                            }
                        } : null
                    }
                }
            ...
            performRawSeries: !0, overallReset: function (t) {
                ...
                t.eachSeries(function (t) {
                    if (t.useColorPaletteOnData) {
                        var n = e.get(t.type);
                        n || (n = {}, e.set(t.type, n)), wM(t).scope = n
                    }
                }), t.eachSeries(function (e) {
                    if (e.useColorPaletteOnData && !t.isSeriesFiltered(e)) {
                        var n = e.getRawData(), i = {}, r = e.getData(), o = wM(e).scope,
                            a = e.visualStyleAccessPath || "itemStyle", s = mh(e, a);
                        r.each(function (t) {
            ...
            return t.prototype.restoreData = function (t, e) {
                ...
                function r(e) {
                    var r = e.uid, l = s.set(r, a && a.get(r) || Cu({plan: Mh, reset: Th, count: Ih}));
                    l.context = {
                        model: e,
                        ecModel: n,
                        api: i,
                ...
                function r(t) {
                    var e = t.uid, n = l.set(e, s && s.get(e) || (p = !0, Cu({reset: bh, onDirty: Sh})));
                    n.context = {model: t, overallProgress: c}, n.agent = a, n.__block = c, o._pipe(t, n)
                }

                var o = this, a = e.overallTask = e.overallTask || Cu({reset: xh});
    ...
    Ah(PM, TS), Ah(OM, PS), PM.eachSeriesByType = PM.eachRawSeriesByType = function (t) {
        vM = t
    }, PM.eachComponent = function (t) {
        "series" === t.mainType && t.subType && (vM = t.subType)
    };
    var RM = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
        EM = {
            color: RM,
            colorLayer: [["#37A2DA", "#ffd85c", "#fd7b5f"], ["#37A2DA", "#67E0E3", "#FFDB5C", "#ff9f7f", "#E062AE", "#9d96f5"], ["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], RM]
        }, BM = "#B9B8CE", zM = "#100C2A", NM = function () {
            return {
                axisLine: {lineStyle: {color: BM}},
                splitLine: {lineStyle: {color: "#484753"}},
                splitArea: {areaStyle: {color: ["rgba(255,255,255,0.02)", "rgba(255,255,255,0.05)"]}},
                minorSplitLine: {lineStyle: {color: "#20203B"}}
            }
        }, FM = ["#4992ff", "#7cffb2", "#fddd60", "#ff6e76", "#58d9f9", "#05c091", "#ff8a45", "#8d48e3", "#dd79ff"], VM = {
            darkMode: !0,
            color: FM,
            backgroundColor: zM,
            axisPointer: {lineStyle: {color: "#817f91"}, crossStyle: {color: "#817f91"}, label: {color: "#fff"}},
            legend: {textStyle: {color: BM}},
            textStyle: {color: BM},
            title: {textStyle: {color: "#EEF1FA"}, subtextStyle: {color: "#B9B8CE"}},
            toolbox: {iconStyle: {borderColor: BM}},
            dataZoom: {
                borderColor: "#71708A",
                textStyle: {color: BM},
            ...
            visualMap: {textStyle: {color: BM}},
            timeline: {lineStyle: {color: BM}, label: {color: BM}, controlStyle: {color: BM, borderColor: BM}},
            calendar: {itemStyle: {color: zM}, dayLabel: {color: BM}, monthLabel: {color: BM}, yearLabel: {color: BM}},
            timeAxis: NM(),
            logAxis: NM(),
            valueAxis: NM(),
            categoryAxis: NM(),
    ...
    var HM = X(), GM = {
            registerMap: function (t, e, n) {
                var i;
                if (M(e)) i = e; else if (e.svg) i = [{type: "svg", source: e.svg, specialAreas: e.specialAreas}]; else {
            ...
            createOnAllSeries: !0, performRawSeries: !0, reset: function (t, e) {
                ...
                if (t.legendSymbol && i.setVisual("legendSymbol", t.legendSymbol), t.hasSymbolVisual) {
                    var r = t.get("symbol"), o = t.get("symbolSize"), a = t.get("symbolKeepAspect"),
                        s = t.get("symbolRotate"), l = T(r), u = T(o), h = T(s), c = l || u || h,
        ...
        }, jM = 2 * Math.PI, qM = dx.CMD, ZM = ["top", "right", "bottom", "left"], KM = [], $M = new um, QM = new um,
        JM = new um, tT = new um, eT = new um, nT = [], iT = new um,
        rT = ["align", "verticalAlign", "width", "height", "fontSize"], oT = new jv, aT = or(), sT = or(),
        lT = ["x", "y", "rotation"], uT = function () {
            function t() {
            ...
            return t.prototype.clearLabels = function () {
                ...
                mm.applyTransform(u, u, l), l ? oT.setLocalTransform(l) : (oT.x = oT.y = oT.rotation = oT.originX = oT.originY = 0, oT.scaleX = oT.scaleY = 1);
                var h, c = i.__hostTarget;
                if (c) {
                    h = c.getBoundingRect().plain();
                    var p = c.getComputedTransform();
                    mm.applyTransform(h, h, p)
                }
                ...
                for (var n = t.getWidth(), i = t.getHeight(), r = 0; r < this._labelList.length; r++) {
                    ...
                    u = "function" == typeof o.layoutOption ? o.layoutOption(Qh(o, s)) : o.layoutOption, u = u || {}, o.computedLayoutOption = u;
                    var h = Math.PI / 180;
                    s && s.setTextConfig({
                        local: !1,
                ...
                var e = t.getWidth(), n = t.getHeight(), i = Xh(this._labelList), r = _(i, function (t) {
                ...
                y(this._chartViewList, function (e) {
                    ...
                    e.group.traverse(function (e) {
                        ...
                        !o && a && (o = aT(a).needsUpdateLabelLine), o && t._updateLabelLine(e, n), r && t._animateLabels(e, n)
                    })
                })
            }, t.prototype._updateLabelLine = function (t, e) {
                var n = t.getTextContent(), i = Gx(t), r = i.dataIndex;
                if (n && null != r) {
                ...
                if (n && !n.ignore && !n.invisible && !t.disableLabelAnimation && !rs(t)) {
                    var r = aT(n), o = r.oldLayout, a = Gx(t), s = a.dataIndex, l = {x: n.x, y: n.y, rotation: n.rotation},
                        u = e.getData(a.dataType);
                    if (o) {
                        n.attr(o);
                        var h = t.prevStates;
                        h && (p(h, "select") >= 0 && n.attr(r.oldLayoutSelect), p(h, "emphasis") >= 0 && n.attr(r.oldLayoutEmphasis)), Ja(n, l, e, s)
                    } else if (n.attr(l), !vw(n).valueAnimation) {
                        var c = N(n.style.opacity, 1);
                        n.style.opacity = 0, ts(n, {style: {opacity: c}}, e, s)
                    }
                    if (r.oldLayout = l, n.states.select) {
                        var f = r.oldLayoutSelect = {};
                        Jh(f, l, lT), Jh(f, n.states.select, lT)
                    }
                    if (n.states.emphasis) {
                        var d = r.oldLayoutEmphasis = {};
                        Jh(d, l, lT), Jh(d, n.states.emphasis, lT)
                    }
                    As(n, s, u, e, e)
                }
                if (i && !i.ignore && !i.invisible) {
                    var r = sT(i), o = r.oldLayout, g = {points: i.shape.points};
                    o ? (i.attr({shape: o}), Ja(i, {shape: g}, e)) : (i.setShape(g), i.style.strokePercent = 0, ts(i, {style: {strokePercent: 1}}, e)), r.oldLayout = g
                }
            }, t
        }(), hT = Math.round(9 * Math.random()), cT = function () {
            function t() {
                this._id = "__ec_inner_" + hT++
            }
        ...
        }), yT = {line: Ex, rect: Ex, roundRect: Ex, square: Ex, circle: _b, diamond: fT, pin: dT, arrow: gT, triangle: pT},
        vT = {
    ...
    var _T = Cx.extend({
            ...
            buildPath: function (t, e, n) {
                ...
                if ("none" !== i) {
                    var r = mT[i];
                    r || (i = "rect", r = mT[i]), vT[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(t, r.shape, n)
                }
            }
        }), xT = new dx(!0), bT = ["shadowBlur", "shadowOffsetX", "shadowOffsetY"],
        wT = [["lineCap", "butt"], ["lineJoin", "miter"], ["miterLimit", 10]], ST = 1, MT = 2, TT = 3, CT = 4,
        IT = new cT, DT = new Qv(100),
        AT = ["symbol", "symbolSize", "symbolKeepAspect", "color", "backgroundColor", "dashArrayX", "dashArrayY", "maxTileWidth", "maxTileHeight"],
        kT = G, LT = y, PT = T, OT = A, RT = p, ET = "undefined" != typeof window, BT = "5.0.2",
        zT = {zrender: "5.0.4"}, NT = 1, FT = 800, VT = 900, HT = 1e3, GT = 2e3, WT = 5e3, UT = 1e3, YT = 1100,
        XT = 2e3, jT = 3e3, qT = 4e3, ZT = 4500, KT = 4600, $T = 5e3, QT = 6e3, JT = 7e3, tC = {
            PROCESSOR: {FILTER: HT, SERIES_FILTER: FT, STATISTIC: WT},
            VISUAL: {
                LAYOUT: UT,
        ...
        }, eC = "__flagInMainProcess", nC = "__optionUpdated", iC = "__needsUpdateStatus", rC = /^[a-zA-Z0-9_]+$/,
        oC = "__connectUpdateStatus", aC = 0, sC = 1, lC = 2, uC = function (t) {
            function n() {
                return null !== t && t.apply(this, arguments) || this
            }
    ...
    hC.on = Fc("on"), hC.off = Fc("off");
    var cC, pC, fC, dC, gC, yC, vC, mC, _C, xC, bC, wC, SC, MC, TC, CC, IC, DC, AC, kC, LC, PC = function (t) {
        function n(e, n, i) {
            function r(t, e) {
                return t.__prio - e.__prio
            }

            var o = t.call(this, new UM) || this;
            o._chartsViews = [], o._chartsMap = {}, o._componentsViews = [], o._componentsMap = {}, o._pendingActions = [], i = i || {}, "string" == typeof n && (n = GC[n]), o._dom = e;
            ...
            o._throttledZrFlush = gh(pv(u.flush, u), 17), n = s(n), n && su(n, !0), o._theme = n, o._locale = Es(i.locale || Bw), o._coordSysMgr = new RS;
            var h = o._api = IC(o);
            return Qn(HC, r), Qn(zC, r), o._scheduler = new kM(o, h, zC, HC), o._messageCenter = new uC, o._labelManager = new uT, o._initEvents(), o.resize = pv(o.resize, o), u.animation.on("frame", o._onframe, o), xC(u, o), bC(u, o), U(o), o
        }
        ...
        return e(n, t), n.prototype._onframe = function () {
            if (!this._disposed) {
                ...
                if (this[nC]) {
                    ...
                    this[eC] = !0, cC(this), dC.update.call(this), this._zr.flush(), this[eC] = !1, this[nC] = !1, mC.call(this, e), _C.call(this, e)
                } else if (t.unfinished) {
                    var n = NT, i = this._model, r = this._api;
                    t.unfinished = !1;
                    do {
                        var o = +new Date;
                        t.performSeriesTasks(i), t.performDataProcessorTasks(i), yC(this, i), t.performVisualTasks(i), TC(this, this._model, r, "remain"), n -= +new Date - o
            ...
            if (!this._disposed) {
                var i, r, o;
                if (OT(e) && (n = e.lazyUpdate, i = e.silent, r = e.replaceMerge, o = e.transition, e = e.notMerge), this[eC] = !0, !this._model || e) {
                    var a = new BS(this._api), s = this._theme, l = this._model = new TS;
                    l.scheduler = this._scheduler, l.init(null, null, null, s, this._locale, a)
                }
                this._model.setOption(t, {replaceMerge: r}, NC), AC(this, o), n ? (this[nC] = {silent: i}, this[eC] = !1, this.getZr().wakeUp()) : (cC(this), dC.update.call(this), this._zr.flush(), this[nC] = !1, this[eC] = !1, mC.call(this, i), _C.call(this, i))
            }
            ...
            if (!this._disposed && Qy.canvasSupported) {
                ...
                if (YC[n]) {
                    ...
                    var f = u - a, d = h - l, g = cv(), v = pi(g, {renderer: e ? "svg" : "canvas"});
                    if (v.resize({width: f, height: d}), e) {
                        var m = "";
                        return LT(c, function (t) {
                    ...
                    return t.connectedBackgroundColor && v.add(new Ex({
                        shape: {x: 0, y: 0, width: f, height: d},
                        style: {fill: t.connectedBackgroundColor}
                    })), LT(c, function (t) {
                        var e = new Lx({style: {x: t.left * p - a, y: t.top * p - l, image: t.dom}});
                        v.add(e)
            ...
            if (!this._disposed) {
                this._disposed = !0, lr(this.getDom(), qC, "");
                var t = this._api, e = this._model;
                LT(this._componentsViews, function (n) {
                    n.dispose(e, t)
                }), LT(this._chartsViews, function (n) {
                    n.dispose(e, t)
                }), this._zr.dispose(), delete UC[this.id]
            }
            ...
            if (!this._disposed) {
                ...
                if (this._loadingFX && this._loadingFX.resize(), e) {
                    ...
                    this[eC] = !0, n && cC(this), dC.update.call(this, {
                        type: "resize",
            ...
            if (!this._disposed && (OT(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), WC[t])) {
                var n = WC[t](this._api, e), i = this._zr;
            ...
            var e = h({}, t);
            return e.type = BC[t.type], e
        }, n.prototype.dispatchAction = function (t, e) {
            if (!this._disposed && (OT(e) || (e = {silent: !!e}), EC[t.type] && this._model)) {
                if (this[eC]) return void this._pendingActions.push(t);
                var n = e.silent;
                vC.call(this, t, n);
                var i = e.flush;
                i ? this._zr.flush() : i !== !1 && Qy.browser.weChat && this._throttledZrFlush(), mC.call(this, n), _C.call(this, n)
            }
            ...
            function t(t) {
                ...
                t.selected && t.states.select && e.push("select"), t.hoverState === qx && t.states.emphasis ? e.push("emphasis") : t.hoverState === jx && t.states.blur && e.push("blur"), t.useStates(e)
            }
            ...
            function n(t, e) {
                ...
                i.traverse(function (t) {
                    t.isGroup || r++
                }), r > e.get("hoverLayerThreshold") && !Qy.node && !Qy.worker && e.eachSeries(function (e) {
            ...
            function a(e, n) {
                ...
                n.group.traverse(function (e) {
                    if (e.states && e.states.emphasis) {
                        if (rs(e)) return;
                        if (e instanceof Cx && wa(e), e.__dirty) {
                            var n = e.prevStates;
                            n && e.useStates(n)
                        }
                        if (r) {
            ...
            cC = function (t) {
                ...
                function n(t) {
                    ...
                    if (!h) {
                        var c = pr(t.type), p = e ? fM.getClass(c.main, c.sub) : yM.getClass(c.sub);
                ...
                var a = t._model;
                if (a.setUpdatePayload(n), !i) return void LT([].concat(t._componentsViews).concat(t._chartsViews), o);
                var s = {};
                s[i + "Id"] = n[i + "Id"], s[i + "Index"] = n[i + "Index"], s[i + "Name"] = n[i + "Name"];
                var l = {mainType: i, query: s};
                r && (l.subType = r);
                var u, h = n.excludeSeriesId;
                null != h && (u = X(), LT(Vi(h), function (t) {
                    var e = Ji(t, null);
                    null != e && u.set(e, !0)
                })), a && a.eachComponent(l, function (e) {
                    u && null != u.get(e.id) || (ba(n) && !n.notBlur ? e instanceof pM && ha(e, n, t._api) : xa(n) && e instanceof pM && (ca(e, n, t._api), pa(e), kC(t)), o(t["series" === i ? "_chartsMap" : "_componentsMap"][e.__viewId]))
                }, t)
            }, dC = {
                prepareAndUpdate: function (t) {
                    ...
                    if (e) {
                        e.setUpdatePayload(t), o.restoreData(e, t), o.performSeriesTasks(e), r.create(e, n), o.performDataProcessorTasks(e, t), yC(this, e), r.update(e, n), wC(e), o.performVisualTasks(e, t), SC(this, e, n, t);
                        var a = e.get("backgroundColor") || "transparent", s = e.get("darkMode");
                        if (Qy.canvasSupported) i.setBackgroundColor(a), null != s && "auto" !== s && i.setDarkMode(s); else {
                            var l = on(a);
                    ...
                    if (n) {
                        ...
                        }), wC(n), this._scheduler.performVisualTasks(n, t, {
                            setDirty: !0,
                            dirtyMap: o
                        }), TC(this, n, i, t, o), CC(n, this._api)
                    }
                }, updateView: function (t) {
                    var e = this._model;
                    e && (e.setUpdatePayload(t), yM.markUpdateMethod(t, "updateView"), wC(e), this._scheduler.performVisualTasks(e, t, {setDirty: !0}), SC(this, this._model, this._api, t), CC(e, this._api))
                }, updateVisual: function (t) {
                    var e = this, n = this._model;
                    n && (n.setUpdatePayload(t), n.eachSeries(function (t) {
                        t.getData().clearAllVisual()
                    }), yM.markUpdateMethod(t, "updateVisual"), wC(n), this._scheduler.performVisualTasks(n, t, {
                        visualType: "visual",
                        setDirty: !0
                ...
                var n = this, i = this.getModel(), r = t.type, o = t.escapeConnect, a = EC[r], s = a.actionInfo,
                ...
                var g, y = [], m = xa(t), _ = ba(t) || m;
                if (LT(f, function (t) {
                    g = a.action(t, n._model, n._api), g = g || h({}, t), g.type = s.event || g.type, y.push(g), _ ? (fC(n, u, t, "series"), kC(n)) : p && fC(n, u, t, p.main, p.sub)
                }), "none" === u || _ || p || (this[nC] ? (cC(this), dC.update.call(this, t), this[nC] = !1) : dC[u].call(this, t)), g = d ? {
                    type: s.event || r,
                    escapeConnect: o,
                    batch: y
                } : y[0], this[eC] = !1, !e) {
                ...
                t.on("mouseover", function (t) {
                    var n = t.target, i = ic(n, ma);
                    if (i) {
                        var r = Gx(i);
                        ua(r.seriesIndex, r.focus, r.blurScope, e._api, !0), Jo(i, t), kC(e)
                    }
                }).on("mouseout", function (t) {
                    var n = t.target, i = ic(n, ma);
                    if (i) {
                        var r = Gx(i);
                        ua(r.seriesIndex, r.focus, r.blurScope, e._api, !1), ta(i, t), kC(e)
                    }
                }).on("click", function (t) {
                    var n = t.target, i = ic(n, function (t) {
                        return null != Gx(t).dataIndex
                    }, !0);
                    if (i) {
                        var r = i.selected ? "unselect" : "select", o = Gx(i);
                ...
                MC(t, e, n, i), LT(t._chartsViews, function (t) {
                    t.__alive = !1
                }), TC(t, e, n, i), LT(t._chartsViews, function (t) {
                    t.__alive || t.remove(e, n)
                })
            }, MC = function (t, e, n, i, s) {
                LT(s || t._componentsViews, function (t) {
                    var s = t.__model;
                    o(s, t), t.render(s, e, n, i), r(s, t), a(s, t)
                })
            }, TC = function (t, e, s, l, u) {
                ...
                e.eachSeries(function (e) {
                    ...
                    n.__alive = !0;
                    var r = n.renderTask;
                    h.updatePayload(r, l), o(e, n), u && u.get(e.uid) && r.dirty(), r.perform(h.getPerformArgs(r)) && (p = !0), e.__transientTransitionOpt = null, n.group.silent = !!e.get("silent"), i(e, n), pa(e), c.addLabelsOfSeries(n)
                ...
                e[iC] && (e.getZr().storage.traverse(function (e) {
                    rs(e) || t(e)
                }), e[iC] = !1)
            }, IC = function (t) {
    ...
    OC.on = Nc("on"), OC.off = Nc("off"), OC.one = function (t, e, n) {
        function i() {
    ...
    var RC = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout", "contextmenu"],
        EC = {}, BC = {}, zC = [], NC = [], FC = [], VC = [], HC = [], GC = {}, WC = {}, UC = {}, YC = {},
        XC = +new Date - 0, jC = +new Date - 0, qC = "_echarts_instance_", ZC = Wc, KC = [], $C = Ou;
    np(XT, TM), np(ZT, IM), np(ZT, DM), np(XT, YM), np(ZT, XM), np(JT, zc), qc(su), Zc(VT, lu), rp("default", _h), Qc({
        type: Jx,
        event: Jx,
        update: Jx
    }, K), Qc({type: tb, event: tb, update: tb}, K), Qc({type: eb, event: eb, update: eb}, K), Qc({
        type: nb,
        event: nb,
        update: nb
    }, K), Qc({type: ib, event: ib, update: ib}, K), jc("light", EM), jc("dark", VM);
    var QC, JC, tI, eI, nI, iI, rI, oI, aI, sI, lI, uI, hI, cI, pI = {}, fI = function () {
            function t(t, e, n, i, r, o) {
                this._old = t, this._new = e, this._oldKeyGetter = n || up, this._newKeyGetter = i || up, this.context = r, this._diffModeMultiple = "multiple" === o
            }
            ...
            return t
        }(), gI = Math.floor, yI = A, vI = v, mI = "undefined", _I = -1, xI = "e\x00\x00", bI = {
            "float": typeof Float64Array === mI ? Array : Float64Array,
            "int": typeof Int32Array === mI ? Array : Int32Array,
            ordinal: Array,
            number: Array,
            time: Array
        }, wI = typeof Uint32Array === mI ? Array : Uint32Array, SI = typeof Int32Array === mI ? Array : Int32Array,
        MI = typeof Uint16Array === mI ? Array : Uint16Array,
        TI = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_rawData", "_dimValueGetter", "_count", "_rawCount", "_nameDimIdx", "_idDimIdx", "_nameRepeatCount"],
        CI = ["_extent", "_approximateExtent", "_rawExtent"], II = function () {
            function t(t, e) {
                this.type = "list", this._count = 0, this._rawCount = 0, this._storage = {}, this._storageArr = [], this._nameList = [], this._idList = [], this._visual = {}, this._layout = {}, this._itemVisuals = [], this._itemLayouts = [], this._graphicEls = [], this._rawExtent = {}, this._extent = {}, this._approximateExtent = {}, this._calculationInfo = {}, this.hasItemOption = !0, this.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "lttbDownSample", "map"], this.CHANGABLE_METHODS = ["filterSelf", "selectRange"], this.DOWNSAMPLE_METHODS = ["downSample", "lttbDownSample"], this.getRawIndex = nI, t = t || ["x", "y"];
                for (var n = {}, i = [], r = {}, o = 0; o < t.length; o++) {
                    var a = t[o], s = C(a) ? new dI({name: a}) : a instanceof dI ? a : new dI(a), l = s.name;
                ...
                this.dimensions = i, this._dimensionInfos = n, this.hostModel = e, this._dimensionsSummary = hp(this), this._invertedIndicesMap = r, this.userOutput = this._dimensionsSummary.userOutput
            }
            ...
            return t.prototype.getDimension = function (t) {
                ...
                for (var n = this._storage, i = this.dimensions, r = i.length, o = this._rawExtent, a = this.count(), s = a + Math.max(t.length, e ? e.length : 0), l = 0; r > l; l++) {
                    var u = i[l];
                    o[u] || (o[u] = uI()), eI(n, this._dimensionInfos[u], s, !0)
                }
                for (var h = vI(i, function (t) {
                    return o[t]
                }), c = this._storageArr = vI(i, function (t) {
                    return n[t]
                }), p = [], f = a; s > f; f++) {
                    ...
                    e && (this._nameList[f] = e[d], this._dontMakeIdFromName || aI(this, f))
                }
                this._rawCount = this._count = s, this._extent = {}, JC(this)
            }, t.prototype._initDataFromProvider = function (t, e, n) {
                if (!(t >= e)) {
                    for (var i = this._rawData, r = this._storage, o = this.dimensions, a = o.length, s = this._dimensionInfos, l = this._nameList, u = this._idList, h = this._rawExtent, c = i.getSource().sourceFormat, p = c === hS, f = 0; a > f; f++) {
                        var d = o[f];
                        h[d] || (h[d] = uI()), eI(r, s[d], e, n)
                    }
                    var g = this._storageArr = vI(o, function (t) {
                        return r[t]
                    }), y = vI(o, function (t) {
                        return h[t]
                    });
                    if (i.fillStorage) i.fillStorage(t, e, g, y); else for (var v = [], m = t; e > m; m++) {
                        ...
                        this._dontMakeIdFromName || aI(this, m)
                    }
                    !i.persistent && i.clean && i.clean(), this._rawCount = this._count = e, this._extent = {}, JC(this)
                }
            }, t.prototype.count = function () {
                return this._count
                ...
                yI(t) ? h(this._calculationInfo, t) : this._calculationInfo[t] = e
                ...
                return null == n && null != this._nameDimIdx && (n = oI(this, this._nameDimIdx, this._nameOrdinalMeta, e)), null == n && (n = ""), n
            }, t.prototype.getId = function (t) {
                return rI(this, this.getRawIndex(t))
            }, t.prototype.each = function (t, e, n, i) {
                var r = this;
                if (this._count) {
                    "function" == typeof t && (i = n, n = e, e = t, t = []);
                    for (var o = n || i || this, a = vI(sI(t), this.getDimension, this), s = a.length, l = vI(a, function (t) {
                ...
                if (this._count) {
                    "function" == typeof t && (i = n, n = e, e = t, t = []);
                    for (var o = n || i || this, a = vI(sI(t), this.getDimension, this), s = this.count(), l = tI(this), u = new l(s), h = [], c = a.length, p = 0, f = vI(a, function (t) {
                        return r._dimensionInfos[t].index
                    ...
                    return s > p && (this._indices = u), this._count = p, this._extent = {}, this.getRawIndex = this._indices ? iI : nI, this
                }
                ...
                if (n) {
                    ...
                    var o = i.length;
                    if (o) {
                        var a = this.count(), s = tI(this), l = new s(a), u = 0, h = i[0], c = vI(i, function (t) {
                        ...
                        if (!g) if (1 === o) for (var m = 0; a > m; m++) {
                            var M = this.getRawIndex(m), _ = d[c[0]][M];
                        ...
                        return a > u && (this._indices = l), this._count = u, this._extent = {}, this.getRawIndex = this._indices ? iI : nI, this
                    }
                }
                ...
                var r = n || i || this, o = vI(sI(t), this.getDimension, this), a = lI(this, o), s = a._storage;
                a._indices = this._indices, a.getRawIndex = a._indices ? iI : nI;
                ...
                for (var r = lI(this, [t]), o = r._storage, a = [], s = gI(1 / e), l = o[t], u = this.count(), h = r._rawExtent[t], c = new (tI(this))(u), p = 0, f = 0; u > f; f += s) {
                ...
                return r._count = p, r._indices = c, r.getRawIndex = iI, r
            }, t.prototype.lttbDownSample = function (t, e) {
                var n, i, r, o = lI(this, []), a = o._storage, s = a[t], l = this.count(), u = new (tI(this))(l), h = 0,
                    c = gI(1 / e), p = this.getRawIndex(0);
                u[h++] = p;
                for (var f = 1; l - 1 > f; f += c) {
                    ...
                    v /= g - d;
                    var b = f, w = Math.min(f + c, l), S = f - 1, M = s[p];
                    n = -1, r = b;
                    for (var m = b; w > m; m++) {
                        var _ = this.getRawIndex(m), x = s[_];
                ...
                return u[h++] = this.getRawIndex(l - 1), o._count = h, o._indices = u, o.getRawIndex = iI, o
            }, t.prototype.getItemModel = function (t) {
                var e = this.hostModel, n = this.getRawDataItem(t);
                return new Iw(n, e, e && e.ecModel)
            }, t.prototype.diff = function (t) {
                var e = this;
                return new fI(t ? t.getIndices() : [], this.getIndices(), function (e) {
                    return rI(t, e)
                }, function (t) {
                    return rI(e, t)
                })
                ...
                this._visual = this._visual || {}, yI(t) ? h(this._visual, t) : this._visual[t] = e
                ...
                i || (i = n[t] = {});
                var r = i[e];
                return null == r && (r = this.getVisual(e), M(r) ? r = r.slice() : yI(r) && (r = h({}, r)), i[e] = r), r
            }, t.prototype.setItemVisual = function (t, e, n) {
                var i = this._itemVisuals[t] || {};
                this._itemVisuals[t] = i, yI(e) ? h(i, e) : i[e] = n
            }, t.prototype.clearAllVisual = function () {
                this._visual = {}, this._itemVisuals = []
            }, t.prototype.setLayout = function (t, e) {
                if (yI(t)) for (var n in t) t.hasOwnProperty(n) && this.setLayout(n, t[n]); else this._layout[t] = e
                ...
                if (e) {
                    var i = Gx(e);
                    i.dataIndex = t, i.dataType = this.dataType, i.seriesIndex = n && n.seriesIndex, "group" === e.type && e.traverse(hI, e)
                }
                ...
                if (!e) {
                    var n = vI(this.dimensions, this.getDimensionInfo, this);
                    e = new t(n, this.hostModel)
                }
                if (e._storage = this._storage, e._storageArr = this._storageArr, cI(e, this), this._indices) {
                ...
                return e.getRawIndex = e._indices ? iI : nI, e
                ...
                function e(t, e, n, i) {
                    return Iu(t[i], this._dimensionInfos[e])
                }
                ...
                QC = {
                    arrayRows: e, objectRows: function (t, e) {
                        ...
                        return !this._rawData.pure && Wi(t) && (this.hasItemOption = !0), Iu(r instanceof Array ? r[i] : r, this._dimensionInfos[e])
                    ...
                    y(e, function (n, i) {
                        ...
                        if (o) {
                            n = e[i] = new SI(o.categories.length);
                            for (var a = 0; a < n.length; a++) n[a] = _I;
                    ...
                    return t._rawCount > 65535 ? wI : MI
                }, eI = function (t, e, n, i) {
                    var r = bI[e.type], o = e.name;
                    if (i) {
                    ...
                    var n = t._idList[e];
                    return null == n && null != t._idDimIdx && (n = oI(t, t._idDimIdx, t._idOrdinalMeta, e)), null == n && (n = xI + e), n
                }, sI = function (t) {
                    return M(t) || (t = null != t ? [t] : []), t
                }, lI = function (e, i) {
                    var r = e.dimensions, o = new t(vI(r, e.getDimensionInfo, e), e.hostModel);
                    cI(o, e);
                    for (var a = o._storage = {}, s = e._storage, l = o._storageArr = [], u = 0; u < r.length; u++) {
                        var h = r[u];
                        s[h] && (p(i, h) >= 0 ? (a[h] = n(s[h]), o._rawExtent[h] = uI(), o._extent[h] = null) : a[h] = s[h], l.push(a[h]))
                    }
                    return o
                }, uI = function () {
                    return [1 / 0, -1 / 0]
                }, hI = function (t) {
                    var e = Gx(t), n = Gx(this);
                    e.seriesIndex = n.seriesIndex, e.dataIndex = n.dataIndex, e.dataType = n.dataType
                }, cI = function (t, e) {
                    y(TI.concat(e.__wrappedMethods || []), function (n) {
                        e.hasOwnProperty(n) && (t[n] = e[n])
                    }), t.__wrappedMethods = e.__wrappedMethods, y(CI, function (n) {
                        t[n] = s(e[n])
                    }), t._calculationInfo = h({}, e._calculationInfo)
                }, aI = function (t, e) {
                    var n = t._nameList, i = t._idList, r = t._nameDimIdx, o = t._idDimIdx, a = n[e], s = i[e];
                    if (null == a && null != r && (n[e] = a = oI(t, r, t._nameOrdinalMeta, e)), null == s && null != o && (i[e] = s = oI(t, o, t._idOrdinalMeta, e)), null == s && null != a) {
            ...
            cartesian2d: function (t, e, n, i) {
                var r = t.getReferringComponents("xAxis", c_).models[0],
                    o = t.getReferringComponents("yAxis", c_).models[0];
                e.coordSysDims = ["x", "y"], n.set("x", r), n.set("y", o), _p(r) && (i.set("x", r), e.firstCategoryDimIndex = 0), _p(o) && (i.set("y", o), null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1))
            }, singleAxis: function (t, e, n, i) {
                var r = t.getReferringComponents("singleAxis", c_).models[0];
                e.coordSysDims = ["single"], n.set("single", r), _p(r) && (i.set("single", r), e.firstCategoryDimIndex = 0)
            }, polar: function (t, e, n, i) {
                var r = t.getReferringComponents("polar", c_).models[0], o = r.findAxisModel("radiusAxis"),
                    a = r.findAxisModel("angleAxis");
                e.coordSysDims = ["radius", "angle"], n.set("radius", o), n.set("angle", a), _p(o) && (i.set("radius", o), e.firstCategoryDimIndex = 0), _p(a) && (i.set("angle", a), null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1))
            }, geo: function (t, e) {
                ...
                y(o.parallelAxisIndex, function (t, o) {
                    ...
                    n.set(l, s), _p(s) && (i.set(l, s), null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = o))
                })
            }
        }, kI = function () {
            function t(t) {
    ...
    var LI = function () {
        ...
        return t.createByAxisModel = function (e) {
            var n = e.option, i = n.data, r = i && v(i, Cp);
        ...
        function n(e) {
            ...
            return i || (i = new LI({})), M(i) && (i = new LI({
        ...
        return e(n, t), n.prototype.parse = function (t) {
            ...
            return t = this.parse(t), Lp(t, this._extent) && null != this._ordinalMeta.categories[t]
    ...
    kI.registerClass(EI);
    var BI = "__ec_stack_", zI = .5, NI = "undefined" != typeof Float32Array ? Float32Array : Array, FI = {
            seriesType: "bar", plan: hh(), reset: function (t) {
                if (Gp(t) && Wp(t)) {
                    var e = t.getData(), n = t.coordinateSystem, i = n.master.getRect(), r = n.getBaseAxis(),
                        ...
                        u = l ? 0 : 1, h = Vp(Np([t]), r, t).width;
                    return h > zI || (h = zI), {
                        progress: function (t, e) {
                            for (var c, p = t.count, f = new NI(2 * p), d = new NI(2 * p), g = new NI(p), y = [], v = [], m = 0, _ = 0; null != (c = t.next());) v[u] = e.get(a, c), v[1 - u] = e.get(s, c), y = n.dataToPoint(v, null, y), d[m] = l ? i.x + i.width : y[0], f[m++] = y[0], d[m] = l ? y[1] : i.y + i.height, f[m++] = y[1], g[_++] = c;
                            e.setLayout({
                                largePoints: f,
                                largeDataIndices: g,
            ...
            return e(n, t), n.prototype.getLabel = function (t) {
                ...
                return Gs(t.value, Uw[Hs(Fs(this._minLevelUnit))] || Uw.second, e, this.getSetting("locale"))
                ...
                var i = this.getSetting("useUTC"), r = Qp(this._minLevelUnit, this._approxInterval, i, e);
                return n = n.concat(r), n.push({value: e[1], level: 0}), n
            }, n.prototype.niceExtent = function (t) {
                var e = this._extent;
                if (e[0] === e[1] && (e[0] -= Vw, e[1] += Vw), e[1] === -1 / 0 && 1 / 0 === e[0]) {
                    var n = new Date;
                    e[1] = +new Date(n.getFullYear(), n.getMonth(), n.getDate()), e[0] = e[1] - Vw
                }
                ...
                var o = GI.length, a = Math.min(VI(GI, this._approxInterval, 0, o), o - 1);
                this._interval = GI[a][1], this._minLevelUnit = GI[Math.max(a - 1, 0)][0]
        ...
        GI = [["second", zw], ["minute", Nw], ["hour", Fw], ["quarter-day", 6 * Fw], ["half-day", 12 * Fw], ["day", 1.2 * Vw], ["half-week", 3.5 * Vw], ["week", 7 * Vw], ["month", 31 * Vw], ["quarter", 95 * Vw], ["half-year", Hw / 2], ["year", Hw]];
    kI.registerClass(HI);
    var WI = kI.prototype, UI = EI.prototype, YI = Si, XI = xi, jI = Math.floor, qI = Math.ceil, ZI = Math.pow,
        KI = Math.log, $I = function (t) {
            function n() {
                var e = null !== t && t.apply(this, arguments) || this;
                return e.type = "log", e.base = 10, e._originalScale = new EI, e._interval = 0, e
            }

            return e(n, t), n.prototype.getTicks = function (t) {
                var e = this._originalScale, n = this._extent, i = e.getExtent(), r = UI.getTicks.call(this, t);
                return v(r, function (t) {
                    var e = t.value, r = xi(ZI(this.base, e));
                    return r = e === n[0] && this._fixMin ? Jp(r, i[0]) : r, r = e === n[1] && this._fixMax ? Jp(r, i[1]) : r, {value: r}
                }, this)
            }, n.prototype.setExtent = function (t, e) {
                var n = this.base;
                t = KI(t) / KI(n), e = KI(e) / KI(n), UI.setExtent.call(this, t, e)
            }, n.prototype.getExtent = function () {
                var t = this.base, e = WI.getExtent.call(this);
                e[0] = ZI(t, e[0]), e[1] = ZI(t, e[1]);
                var n = this._originalScale, i = n.getExtent();
                return this._fixMin && (e[0] = Jp(e[0], i[0])), this._fixMax && (e[1] = Jp(e[1], i[1])), e
            }, n.prototype.unionExtent = function (t) {
                this._originalScale.unionExtent(t);
                var e = this.base;
                t[0] = KI(t[0]) / KI(e), t[1] = KI(t[1]) / KI(e), WI.unionExtent.call(this, t)
            }, n.prototype.unionExtentFromData = function (t, e) {
                this.unionExtent(t.getApproximateExtent(e))
                ...
                if (!(1 / 0 === n || 0 >= n)) {
                    ...
                    var o = [xi(qI(e[0] / i) * i), xi(jI(e[1] / i) * i)];
                    this._interval = i, this._niceExtent = o
                }
            }, n.prototype.niceExtent = function (t) {
                UI.niceExtent.call(this, t), this._fixMin = t.fixMin, this._fixMax = t.fixMax
            }, n.prototype.parse = function (t) {
                return t
            }, n.prototype.contain = function (t) {
                return t = KI(t) / KI(this.base), Lp(t, this._extent)
            }, n.prototype.normalize = function (t) {
                return t = KI(t) / KI(this.base), Pp(t, this._extent)
            }, n.prototype.scale = function (t) {
                return t = Op(t, this._extent), ZI(this.base, t)
            }, n.type = "log", n
        }(kI), QI = $I.prototype;
    QI.getMinorTicks = UI.getMinorTicks, QI.getLabel = UI.getLabel, kI.registerClass($I);
    var JI = function () {
            function t(t, e, n) {
            ...
            return t.prototype._prepareParams = function (t, e, n) {
                ...
                if (T(o) ? this._modelMaxNum = ef(t, o({
                    min: n[0],
                    max: n[1]
                })) : "dataMax" !== o && (this._modelMaxNum = ef(t, o)), i) this._axisDataLen = e.getCategories().length; else {
        ...
        }(), tD = {min: "_determinedMin", max: "_determinedMax"}, eD = {min: "_dataMin", max: "_dataMax"},
        nD = function () {
            function t() {
            }
        ...
        }(), iD = {isDimensionStacked: bp, enableDataStack: xp, getStackedDimension: wp},
        rD = (Object.freeze || Object)({
            ...
            registerSubTypeDefaulter: function (t, e) {
                iS.registerSubTypeDefaulter(t, e)
            },
            ...
            return t.prototype.getBoundingRect = function () {
                ...
                return 0 === s && (n[0] = n[1] = i[0] = i[1] = 0), this._rect = new mm(n[0], n[1], i[0] - n[0], i[1] - n[1])
                ...
                n ? i || (i = n / o) : n = o * i;
                for (var a = new mm(t, e, n, i), s = r.calculateTransform(a), l = this.geometries, u = 0; u < l.length; u++) if ("polygon" === l[u].type) {
            ...
            isNumeric: Ei,
            numericToNumber: Ri
        }), hD = (Object.freeze || Object)({parse: Di, format: Gs}), cD = (Object.freeze || Object)({
            extendShape: Ga,
            extendPath: Wa,
            makePath: Xa,
            makeImage: ja,
            ...
            return t.prototype.contain = function (t) {
                ...
                return t = i.normalize(t), this.onBand && "ordinal" === i.type && (n = n.slice(), Ff(n, i.count())), mi(t, gD, n, e)
            }, t.prototype.coordToData = function (t, e) {
                var n = this._extent, i = this.scale;
                this.onBand && "ordinal" === i.type && (n = n.slice(), Ff(n, i.count()));
                var r = mi(t, n, gD, e);
                return this.scale.scale(r)
            }, t.prototype.pointToData = function () {
            }, t.prototype.getTicksCoords = function (t) {
                t = t || {};
                var e = t.tickModel || this.getTickModel(), n = Cf(this, e), i = n.ticks, r = v(i, function (t) {
                    return {
            ...
            function n(e, n, i) {
                ...
                var o;
                i = i || Sm, "string" == typeof e ? o = Xf(e, n, i) : A(e) && (o = e, e = o.id), r.id = e, r.dom = o;
                var a = o.style;
                return a && (o.onselectstart = Yf, a.webkitUserSelect = "none", a.userSelect = "none", a.webkitTapHighlightColor = "rgba(0,0,0,0)", a["-webkit-touch-callout"] = "none", a.padding = "0", a.margin = "0", a.borderWidth = "0"), r.domBack = null, r.ctxBack = null, r.painter = n, r.config = null, r.dpr = i, r
            }
            ...
            return e(n, t), n.prototype.getElementCount = function () {
                ...
                function r(t) {
                    if (t.isFinite() && !t.isZero()) if (0 === o.length) {
                        var e = new mm(0, 0, 0, 0);
                        e.copy(t), o.push(e)
                    } else {
                        for (var n = !1, i = 1 / 0, r = 0, u = 0; u < o.length; ++u) {
                            var h = o[u];
                            if (h.intersect(t)) {
                                var c = new mm(0, 0, 0, 0);
                ...
                for (var o = [], a = this.maxRepaintRectCount, s = !1, l = new mm(0, 0, 0, 0), u = this.__startIndex; u < this.__endIndex; ++u) {
                    var h = t[u];
                    if (h) {
                        var c = h.shouldBePainted(n, i, !0, !0),
                            p = h.__isRendered && (h.__dirty & Om.REDARAW_BIT || !c) ? h.getPrevPaintRect() : null;
                        p && r(p);
                        var f = c && (h.__dirty & Om.REDARAW_BIT || !h.__isRendered) ? h.getPaintRect() : null;
                        f && r(f)
                    }
                }
        ...
        }(Sv), mD = 1e5, _D = 314159, xD = .01, bD = .001, wD = function () {
            function t(t, e, n) {
                this.type = "canvas", this._zlevelList = [], this._prevDisplayList = [], this._layers = {}, this._layerConfig = {}, this._needsManuallyCompositing = !1, this.type = "canvas";
                var i = !t.nodeName || "CANVAS" === t.nodeName.toUpperCase();
                this._opts = n = h({}, n || {}), this.dpr = n.devicePixelRatio || Sm, this._singleCanvas = i, this.root = t;
                var r = t.style;
                ...
                if (i) {
                    ...
                    var c = new vD(s, this, this.dpr);
                    c.__builtin__ = !0, c.initContext(), a[_D] = c, c.zlevel = _D, o.push(_D), this._domRoot = t
                } else {
            ...
            return t.prototype.getType = function () {
                ...
                if (n && n.clear(), e) {
                    for (var i, r = {inHover: !0, viewWidth: this._width, viewHeight: this._height}, o = 0; e > o; o++) {
                        var a = t[o];
                        a.__inHover && (n || (n = this._hoverlayer = this.getLayer(mD)), i || (i = n.ctx, i.save()), Ac(i, a, r, o === e - 1))
                    }
                    i && i.restore()
                }
            }, t.prototype.getHoverLayer = function () {
                return this.getLayer(mD)
                ...
                var t = this.getLayer(_D).ctx, e = this._domRoot.width, n = this._domRoot.height;
                ...
                return Qy.wxa && y(this._layers, function (t) {
                ...
                if (n) {
                    ...
                    (!i || s && s.intersect(i)) && (Ac(a, t, r, o), t.setPrevPaintRect(s))
                } else Ac(a, t, r, o)
            }, t.prototype.getLayer = function (t, e) {
                this._singleCanvas && !this._needsManuallyCompositing && (t = _D);
                var n = this._layers[t];
                return n || (n = new vD("zr_" + t, this, this.dpr), n.zlevel = t, n.__builtin__ = !0, this._layerConfig[t] ? l(n, this._layerConfig[t], !0) : this._layerConfig[t - xD] && l(n, this._layerConfig[t - xD], !0), e && (n.virtual = e), this.insertLayer(t, n), n.initContext()), n
                ...
                if (!qf(e)) return void a("Layer of zlevel " + t + " is not valid");
                if (r > 0 && t > i[0]) {
                ...
                for (o = 0; o < t.length; o++) {
                    ...
                    r !== u && (r = u, l = 0), i.incremental ? (h = this.getLayer(u + bD, this._needsManuallyCompositing), h.incremental = !0, l = 1) : h = this.getLayer(u + (l > 0 ? xD : 0), this._needsManuallyCompositing), h.__builtin__ || a("ZLevel " + u + " has been used by unkown layer " + h.id), h !== s && (h.__used = !0, h.__startIndex !== o && (h.__dirty = !0), h.__startIndex = o, h.__drawIndex = h.incremental ? -1 : o, e(o), s = h), i.__dirty & Om.REDARAW_BIT && !i.__inHover && (h.__dirty = !0, h.incremental && h.__drawIndex < 0 && (h.__drawIndex = o))
                }
                ...
                if (this._domRoot.style) {
                    ...
                    this._width = t, this._height = e, this.getLayer(_D).resize(t, e)
                }
                return this
                ...
                if (t = t || {}, this._singleCanvas && !this._compositeManually) return this._layers[_D].dom;
                var e = new vD("image", this, t.pixelRatio || this.dpr);
                ...
                return (a[i] || jf(s[n]) || jf(a.style[n])) - (jf(s[r]) || 0) - (jf(s[o]) || 0) | 0
            }, t.prototype.pathToImage = function (t, e) {
                e = e || this.dpr;
                ...
                t.x = c - r.x, t.y = f - r.y, t.rotation = 0, t.scaleX = 1, t.scaleY = 1, t.updateTransform(), t && Ac(i, t, {
                    inHover: !1,
                    viewWidth: this._width,
                    viewHeight: this._height
                }, !0);
                var m = new Lx({style: {x: 0, y: 0, image: n}});
                return h(t, v), m
            }, t
        }(), SD = function (t) {
            function n() {
            ...
            return e(n, t), n.prototype.init = function (e, n, i) {
                t.prototype.init.call(this, e, n, i), this._sourceManager = new oM(this), zu(this)
            ...
            }, n.type = "dataset", n.defaultOption = {seriesLayoutBy: yS}, n
        }(iS), MD = function (t) {
            function n() {
                var e = null !== t && t.apply(this, arguments) || this;
                return e.type = "dataset", e
    ...
    var TD = {
        ...
        return e(n, t), n.prototype.getInitialData = function () {
            return Sp(this.getSource(), this, {useEncodeDefaulter: !0})
    ...
    var DD = function (t) {
            ...
            }, n.type = "series.bar", n.dependencies = ["grid", "polar"], n.defaultOption = Os(ID.defaultOption, {
                clip: !0,
                roundCap: !1,
                showBackground: !1,
                backgroundStyle: {
        ...
        }(Cx), LD = ["itemStyle", "borderWidth"], PD = ["itemStyle", "borderRadius"], OD = [0, 0], RD = Math.max,
        ED = Math.min, BD = function (t) {
            function n() {
            ...
            return e(n, t), n.prototype.render = function (t, e, n, i) {
                ...
                function r(t) {
                    var e = FD[u.type](s, t), n = yd(u, o, e);
                ...
                var c = t.isAnimationEnabled() ? t : null, p = ad(t, u);
                p && this._enableRealtimeSort(p, s, n);
                var f = t.get("clip", !0) || p, d = od(u, s);
                a.removeClipPath();
                ...
                s.diff(l).add(function (e) {
                    var n = s.getItemModel(e), i = FD[u.type](s, e, n);
                    if (y && r(e), s.hasValue(e)) {
                        var l = !1;
                        f && (l = zD[u.type](d, i));
                        var v = ND[u.type](t, s, e, i, o, c, h.model, !1, g);
                        ud(v, s, e, n, i, t, o, "polar" === u.type), b ? v.attr({shape: i}) : p ? sd(p, c, v, i, e, o, !1, !1) : ts(v, {shape: i}, t, e), s.setItemGraphicEl(e, v), a.add(v), v.ignore = l
                    }
                }).update(function (e, n) {
                    var i = s.getItemModel(e), S = FD[u.type](s, e, i);
                    if (y) {
                        var M = void 0;
                        0 === x.length ? M = r(n) : (M = x[n], M.useStyle(v.getItemStyle()), "cartesian2d" === u.type && M.setShape("r", m), _[e] = M);
                        var T = FD[u.type](s, e), C = gd(o, T, u);
                        Ja(M, {shape: C}, c, e)
                    }
                    var I = l.getItemGraphicEl(n);
                    if (!s.hasValue(e)) return a.remove(I), void (I = null);
                    var D = !1;
                    f && (D = zD[u.type](d, S), D && a.remove(I)), I || (I = ND[u.type](t, s, e, S, o, c, h.model, !!I, g)), w || ud(I, s, e, i, S, t, o, "polar" === u.type), b ? I.attr({shape: S}) : p ? sd(p, c, I, S, e, o, !0, w) : Ja(I, {shape: S}, t, e, null), s.setItemGraphicEl(e, I), I.ignore = D, a.add(I)
                }).remove(function (e) {
                    var n = l.getItemGraphicEl(e);
                    n && is(n, t, e)
                }).execute();
                var S = this._backgroundGroup || (this._backgroundGroup = new $m);
                S.removeAll();
                for (var M = 0; M < _.length; ++M) S.add(_[M]);
                a.add(S), this._backgroundEls = _, this._data = s
            }, n.prototype._renderLarge = function (t) {
                this._clear(), cd(t, this.group), this._updateLargeClip(t)
            }, n.prototype._incrementalRenderLarge = function (t, e) {
                this._removeBackground(), cd(e, this.group, !0)
            }, n.prototype._updateLargeClip = function (t) {
                var e = t.get("clip", !0) ? ed(t.coordinateSystem, !1, t) : null;
            ...
            cartesian2d: function (t, e) {
                ...
                var r = t.x + t.width, o = t.y + t.height, a = RD(e.x, t.x), s = ED(e.x + e.width, r), l = RD(e.y, t.y),
                    u = ED(e.y + e.height, o), h = a > s, c = l > u;
                ...
                var r = ED(e.r, t.r), o = RD(e.r0, t.r0);
                e.r = r, e.r0 = o;
                var a = 0 > r - o;
                if (0 > n) {
                    var i = e.r;
            ...
            cartesian2d: function (t, e, n, i, r, o) {
                ...
                var u = i.startAngle < i.endAngle, h = !r && l ? kD : Rb, p = new h({shape: c({clockwise: u}, i), z2: 1});
                if (p.name = "item", o) {
                    var f = p.shape, d = r ? "r" : "endAngle", g = {};
                    f[d] = r ? 0 : i.startAngle, g[d] = i[d], (s ? Ja : ts)(p, {shape: g}, o)
                }
                return p
            }
        }, FD = {
            cartesian2d: function (t, e, n) {
                var i = t.getItemLayout(e), r = n ? hd(n, i) : 0, o = i.width > 0 ? 1 : -1, a = i.height > 0 ? 1 : -1;
            ...
            var e = this, n = pd(e, t.offsetX, t.offsetY);
            Gx(e).dataIndex = n >= 0 ? n : null
        }, 30, !1);
    _f(vd);
    var WD = function (t) {
            function n() {
            ...
            return e(n, t), n.prototype._createSymbol = function (t, e, n, i, r) {
                ...
                o.attr({
                    ...
                    scaleX: i[0] / 2,
                    scaleY: i[1] / 2
                }), o.drift = md, this._symbolType = t, this.add(o)
                ...
                if (i && (a = i.emphasisItemStyle, s = i.blurItemStyle, l = i.selectItemStyle, u = i.focus, c = i.blurScope, p = i.symbolOffset, f = i.labelStatesModels, d = i.hoverScale, g = i.cursorStyle), !i || t.hasItemOption) {
                    ...
                    a = _.getModel("itemStyle").getItemStyle(), l = m.getModel(["select", "itemStyle"]).getItemStyle(), s = m.getModel(["blur", "itemStyle"]).getItemStyle(), u = _.get("focus"), c = _.get("blurScope"), p = m.getShallow("symbolOffset"), f = bs(m), d = _.getShallow("scale"), g = m.getShallow("cursor")
                }
                var x = t.getItemVisual(e, "symbolRotate");
                y.attr("rotation", (x || 0) * Math.PI / 180 || 0), p && (y.x = _i(p[0], n[0]), y.y = _i(p[1], n[1])), g && y.attr("cursor", g);
                ...
                null != M ? null == T && (this._z2 = y.z2, y.z2 += M) : null != T && (y.z2 = T, this._z2 = null);
                ...
                var n = this.childAt(0), i = this._seriesModel, r = Gx(this).dataIndex, o = e && e.animation;
                if (this.silent = n.silent = !0, e && e.fadeLabel) {
                    var a = n.getTextContent();
                    a && es(a, {style: {opacity: 0}}, i, {
                        dataIndex: r, removeOpt: o, cb: function () {
                            n.removeTextContent()
                        }
                    })
                } else n.removeTextContent();
                es(n, {style: {opacity: 0}, scaleX: 0, scaleY: 0}, i, {dataIndex: r, cb: t, removeOpt: o})
            ...
            function t(t) {
                this.group = new $m, this._SymbolCtor = t || UD
            }
            ...
            return t.prototype.updateData = function (t, e) {
                ...
                var n = this.group, i = t.hostModel, r = this._data, o = this._SymbolCtor, a = e.disableAnimation,
                    s = bd(t), l = {disableAnimation: a}, u = e.getSymbolPoint || function (e) {
                ...
                r || n.removeAll(), t.diff(r).add(function (i) {
                    ...
                    if (!_d(t, f, h, e)) return void n.remove(p);
                    if (p) {
        ...
        }(), XD = "undefined" != typeof Float32Array, jD = XD ? Float32Array : Array, qD = Math.min, ZD = Math.max,
        KD = function () {
            function t() {
            ...
            return e(n, t), n.prototype.getDefaultStyle = function () {
                ...
                if (e.connectNulls) {
                    for (; r > 0 && Dd(n[2 * r - 2], n[2 * r - 1]); r--) ;
                    for (; r > i && Dd(n[2 * i], n[2 * i + 1]); i++) ;
                }
                for (; r > i;) i += Ad(t, n, i, r, r, 1, e.smooth, e.smoothMonotone, e.connectNulls) + 1
            }, n.prototype.getPointOn = function (t, e) {
                this.path || (this.createPathProxy(), this.buildPath(this.path, this.shape));
                for (var n, i, r = this.path, o = r.data, a = dx.CMD, s = "x" === e, l = [], u = 0; u < o.length;) {
            ...
            return e(n, t), n.prototype.getDefaultShape = function () {
                ...
                if (e.connectNulls) {
                    for (; o > 0 && Dd(n[2 * o - 2], n[2 * o - 1]); o--) ;
                    for (; o > r && Dd(n[2 * r], n[2 * r + 1]); r++) ;
                }
                for (; o > r;) {
                    var s = Ad(t, n, r, o, o, 1, e.smooth, a, e.connectNulls);
                    Ad(t, i, r + s - 1, s, o, -1, e.stackedOnSmooth, a, e.connectNulls), r += s + 1, t.closePath()
                }
            }, n
        }(Cx), tA = function (t) {
            function n() {
            ...
            return e(n, t), n.prototype.init = function () {
                ...
                var i = this, r = t.coordinateSystem, o = this.group, a = t.getData(), s = t.getModel("lineStyle"),
                    ...
                    v = t.get("animation"), m = !l.isEmpty(), _ = l.get("origin"), x = wd(r, a, _), b = m && Rd(r, a, x),
                    w = t.get("showSymbol"), S = w && !h && zd(t, a, r), M = this._data;
                ...
                var I = Bd(a, r) || a.getVisual("style")[a.getVisual("drawType")];
                d && p.type === r.type && C === this._step ? (m && !g ? g = this._newPolygon(u, b) : g && !m && (y.remove(g), g = this._polygon = null), h || this._initOrUpdateEndLabel(t, r, gl(I)), y.setClipPath(Wd(this, r, !1, t)), w && f.updateData(a, {
                    isIgnore: S,
                    clipShape: T,
                    disableAnimation: !0,
                ...
                }), kd(this._stackedOnPoints, b) && kd(this._points, u) || (v ? this._doUpdateAnimation(a, b, r, n, C, _) : (C && (u = Ed(u, r, C), b && (b = Ed(b, r, C))), d.setShape({points: u}), g && g.setShape({
                    points: u,
                    stackedOnPoints: b
                })))) : (w && f.updateData(a, {
                    isIgnore: S,
                ...
                }), v && this._initSymbolLabelAnimation(a, r, T), C && (u = Ed(u, r, C), b && (b = Ed(b, r, C))), d = this._newPolyline(u), m && (g = this._newPolygon(u, b)), h || this._initOrUpdateEndLabel(t, r, gl(I)), y.setClipPath(Wd(this, r, !0, t)));
                var D = t.get(["emphasis", "focus"]), A = t.get(["emphasis", "blurScope"]);
                if (d.useStyle(c(s.getLineStyle(), {
                    fill: "none",
                    stroke: I,
                    lineJoin: "bevel"
                })), ya(d, t, "lineStyle"), d.style.lineWidth > 0 && "bolder" === t.get(["emphasis", "lineStyle", "width"])) {
                    var k = d.getState("emphasis").style;
                    k.lineWidth = d.style.lineWidth + 1
                }
                Gx(d).seriesIndex = t.seriesIndex, da(d, D, A);
                var L = Od(t.get("smooth")), P = t.get("smoothMonotone"), O = t.get("connectNulls");
                if (d.setShape({smooth: L, smoothMonotone: P, connectNulls: O}), g) {
                    ...
                    })), R && (E = Od(R.get("smooth"))), g.setShape({
                        smooth: L,
                        stackedOnSmooth: E,
                        smoothMonotone: P,
                        connectNulls: O
                    }), ya(g, t, "areaStyle"), Gx(g).seriesIndex = t.seriesIndex, da(g, D, A)
                }
                var B = function (t) {
                ...
                if (this._changePolyState("emphasis"), !(o instanceof Array) && null != o && o >= 0) {
                    ...
                    if (!s) {
                        ...
                        s = new UD(r, o), s.x = l, s.y = u, s.setZ(t.get("zlevel"), t.get("z")), s.__temp = !0, r.setItemGraphicEl(o, s), s.stopSymbolAnimation(!0), this.group.add(s)
                    }
                    s.highlight()
                } else yM.prototype.highlight.call(this, t, e, n, i)
                ...
                var n = this._polygon;
                return n && this._lineGroup.remove(n), n = new JD({
                ...
                if (i.get("show")) {
                    ...
                    a || (a = this._endLabel = new Fx({z2: 200}), a.ignoreClip = !0, o.setTextContent(this._endLabel), o.disableLabelAnimation = !0);
                    var s = Vd(r.getLayout("points"));
                    s >= 0 && (xs(o, bs(t, "endLabel"), {
                        inheritColor: n, labelFetcher: t, labelDataIndex: s, defaultText: function (t, e, n) {
                            return null != n ? rd(r, n) : id(r, t)
                        }, enableTextSetter: !0
                    }, Ud(i, e)), o.textConfig.position = null)
                ...
                if (s) {
                    ...
                    var u = n.getLayout("points"), h = n.hostModel, c = h.get("connectNulls"), p = o.get("precision"),
                        ...
                        x = (g ? 0 : -f) * (y ? -1 : 1), b = g ? "x" : "y", w = Gd(u, m, b), S = w.range, M = S[1] - S[0],
                        T = void 0;
                    if (M >= 1) {
                        if (M > 1 && !c) {
                            var C = Hd(u, S[0]);
                        ...
                        var A = 1 === t || i.lastFrameIndex > 0 ? S[0] : 0, C = Hd(u, A);
                        r && (T = h.getRawValue(A)), s.attr({x: C[0] + _, y: C[1] + x})
                    }
                    r && vw(s).setLabelText(T)
                }
            }, n.prototype._doUpdateAnimation = function (t, e, n, i, r, o) {
                var a = this._polyline, s = this._polygon, l = t.hostModel,
                    u = Id(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, o), h = u.current,
                    c = u.stackedOnCurrent, p = u.next, f = u.stackedOnNext;
                if (r && (h = Ed(u.current, n, r), c = Ed(u.stackedOnCurrent, n, r), p = Ed(u.next, n, r), f = Ed(u.stackedOnNext, n, r)), Pd(h, p) > 3e3 || s && Pd(c, f) > 3e3) return a.setShape({points: p}), void (s && s.setShape({
                    points: p,
                    stackedOnPoints: f
                }));
                a.shape.__points = u.current, a.shape.points = h;
                var d = {shape: {points: p}};
                u.current !== h && (d.shape.__points = u.next), a.stopAnimation(), Ja(a, d, l), s && (s.setShape({
                    points: h,
                    stackedOnPoints: c
                }), s.stopAnimation(), Ja(s, {shape: {stackedOnPoints: f}}, l), a.shape.points !== s.shape.points && (s.shape.points = a.shape.points));
    ...
    _f(Xd);
    var eA = 2 * Math.PI, nA = Math.PI / 180, iA = Math.PI / 180, rA = function (t) {
        function n(e, n, i) {
            var r = t.call(this) || this;
            r.z2 = 2;
            var o = new Vb, a = new Fx;
        ...
        return e(n, t), n.prototype.updateData = function (t, e, n, i) {
            var r = this, o = t.hostModel, a = t.getItemModel(e), s = a.getModel("emphasis"), l = t.getItemLayout(e),
                u = h(tg(a.getModel("itemStyle"), l) || {}, l);
            if (i) {
                r.setShape(u);
                var c = o.getShallow("animationType");
                "scale" === c ? (r.shape.r = l.r0, ts(r, {shape: {r: l.r}}, o, e)) : null != n ? (r.setShape({
                    startAngle: n,
                    endAngle: n
                }), ts(r, {
                    shape: {
            ...
            y && r.attr("cursor", y), this._updateLabel(o, t, e), r.ensureState("emphasis").shape = Zy({r: l.r + (s.get("scale") ? s.get("scaleSize") || 0 : 0)}, tg(s.getModel("itemStyle"), l)), h(r.ensureState("select"), {
                x: d,
                y: g,
                shape: tg(a.getModel(["select", "itemStyle"]), l)
            }), h(r.ensureState("blur"), {shape: tg(a.getModel(["blur", "itemStyle"]), l)});
            ...
            var i, r = this, o = e.getItemModel(n), a = o.getModel("labelLine"), s = e.getItemVisual(n, "style"),
                l = s && s.fill, u = s && s.opacity;
            xs(r, bs(o), {
            ...
            return "outside" !== c && "outer" !== c ? void (null === (i = r.getTextGuideLine()) || void 0 === i ? void 0 : i.hide()) : void Uh(this, Yh(o), {
                stroke: l,
        ...
        return e(n, t), n.prototype.init = function () {
            ...
            n.diff(i).add(function (t) {
                ...
                is(n, t, e)
            }).execute(), Jd(t), "expansion" !== t.get("animationTypeUpdate") && (this._data = n)
        }, n.prototype.dispose = function () {
        ...
        return e(n, t), n.prototype.init = function (e) {
            t.prototype.init.apply(this, arguments), this.legendVisualProvider = new aA(pv(this.getData, this), pv(this.getRawData, this)), this._defaultLabelLine(e)
        }, n.prototype.mergeOption = function () {
            t.prototype.mergeOption.apply(this, arguments)
        }, n.prototype.getInitialData = function () {
            return eg(this, {coordDimensions: ["value"], encodeDefaulter: S(Cl, this)})
    ...
    var lA = function (t) {
        ...
        return e(n, t), n.prototype.getCoordSysModel = function () {
            return this.getReferringComponents("grid", c_).models[0]
    ...
    var hA = {
            ...
            splitLine: {show: !1}
        }, pA), dA = c({scale: !0, logBase: 10}, pA), gA = {category: cA, value: pA, time: fA, log: dA},
        yA = {value: 1, category: 1, time: 1, log: 1}, vA = function () {
            function t(t) {
        ...
        }(), mA = ["x", "y"], _A = function (t) {
            function n() {
                var e = null !== t && t.apply(this, arguments) || this;
                return e.type = "cartesian2d", e.dimensions = mA, e
            }
            ...
            function t(t, e, n) {
                this.type = "grid", this._coordsMap = {}, this._coordsList = [], this._axesMap = {}, this._axesList = [], this.axisPointerEnabled = !0, this.dimensions = mA, this._initCartesian(t, e, n), this.model = t
            }
            ...
            return t.prototype.getRect = function () {
                ...
                function i() {
                    y(s, function (t) {
                        ...
                        t.setExtent(n[i], n[1 - i]), pg(t, e ? a.x : a.y)
                    })
                }

                var r = t.getBoxLayoutParams(), o = !n && t.get("containLabel"),
                    a = ml(r, {width: e.getWidth(), height: e.getHeight()});
                this._rect = a;
                ...
                var e, n, i = t.seriesModel, r = t.xAxisModel || i && i.getReferringComponents("xAxis", c_).models[0],
                    o = t.yAxisModel || i && i.getReferringComponents("yAxis", c_).models[0], a = t.gridModel,
                    s = this._coordsList;
                ...
                function n(e) {
                    return function (n, i) {
                        if (ug(n, t)) {
                            ...
                            var u = new xA(e, af(n), [0, 0], n.get("type"), l), h = "category" === u.type;
                ...
                y(this._axesList, function (t) {
                    ...
                    if (sg(t)) {
                        var i = lg(t), r = i.xAxisModel, o = i.yAxisModel;
                        if (!ug(r, e) || !ug(o, e)) return;
                ...
                return e.eachComponent("grid", function (r, o) {
                    ...
                    if (sg(t)) {
                        var e = lg(t), n = e.xAxisModel, i = e.yAxisModel, r = n.getCoordSysModel(), o = r.coordinateSystem;
                        t.coordinateSystem = o.getCartesian(n.componentIndex, i.componentIndex)
                    }
                }), i
            }, t.dimensions = mA, t
        }(), wA = Math.PI, SA = function () {
            function t(t, e) {
                this.group = new $m, this.opt = e, this.axisModel = t, c(e, {
                    labelOffset: 0,
                    nameDirection: 1,
                    tickDirection: 1,
                    labelDirection: 1,
                ...
                var n = new $m({x: e.position[0], y: e.position[1], rotation: e.rotation});
            ...
            return t.prototype.hasBuilder = function (t) {
                ...
                MA[t](this.opt, this.axisModel, this.group, this._transformGroup)
            }, t.prototype.getGroup = function () {
                return this.group
            }, t.innerTextLayout = function (t, e, n) {
                var i, r, o = Ci(e - t);
                return Ii(o) ? (r = n > 0 ? "top" : "bottom", i = "center") : Ii(o - wA) ? (r = n > 0 ? "bottom" : "top", i = "center") : (r = "middle", i = o > 0 && wA > o ? n > 0 ? "right" : "left" : n > 0 ? "left" : "right"), {
                    rotation: o,
                    textAlign: i,
                    textVerticalAlign: r
                }
            ...
            axisLine: function (t, e, n, i) {
                ...
                if ("auto" === r && t.handleAutoShown && (r = t.handleAutoShown("axisLine")), r) {
                    ...
                    a && (ge(s, s, a), ge(l, l, a));
                    var u = h({lineCap: "round"}, e.getModel(["axisLine", "lineStyle"]).getLineStyle()), c = new Wb({
                        subPixelOptimize: !0,
                    ...
                    if ("number" == typeof d && (d = [d, d]), null != p) {
                        ...
                        y([{rotate: t.rotation + Math.PI / 2, offset: d[0], r: 0}, {
                            ...
                            if ("none" !== p[i] && null != p[i]) {
                                var r = oc(p[i], -g / 2, -v / 2, g, v, u.stroke, !0), o = e.r + e.offset;
                                r.attr({
                                    rotation: e.rotate,
                ...
                var r = _g(n, i, e, t), o = bg(n, i, e, t);
                dg(e, o, r), xg(n, i, e, t.tickDirection)
                ...
                if (r) {
                    var o, a = e.get("nameLocation"), s = t.nameDirection, l = e.getModel("nameTextStyle"),
                        ...
                        f = ["start" === a ? c[0] - p * u : "end" === a ? c[1] + p * u : (c[0] + c[1]) / 2, vg(a) ? t.labelOffset + s * u : 0],
                        d = e.get("nameRotate");
                    null != d && (d = d * wA / 180);
                    var g;
                    vg(a) ? o = SA.innerTextLayout(t.rotation, null != d ? d : t.rotation, s) : (o = fg(t.rotation, a, d || 0, c), g = t.axisNameAvailableWidth, null != g && (g = Math.abs(g / Math.sin(o.rotation)), !isFinite(g) && (g = null)));
                    var y = l.getFont(), v = e.get("nameTruncate", !0) || {}, m = v.ellipsis,
                        _ = z(t.nameTruncateMaxWidth, v.maxWidth, g), x = e.get("tooltip", !0), b = e.mainType,
                    ...
                    if (S.tooltip = x && x.show ? h({
                        ...
                        var M = SA.makeAxisEventDataBase(e);
                        M.targetType = "axisName", M.name = r, Gx(S).eventData = M
                    }
        ...
        }(fM), IA = or(), DA = ["axisLine", "axisTickLabel", "axisName"], AA = ["splitArea", "splitLine", "minorSplitLine"],
        kA = function (t) {
            function n() {
                var e = null !== t && t.apply(this, arguments) || this;
            ...
            return e(n, t), n.prototype.render = function (e, n, i, r) {
                ...
                if (this._axisGroup = new $m, this.group.add(this._axisGroup), e.get("show")) {
                    var a = e.getCoordSysModel(), s = ag(a, e), l = new SA(e, h({
                        handleAutoShown: function () {
                    ...
                    y(DA, l.add, l), this._axisGroup.add(l.getGroup()), y(AA, function (t) {
                        e.get([t, "show"]) && LA[t](this, this._axisGroup, e, a)
                    }, this), hs(o, this._axisGroup, e), t.prototype.render.call(this, e, n, i, r)
                }
            }, n.prototype.remove = function () {
                Rg(this)
            ...
            splitLine: function (t, e, n, i) {
                ...
                if (u.length) for (var h = [], c = [], p = a.getLineStyle(), f = 0; f < u.length; f++) for (var d = 0; d < u[f].length; d++) {
                    ...
                    l ? (h[0] = g, h[1] = s.y, c[0] = g, c[1] = s.y + s.height) : (h[0] = s.x, h[1] = g, c[0] = s.x + s.width, c[1] = g), e.add(new Wb({
            ...
            return e(n, t), n.prototype.render = function (t) {
                this.group.removeAll(), t.get("show") && this.group.add(new Ex({
        ...
        return e(n, t), n.prototype.render = function (t, e, n) {
            if (this.group.removeAll(), t.get("show")) {
                var i = this.group, r = t.getModel("textStyle"), o = t.getModel("subtextStyle"), a = t.get("textAlign"),
                    ...
                    l = new Fx({style: ws(r, {text: t.get("text"), fill: r.getTextColor()}, {disableBox: !0}), z2: 10}),
                    u = l.getBoundingRect(), h = t.get("subtext"), c = new Fx({
                        style: ws(o, {
                            text: h,
                            fill: o.getTextColor(),
    ...
    var NA = function (t, e) {
        ...
        return e(n, t), n.prototype.init = function (t, e, n) {
            ...
            e === !0 && (e = t.selector = ["all", "inverse"]), M(e) && y(e, function (t, i) {
                C(t) && (t = {type: t}), e[i] = l(t, NA(n, t.type))
            })
        }, n.prototype.optionUpdated = function () {
            ...
            var i = this.get("data") || e, r = v(i, function (t) {
                return ("string" == typeof t || "number" == typeof t) && (t = {name: t}), new Iw(t, this, this.ecModel)
            }, this);
            this._data = r
    ...
    }(iS), VA = S, HA = y, GA = $m, WA = function (t) {
        function n() {
            var e = null !== t && t.apply(this, arguments) || this;
        ...
        return e(n, t), n.prototype.init = function () {
            this.group.add(this._contentGroup = new GA), this.group.add(this._selectorGroup = new GA), this._isFirstRender = !0
            ...
            if (this._isFirstRender = !1, this.resetInner(), t.get("show", !0)) {
                ...
                var l = t.getBoxLayoutParams(), u = {width: n.getWidth(), height: n.getHeight()}, h = t.get("padding"),
                    p = ml(l, u, h), f = this.layoutInner(t, r, p, i, a, s),
                    d = ml(c({width: f.width, height: f.height}, l), u, h);
                this.group.x = d.x - f.x, this.group.y = d.y - f.y, this.group.markRedraw(), this.group.add(this._backgroundEl = zg(f, t))
            }
            ...
            n.eachRawSeries(function (t) {
                ...
                if (!l.get(a)) if (p) {
                    ...
                    x.on("click", VA(Fg, a, null, i, h)).on("mouseover", VA(Hg, p.name, null, i, h)).on("mouseout", VA(Gg, p.name, null, i, h)), l.set(a, !0)
                    ...
                    if (!l.get(a) && n.legendVisualProvider) {
                        ...
                        m.on("click", VA(Fg, null, a, i, h)).on("mouseover", VA(Hg, null, a, i, h)).on("mouseout", VA(Gg, null, a, i, h)), l.set(a, !0)
                    }
                }, this)
            ...
            HA(t, function (t) {
                ...
                xs(o, {normal: a, emphasis: s}, {defaultText: t.title}), da(o)
            })
            ...
            var p = i.get("itemWidth"), f = i.get("itemHeight"), d = i.get("inactiveColor"),
                ...
                m = i.isSelected(t), _ = new GA, x = n.getModel("textStyle"), b = n.get("icon"),
                w = n.getModel("tooltip"), S = w.parentModel;
            r = b || r;
            var M = oc(r, 0, 0, p, f, m ? s : d, null == y ? !0 : y);
            if (_.add(Ng(M, r, v, l, g, u, m)), !b && o && (o !== r || "none" === o)) {
                var T = .8 * f;
                "none" === o && (o = "circle");
                var C = oc(o, (p - T) / 2, (f - T) / 2, T, T, m ? s : d, null == y ? !0 : y);
                _.add(Ng(C, o, v, l, g, u, m))
            }
            var I = "left" === a ? p + 5 : -5, D = a, A = i.get("formatter"), k = t;
            "string" == typeof A && A ? k = A.replace("{name}", null != t ? t : "") : "function" == typeof A && (k = A(t)), _.add(new Fx({
                style: ws(x, {
                    text: k,
                    x: I,
                    y: f / 2,
            ...
            var L = new Ex({shape: _.getBoundingRect(), invisible: !0});
            if (w.get("show")) {
        ...
        return e(n, t), n.prototype.setScrollDataIndex = function (t) {
            ...
            var r = bl(e);
            t.prototype.init.call(this, e, n, i), jg(this, e, r)
        }, n.prototype.mergeOption = function (e, n) {
            t.prototype.mergeOption.call(this, e, n), jg(this, this.option, e)
        }, n.type = "legend.scroll", n.defaultOption = Os(FA.defaultOption, {
            scrollDataIndex: 0,
            pageButtonItemGap: 5,
            pageButtonGap: null,
    ...
    }(FA), YA = $m, XA = ["width", "height"], jA = ["x", "y"], qA = function (t) {
        function n() {
            var e = null !== t && t.apply(this, arguments) || this;
        ...
        return e(n, t), n.prototype.init = function () {
            t.prototype.init.call(this), this.group.add(this._containerGroup = new YA), this._containerGroup.add(this.getContentGroup()), this.group.add(this._controllerGroup = new YA)
        }, n.prototype.resetInner = function () {
            ...
            function l(t, e) {
                var i = t + "DataIndex",
                    o = fs(n.get("pageIcons", !0)[n.getOrient().name][e], {onclick: pv(u._pageGo, u, i, n, r)}, {
                        x: -p[0] / 2,
                        y: -p[1] / 2,
                        width: p[0],
                        height: p[1]
            ...
            var a = this.getSelectorGroup(), l = t.getOrient().index, u = XA[l], h = jA[l], c = XA[1 - l],
                p = jA[1 - l];
            r && eS("horizontal", a, t.get("selectorItemGap", !0));
            ...
            eS(t.get("orient"), l, t.get("itemGap"), i ? n.width : null, i ? null : n.height), eS("horizontal", h, t.get("pageButtonItemGap", !0));
            ...
            if (_[r] = f ? n[r] : c[r], _[o] = Math.max(c[o], p[o]), _[a] = Math.min(0, p[a] + y[1 - i]), u.__rectSize = n[r], f) {
                var x = {x: 0, y: 0};
                x[r] = Math.max(n[r] - p[r] - v, 0), x[o] = _[o], u.setClipPath(new Ex({shape: x})), u.__rectSize = x[r]
            ...
            var i = t.get("scrollDataIndex", !0), r = this.getContentGroup(), o = this._containerGroup.__rectSize,
                a = t.getOrient().index, s = XA[a], l = jA[a], u = this._findTargetItemIndex(i), h = r.children(),
    ...
    _f(Zg);
    var ZA = or(), KA = s, $A = pv, QA = function () {
            function t() {
            ...
            return t.prototype.render = function (t, e, n, i) {
                ...
                if (this._axisModel = t, this._axisPointerModel = e, this._api = n, i || this._lastValue !== r || this._lastStatus !== o) {
                    ...
                    } else a = this._group = new $m, this.createPointerEl(a, l, t, e), this.createLabelEl(a, l, t, e), n.getZr().add(a);
                    ty(a, e, !0), this._renderHandle(r)
                }
            }, t.prototype.remove = function (t) {
                this.clear(t)
                ...
                if ("auto" === n || null == n) {
                    ...
                    if (o) {
                        var s = Ag(t).seriesDataCount, l = i.getExtent();
                ...
                var n = e.pointer;
                if (n) {
                    var i = ZA(t).pointerEl = new pw[n.type](KA(e.pointer));
                    t.add(i)
                }
                ...
                if (!this._dragging && this.updateHandleTransform) {
                    ...
                    this._handle || (a = !0, i = this._handle = fs(r.get("icon"), {
                        ...
                        onmousedown: $A(this._onHandleDragMove, this, 0, 0),
                        drift: $A(this._onHandleDragMove, this),
                        ondragend: $A(this._onHandleDragEnd, this)
                    }), n.add(i)), ty(i, e, !1), i.setStyle(r.getItemStyle(null, ["color", "borderColor", "borderWidth", "opacity", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY"]));
                    var s = r.get("size");
                    M(s) || (s = [s, s]), i.scaleX = s[0] / 2, i.scaleY = s[1] / 2, yh(this, "_doDispatchAxisPointer", r.get("throttle") || 0, "fixRate"), this._moveHandleToValue(t, a)
                }
            }, t.prototype._moveHandleToValue = function (t, e) {
                Kg(this._axisPointerModel, !e && this._moveAnimation, this._handle, Jg(this.getHandleTransform(t, this._axisModel, this._axisPointerModel)))
            }, t.prototype._onHandleDragMove = function (t, e) {
                var n = this._handle;
                if (n) {
                    this._dragging = !0;
                    var i = this.updateHandleTransform(Jg(n), [t, e], this._axisModel, this._axisPointerModel);
                    this._payloadInfo = i, n.stopAnimation(), n.attr(Jg(i)), ZA(n).lastProp = null, this._doDispatchAxisPointer()
                }
            ...
            return e(n, t), n.prototype.makeElOption = function (t, e, n, i, r) {
                var o = n.axis, a = o.grid, s = i.get("type"), l = uy(a, o).getOtherAxis(o).getGlobalExtent(),
                    u = o.toGlobalCoord(o.dataToCoord(e, !0));
                if (s && "none" !== s) {
                    var h = ey(i), c = tk[s](o, u, l);
                    c.style = h, t.graphicKey = c.type, t.pointer = c
                }
                var p = ag(a.model, n);
                ay(e, t, p, n, i, r)
            }, n.prototype.getHandleTransform = function (t, e, n) {
                var i = ag(e.axis.grid.model, e, {labelInside: !1});
                ...
                var i = n.axis, r = i.grid, o = i.getGlobalExtent(!0), a = uy(r, i).getOtherAxis(i).getGlobalExtent(),
            ...
            return e(n, t), n.prototype.render = function (t, e, n) {
                ...
                cy("axisPointer", n, function (t, e, n) {
        ...
        }(iS), sk = ["-ms-", "-moz-", "-o-", "-webkit-", ""],
        lk = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;",
        uk = function () {
            function t(t, e, n) {
                if (this._show = !1, this._styleCoord = [0, 0, 0, 0], this._enterable = !0, this._firstShow = !0, this._longHide = !0, Qy.wxa) return null;
                var i = document.createElement("div");
                i.domBelongToZr = !0, this.el = i;
                var r = this._zr = e.getZr(), o = this._appendToBody = n && n.appendToBody;
                zy(this._styleCoord, r, o, e.getWidth() / 2, e.getHeight() / 2), o ? document.body.appendChild(i) : t.appendChild(i), this._container = t;
                var a = this;
            ...
            return t.prototype.update = function (t) {
                ...
                e = gl(e), n.style.cssText = lk + By(t, !this._firstShow, this._longHide) + ";left:" + i[0] + "px;top:" + (i[1] - r) + "px;" + ("border-color: " + e + ";") + (t.get("extraCssText") || ""), n.style.display = n.innerHTML ? "block" : "none", n.style.pointerEvents = this._enterable ? "auto" : "none", this._show = !0, this._firstShow = !1, this._longHide = !1
                ...
                if (zy(n, this._zr, this._appendToBody, t, e), null != n[0] && null != n[1]) {
                    var i = this.el.style;
                ...
                !this._show || this._inContent && this._enterable || (t ? (this._hideDelay = t, this._show = !1, this._hideTimeout = setTimeout(pv(this.hide, this), t)) : this.hide())
            ...
            function t(t) {
                this._show = !1, this._styleCoord = [0, 0, 0, 0], this._enterable = !0, this._zr = t.getZr(), Vy(this._styleCoord, this._zr, t.getWidth() / 2, t.getHeight() / 2)
            }
        ...
        }(), ck = pv, pk = y, fk = _i, dk = new Ex({shape: {x: -1, y: -1, width: 2, height: 2}}), gk = function (t) {
            function n() {
                var e = null !== t && t.apply(this, arguments) || this;
                return e.type = n.type, e
            }
            ...
            return e(n, t), n.prototype.init = function (t, e) {
                if (!Qy.node) {
                    ...
                    this._renderMode = hr(i), this._tooltipContent = "richText" === this._renderMode ? new hk(e) : new uk(e.getDom(), e, {appendToBody: n.get("appendToBody", !0)})
                }
            }, n.prototype.render = function (t, e, n) {
                if (!Qy.node) {
                ...
                cy("itemTooltip", this._api, ck(function (t, n, i) {
                ...
                if (i.from !== this.uid && !Qy.node) {
                    ...
                    if (i.tooltip && null != i.x && null != i.y) {
                        ...
                        var s = my(i, e), l = s.point[0], u = s.point[1];
                ...
                if (null != r && null != o && null != a) {
                    ...
                    if (s) {
                        var l = s.getData(), u = Hy([l.getItemModel(o), s, (s.coordinateSystem || {}).model, t]);
                ...
                e = pv(e, this), clearTimeout(this._showTimout), n > 0 ? this._showTimout = setTimeout(e, n) : e()
            }, n.prototype._showAxisTooltip = function (t, e) {
                var n = this._ecModel, i = this._tooltipModel, r = [e.offsetX, e.offsetY], o = Hy([e.tooltipOption, i]),
                    a = this._renderMode, s = [], l = Hu("section", {blocks: [], noHeader: !0}), u = [], h = new hM;
                pk(t, function (t) {
                    pk(t.dataByAxis, function (t) {
                        var e = n.getComponent(t.axisDim + "Axis", t.axisIndex), i = t.value;
                        if (e && null != i) {
                            var r = ry(i, e.axis, n, t.seriesDataIndices, t.valueLabelOpt),
                                o = Hu("section", {header: r, noHeader: !W(r), sortBlocks: !0, blocks: []});
                            l.blocks.push(o), y(t.seriesDataIndices, function (l) {
                                ...
                                f.axisDim = t.axisDim, f.axisIndex = t.axisIndex, f.axisType = t.axisType, f.axisId = t.axisId, f.axisValue = uf(e.axis, {value: i}), f.axisValueLabel = r, f.marker = h.makeTooltipMarker("item", gl(f.color), a);
                ...
                var c = e.position, p = o.get("order"), f = Uu(l, h, a, p, n.get("useUTC"), o.get("textStyle"));
                f && u.unshift(f);
                var d = "richText" === a ? "\n\n" : "<br/>", g = u.join(d);
                ...
                var i = ic(e, function (t) {
                        return null != Gx(t).dataIndex
                    }, !0), r = this._ecModel, o = Gx(i), a = o.seriesIndex, s = r.getSeriesByIndex(a), l = o.dataModel || s,
                    u = o.dataIndex, h = o.dataType, c = l.getData(h), p = this._renderMode,
                    f = Hy([c.getItemModel(u), l, s && (s.coordinateSystem || {}).model, this._tooltipModel]),
                    d = f.get("trigger");
                if (null == d || "item" === d) {
                    var g = l.getDataParams(u, h), y = new hM;
                    g.marker = y.makeTooltipMarker("item", gl(g.color), p);
                    var v = Tu(l.formatTooltip(u, !1, h)), m = f.get("order"),
                        _ = v.markupFragment ? Uu(v.markupFragment, y, p, m, r.get("useUTC"), f.get("textStyle")) : v.markupText,
                        x = "item_" + l.name + "_" + u;
                ...
                var o = new Iw(i, this._tooltipModel, this._ecModel), a = o.get("content"), s = Math.random() + "",
                    l = new hM;
                this._showOrMove(o, function () {
                ...
                if (a && p.applyTransform(a.transform), T(e) && (e = e([n, i], o, r.el, p, {
                    viewSize: [s, l],
                    contentSize: u.slice()
                })), M(e)) n = fk(e[0], s), i = fk(e[1], l); else if (A(e)) {
                    var f = e;
                    f.width = u[0], f.height = u[1];
                    var d = ml(f, {width: s, height: l});
                ...
                if (h && (n -= Xy(h) ? u[0] / 2 : "right" === h ? u[0] : 0), c && (i -= Xy(c) ? u[1] / 2 : "bottom" === c ? u[1] : 0), Ly(t)) {
                    var g = Uy(n, i, r, s, l);
                    n = g[0], i = g[1]
                }
                r.moveTo(n, i)
                ...
                return n && pk(e, function (e, i) {
                    var r = e.dataByAxis || [], o = t[i] || {}, a = o.dataByAxis || [];
                    n = n && r.length === a.length, n && pk(r, function (t, e) {
                        var i = a[e] || {}, r = t.seriesDataIndices || [], o = i.seriesDataIndices || [];
                        n = n && t.value === i.value && t.axisType === i.axisType && t.axisId === i.axisId && r.length === o.length, n && pk(r, function (t, e) {
                            var i = o[e];
                ...
                Qy.node || (this._tooltipContent.dispose(), vy("itemTooltip", e))
            }, n.type = "tooltip", n
        }(fM);
